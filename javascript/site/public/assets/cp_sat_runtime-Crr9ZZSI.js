async function Qi(ze = {}) {
  ...
  if (y) {
    ...
    async function e(r) {
      try {
        ...
        throw w(`worker: onmessage() captured an uncaught exception: ${o}`), o?.stack && w(o.stack), Wt(), o;
      }
    }
    self.onmessage = e;
  }
  ...
  var dn = (e, r) => {
    ...
    e.onmessage = (a) => {
      ...
      throw e.pthread_ptr && (s = `Pthread ${ie(e.pthread_ptr)} sent an error!`), w(`${s} ${a.filename}:${a.lineno}: ${a.message}`), a;
...
`)), !e)
  ...
  var lt = (e, r, t) => {
    ...
    r = U(r), z(e, { name: r, fromWireType: function(o) {
      ...
      return this.fromWireType((u(), W)[o]);
...
${_}`, new Function(g, _);
  ...
  function Bn(e, r, t, n, o, a) {
    ...
    for (var l = r[1] !== null && t !== null, d = _t(r), _ = !r[0].isVoid, v = s - 2, g = $n(r), m = r[0], p = r[1], k = [e, $, n, o, Ln, m.fromWireType.bind(m), p?.toWireType.bind(p)], b = 2; b < s; ++b) {
      var I = r[b];
  ...
  var Xn = (e) => {
    ...
    r = U(r), z(e, { name: r, fromWireType(t) {
      ...
      var s = $e(4 + o + 1), l = s + 4;
      return (u(), h)[s >> 2] = o, a ? q(n, l, o + 1) : (u(), W).set(n, l), t !== null && t.push(K, s), s;
  ...
  var Le = [], Si = (e, r) => {
    ...
    var e = Tt().split(`
`);
    return e[0] == "Error" && e.shift(), kt(e), ae.last_addr = We(e[3]), ae.last_stack = e, ae.last_addr;
  }, Ue = (e) => {
    var r = ae[e];
    if (!r) return 0;
    var t, n;
...
`), n[0] == "Error" && n.shift(), kt(n));
    for (var o = 3; n[o] && We(n[o]) != e; )
      ++o;
    for (var a = 0; a < t && n[a + o]; ++a)
      (u(), C)[r + a * 4 >> 2] = We(n[a + o]);
    return a;
...
eo && Qi();
//# sourceMappingURL=cp_sat_runtime-Crr9ZZSI.js.map
