async function Zt(I = {}) {
  ...
  var er;
  function cn() {
    return c.locateFile ? rn("cp_sat_runtime.wasm") : new URL("/assets/cp_sat_runtime-CY8CFHYZ.wasm", import.meta.url).href;
  }
  function un(e) {
    if (e == er && Ae)
  ...
  var vn = (e, r) => {
    ...
    if (c.mainScriptUrlOrBlob) {
      ...
      /* @vite-ignore */
      "/assets/cp_sat_runtime-DkVzMw-A.js",
      import.meta.url
...
//# sourceMappingURL=cpsat_worker-CCrEJ0s3.js.map
