async function Zt(I = {}) {
  ...
  function Pe() {
    if (!me) {
      ...
      (r != 34821223 || t != 2310721022) && P(`Stack overflow! Stack cookie has been overwritten at ${ce(e)}, expected hex dwords 0x89BACDFE and 0x2135467, but received ${ce(t)} ${ce(r)}`), (f(), h)[0] != 1668509029 && P("Runtime error: The application has corrupted its heap memory area (address zero)!");
    }
  }
  function Ye(...e) {
    console.warn(...e);
  ...
  function Fr(e) {
    y || Object.getOwnPropertyDescriptor(c, e) || Object.defineProperty(c, e, { configurable: !0, get() {
      ...
      nn(e) && (r += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), P(r);
    } });
  }
  function an() {
    function e() {
    ...
    async function e(r) {
      try {
        ...
        if (n === "load") {
          ...
          u(t.pthread_ptr), pn(t.pthread_ptr), pr(t.pthread_ptr, 0, 0, 1, 0, 0), w.threadInitTLS(), fr(t.pthread_ptr), Qe || (Ut(), Qe = !0);
          try {
        ...
        } else t.target === "setimmediate" || (n === "checkMailbox" ? Qe && ze() : n && (b(`worker: received unknown command ${n}`), b(t)));
      } catch (i) {
        throw b(`worker: onmessage() captured an uncaught exception: ${i}`), i?.stack && b(i.stack), zt(), i;
      }
    }
    self.onmessage = e;
  }
  ...
  function P(e) {
    c.onAbort?.(e), e = "Aborted(" + e + ")", b(e), me = !0;
  ...
  var er;
  function cn() {
    return c.locateFile ? rn("cp_sat_runtime.wasm") : new URL("/assets/cp_sat_runtime-DeNC4Axa.wasm", import.meta.url).href;
  }
  function un(e) {
    if (e == er && Ae)
  ...
  var Or = (e) => {
    ...
    for (; e.length > 0; )
      e.shift()(c);
  }, Lr = [], Ur = (e) => Lr.push(e), le = 0, Me = null, he = {}, de = null, $r = (e) => {
  ...
  }, pe = 0, Le = () => ar || pe > 0, Hr = () => Er(), rr = (e) => Kt(e), tr = (e) => Xt(e), x = (e, r, t, ...n) => {
    for (var i = n.length * 2, a = Hr(), s = tr(i * 8), l = s >> 3, d = 0; d < n.length; d++) {
      var m = n[d];
      typeof m == "bigint" ? ((f(), N)[l + 2 * d] = 1n, (f(), N)[l + 2 * d + 1] = m) : ((f(), N)[l + 2 * d] = 0n, (f(), Ie)[l + 2 * d + 1] = m);
    }
    var v = Ht(e, r, i, s, t);
    return rr(a), v;
  };
  function nr(e) {
    ...
    _e = e, Le() || (w.terminateAllThreads(), c.onExit?.(e), me = !0), Sr(e, new Nr(e));
  }
  function jr(e) {
  ...
  var vn = (e, r) => {
    ...
    nr(e);
  }, or = vn, ce = (e) => (u(typeof e == "number", `ptrToString expects a number, got ${typeof e}`), e >>>= 0, "0x" + e.toString(16).padStart(8, "0")), w = { unusedWorkers: [], runningWorkers: [], tlsInitFunctions: [], pthreads: {}, nextWorkerID: 1, init() {
    y || w.initMainThread();
  }, initMainThread() {
    ...
    e.onmessage = (a) => {
      ...
      l === "checkMailbox" ? ze() : l === "spawnThread" ? zr(s) : l === "cleanupThread" ? Et(() => xr(s.thread)) : l === "loaded" ? (e.loaded = !0, r(e)) : s.target === "setimmediate" ? e.postMessage(s) : l === "callHandler" ? c[s.handler](...s.args) : l && b(`worker sent an unknown command ${l}`);
    }, e.onerror = (a) => {
    ...
    if (c.mainScriptUrlOrBlob) {
      ...
      /* @vite-ignore */
      "/assets/cp_sat_runtime-2Spcslnn.js",
      import.meta.url
  ...
  qr.isAsync = !0;
  var ar = !0, gn = (e) => w.tlsInitFunctions.push(e), ne = (e) => {
    ...
    return a;
  }, Z = (e, r, t) => (u(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? ge((f(), j), e, r, t) : ""), yn = (e, r, t, n) => P(`Assertion failed: ${Z(e)}, at: ` + [r ? Z(r) : "unknown filename", t, n ? Z(n) : "unknown function"]);
  class En {
    constructor(r) {
  ...
  function Yr(e, r, t, n) {
    return y ? x(2, 0, 1, e, r, t, n) : Jr(e, r, t, n);
  }
  ...
  }, ye = Ue, T = { isAbs: (e) => e.charAt(0) === "/", splitPath: (e) => {
    var r = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/;
  ...
  }, basename: (e) => e && e.match(/([^\/]+|\/)\/*$/)[1], join: (...e) => T.normalize(e.join("/")), join2: (e, r) => T.normalize(e + "/" + r) }, Sn = () => (e) => e.set(crypto.getRandomValues(new Uint8Array(e.byteLength))), sr = (e) => {
    (sr = Sn())(e);
  }, Ee = { resolve: (...e) => {
...
`)), !e)
    ...
    var d = r ? Ee.resolve(T.join2(e, r)) : e, m = In(`cp ${d}`);
    Br(m);
    try {
      var v = t;
  ...
  }, Rn = (e, r, t, n, i, a, s, l, d, m) => {
    nt(e, r, t, n, i, l, d, m).then(a).catch(s);
    ...
    var m = o.lookupNode(l, i), v = Ee.relative(e, n);
    if (v.charAt(0) !== ".")
      throw new o.ErrnoError(28);
    ...
    if (m !== g) {
      ...
      if (p = g ? o.mayDelete(d, a, _) : o.mayCreate(d, a), p)
        throw new o.ErrnoError(p);
      if (!l.node_ops.rename)
        throw new o.ErrnoError(63);
      if (o.isMountpoint(m) || g && o.isMountpoint(g))
        throw new o.ErrnoError(10);
    ...
    class a {
      ...
      cacheLength() {
        ...
        var p = Number(_.getResponseHeader("Content-length")), k, S = (k = _.getResponseHeader("Accept-Ranges")) && k === "bytes", D = (k = _.getResponseHeader("Content-Encoding")) && k === "gzip", B = 1024 * 1024;
        S || (B = p);
        var H = (J, Te) => {
          J > Te && P("invalid range (" + J + ", " + Te + ") or no bytes requested!"), Te > p - 1 && P("only " + p + " bytes available! programmer error!");
          var L = new XMLHttpRequest();
          return L.open("GET", t, !1), p !== B && L.setRequestHeader("Range", "bytes=" + J + "-" + Te), L.responseType = "arraybuffer", L.overrideMimeType && L.overrideMimeType("text/plain; charset=x-user-defined"), L.send(null), L.status >= 200 && L.status < 300 || L.status === 304 || P("Couldn't load " + t + ". Status: " + L.status), L.response !== void 0 ? new Uint8Array(L.response || []) : dr(L.responseText || "");
        }, Ne = this;
        Ne.setDataGetter((J) => {
          var Te = J * B, L = (J + 1) * B - 1;
          return L = Math.min(L, p - 1), typeof Ne.chunks[J] > "u" && (Ne.chunks[J] = H(Te, L)), typeof Ne.chunks[J] > "u" && P("doXHR failed!"), Ne.chunks[J];
    ...
    return m.read = (g, _, p, k, S) => (o.forceLoadFile(d), v(g, _, p, k, S)), m.mmap = (g, _, p, k, S) => {
      ...
      if (!D)
        throw new o.ErrnoError(48);
      return v(g, (f(), W), D, _, p), { ptr: D, allocated: !0 };
    }, d.stream_ops = m, d;
  }, absolutePath() {
      ...
      switch (r) {
        ...
        case 21508: {
          ...
          if (n.tty.ops.ioctl_tcsets) {
            for (var a = ye(), l = (f(), R)[a >> 2], d = (f(), R)[a + 4 >> 2], m = (f(), R)[a + 8 >> 2], v = (f(), R)[a + 12 >> 2], g = [], s = 0; s < 32; s++)
              g.push((f(), W)[a + s + 17]);
        ...
        case 21523: {
          ...
          if (n.tty.ops.ioctl_tiocgwinsz) {
            var _ = n.tty.ops.ioctl_tiocgwinsz(n.tty), a = ye();
            (f(), se)[a >> 1] = _[0], (f(), se)[a + 2 >> 1] = _[1];
          }
          return 0;
        }
        case 21524:
  ...
  var Dn = () => P("native code called abort()"), V = (e) => {
    for (var r = ""; ; ) {
      var t = (f(), j)[e++];
      if (!t) return r;
  ...
  }, mt = [], Q = [0, 1, , 1, null, 1, !0, 1, !1, 1], Ln = (e) => {
    e > 9 && --Q[e + 1] === 0 && (u(Q[e] !== void 0, "Decref for unallocated handle."), Q[e] = void 0, mt.push(e));
  }, _t = { toValue: (e) => (e || G(`Cannot use deleted val. handle = ${e}`), u(e === 2 || Q[e] !== void 0 && e % 2 === 0, `invalid handle: ${e}`), Q[e]), toHandle: (e) => {
    switch (e) {
      case void 0:
        return 2;
      case null:
  ...
  var Un = { name: "emscripten::val", fromWireType: (e) => {
    var r = _t.toValue(e);
    return Ln(e), r;
  }, toWireType: (e, r) => _t.toHandle(r), readValueFromPointer: ur, destructorFunction: null }, $n = (e) => K(e, Un), Bn = (e, r) => {
    switch (r) {
      case 4:
        return function(t) {
...
${m}`, new Function(g, m);
  ...
  function qn(e, r, t, n, i, a) {
    ...
    for (var l = r[1] !== null && t !== null, d = ht(r), m = !r[0].isVoid, v = s - 2, g = Gn(r), _ = r[0], p = r[1], k = [e, G, n, i, Hn, _.fromWireType.bind(_), p?.toWireType.bind(p)], S = 2; S < s; ++S) {
      var D = r[S];
  ...
  var ro = (e) => {
    ...
    K(e, { name: r, fromWireType: s, toWireType: (d, m) => {
      if (typeof m != "number" && typeof m != "boolean")
        throw new TypeError(`Cannot convert "${Be(m)}" to ${r}`);
      return ft(r, m, n, i), m;
    ...
    t = V(t);
    var n, i, a;
    r === 2 ? (n = co, i = uo, a = fo) : (u(r === 4, "only 2-byte and 4-byte strings are currently supported"), n = mo, i = _o, a = vo), K(e, { name: t, fromWireType: (s) => {
      var l = (f(), h)[s >> 2], d = n(s + 4, l * r, !0);
      return ee(s), d;
    }, toWireType: (s, l) => {
      typeof l != "string" && G(`Cannot pass non-string to C++ string type ${t}`);
      var d = a(l), m = De(4 + d + r);
      return (f(), h)[m >> 2] = d / r, i(l, m + 4, d + r), s !== null && s.push(ee, m), m;
    ...
    y ? postMessage({ cmd: "cleanupThread", thread: e }) : xr(e);
  }, So = (e) => {
  }, ko = 9007199254740992, To = -9007199254740992, mr = (e) => e < To || e > ko ? NaN : Number(e);
  function wt(e, r, t, n, i, a, s) {
    if (y) return x(10, 0, 1, e, r, t, n, i, a, s);
    i = mr(i);
    try {
      u(!isNaN(i));
      var l = C.getStreamFromFD(n), d = o.mmap(l, e, i, r, t), m = d.ptr;
  ...
  var Fo = (e, r, t, n) => {
    var i = (/* @__PURE__ */ new Date()).getFullYear(), a = new Date(i, 0, 1), s = new Date(i, 6, 1), l = a.getTimezoneOffset(), d = s.getTimezoneOffset(), m = Math.max(l, d);
    (f(), h)[e >> 2] = m * 60, (f(), R)[r >> 2] = +(l != d);
    var v = (p) => {
      var k = p >= 0 ? "-" : "+", S = Math.abs(p), D = String(Math.floor(S / 60)).padStart(2, "0"), B = String(S % 60).padStart(2, "0");
      return `UTC${k}${D}${B}`;
    }, g = v(l), _ = v(d);
    u(g), u(_), u(oe(g) <= 16, `timezone name truncated to fit in TZNAME_MAX (${g})`), u(oe(_) <= 16, `timezone name truncated to fit in TZNAME_MAX (${_})`), d < l ? (X(g, t, 17), X(_, n, 17)) : (X(g, n, 17), X(_, t, 17));
  ...
  var je = [], Io = (e, r) => {
    ...
    throw kt(), "unwind";
  }, Tt = () => 2147483648, xo = () => Tt(), Wo = () => navigator.hardwareConcurrency, ue = {}, Ft = (e) => {
    var r = oe(e) + 1, t = De(r);
    return t && X(e, t, r), t;
  }, Ve = (e) => {
    var r;
  ...
  }, Pt = () => new Error().stack.toString(), Lo = () => {
    var e = Pt().split(`
`);
...
`), n[0] == "Error" && n.shift(), At(n));
  ...
  function Nt(e, r, t, n) {
    ...
    try {
      var i = C.getStreamFromFD(e), a = jo(i, r, t);
      return (f(), h)[n >> 2] = a, 0;
    } catch (s) {
      if (typeof o > "u" || s.name !== "ErrnoError") throw s;
      return s.errno;
  ...
  Wt.sig = "i";
  var Lt = F("___getTypeName"), Ut = F("__embind_initialize_bindings");
  ...
  function qe() {
    ...
    async function e() {
      u(!Jt), Jt = !0, c.calledRun = !0, !me && (Mr(), Je?.(c), c.onRuntimeInitialized?.(), xe("onRuntimeInitialized"), u(!c._main, 'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]'), dn());
    }
...
const Fe = self;
let M = null;
const li = si().then((I) => (M = I, Fe.postMessage({ type: "ready" }), I)).catch((I) => {
  throw console.error("[cpsat_worker] cpSatModule init failed:", I), Fe.postMessage({
    type: "error",
    id: 0,
    error: String(I)
  }), I;
}), Qt = (I, A) => new DataView(I, A, 4).getUint32(0, !0), wr = (I) => {
  if (!M || !I?.length)
    return 0;
...
Fe.onmessage = async (I) => {
  ...
  try {
    ...
    if (A.type === "solve") {
      const c = await di(A.modelBytes, A.paramsBytes);
      Fe.postMessage({
        type: "solveResult",
        id: A.id,
        bytes: c
...
//# sourceMappingURL=cpsat_worker-CGyEC79i.js.map
