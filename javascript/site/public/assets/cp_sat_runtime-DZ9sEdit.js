async function eo(ze = {}) {
  ...
  var f = ze, Pe = !!globalThis.window, Y = !!globalThis.WorkerGlobalScope, He = globalThis.process?.versions?.node && globalThis.process?.type != "renderer", gr = !Pe && !He && !Y, y = Y && self.name?.startsWith("em-pthread");
  ...
  var J = console.log.bind(console), w = console.error.bind(console);
  c(Pe || Y || He, "Pthreads do not work in this environment yet (need Web Workers, or an alternative to them)"), c(!He, "node environment detected but not enabled at build time.  Add `node` to `-sENVIRONMENT` to enable."), c(!gr, "shell environment detected but not enabled at build time.  Add `shell` to `-sENVIRONMENT` to enable.");
  var Ee;
  ...
  function we() {
    if (!se) {
      ...
      (r != 34821223 || t != 2310721022) && A(`Stack overflow! Stack cookie has been overwritten at ${oe(e)}, expected hex dwords 0x89BACDFE and 0x2135467, but received ${oe(t)} ${oe(r)}`), (u(), h)[0] != 1668509029 && A("Runtime error: The application has corrupted its heap memory area (address zero)!");
    }
  }
  function qe(...e) {
    console.warn(...e);
  ...
  function Sr(e) {
    y || Object.getOwnPropertyDescriptor(f, e) || Object.defineProperty(f, e, { configurable: !0, get() {
      ...
      Zt(e) && (r += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), A(r);
    } });
  }
  function en() {
    function e() {
      var t = 0;
      return de && typeof pe < "u" && (t = pe()), `w:${kr},t:${oe(t)}:`;
    }
    var r = qe;
    qe = (...t) => r(e(), ...t);
  }
      ...
      try {
        ...
        if (n === "load") {
          ...
          for (const a of t.handlers)
            ...
            }, a == "print" && (J = f[a]), a == "printErr" && (w = f[a]));
          B = t.wasmMemory, De(), re = t.wasmModule, Ir(), Be();
        } else if (n === "run") {
          c(t.pthread_ptr), fn(t.pthread_ptr), mr(t.pthread_ptr, 0, 0, 1, 0, 0), S.threadInitTLS(), dr(t.pthread_ptr), Ye || (Wt(), Ye = !0);
          try {
        ...
        } else t.target === "setimmediate" || (n === "checkMailbox" ? Ye && We() : n && (w(`worker: received unknown command ${n}`), w(t)));
      } catch (o) {
        throw w(`worker: onmessage() captured an uncaught exception: ${o}`), o?.stack && w(o.stack), Ut(), o;
      }
    }
    self.onmessage = e;
  }
  var N, L, te, be, C, h, Fr, Se, D, Ar, de = !1;
  function De() {
    var e = B.buffer;
    N = new Int8Array(e), te = new Int16Array(e), f.HEAPU8 = L = new Uint8Array(e), be = new Uint16Array(e), C = new Int32Array(e), h = new Uint32Array(e), Fr = new Float32Array(e), Se = new Float64Array(e), D = new BigInt64Array(e), Ar = new BigUint64Array(e);
  }
  function rn() {
    if (!y) {
      if (f.wasmMemory)
  ...
  function A(e) {
    f.onAbort?.(e), e = "Aborted(" + e + ")", w(e), se = !0;
  ...
  async function ln(e, r) {
    try {
      ...
      w(`failed to asynchronously prepare wasm: ${o}`), wr(e) && w(`warning: Loading from a file URI (${e}) is not supported in most browsers. See https://emscripten.org/docs/getting_started/FAQ.html#how-do-i-run-a-local-webserver-for-testing-why-does-my-program-stall-in-downloading-or-preparing`), A(o);
    }
  }
  ...
  function Cr() {
    Ji(), ge.__instrumented || (ge.__instrumented = !0, H.instrumentWasmImports(ge));
    var e = { env: ge, wasi_snapshot_preview1: ge };
    return e;
  }
  async function Ir() {
    function e(l, d) {
      return X = l.exports, X = H.instrumentWasmExports(X), _n(X._emscripten_tls_init), Yi(X), re = d, X;
    }
    var r = f;
    function t(l) {
    ...
    if (y) {
      c(re, "wasmModule should have been received via postMessage");
      var o = new WebAssembly.Instance(re, Cr());
      return e(o, re);
    }
    Je ??= on();
    var a = await dn(Ee, Je, n), s = t(a);
    return s;
  }
  class Dr {
    name = "ExitStatus";
  ...
  var Mr = (e) => {
    ...
    var r = S.pthreads[e];
    c(r), S.returnWorkerToPool(r);
  }, Nr = (e) => {
    for (; e.length > 0; )
      e.shift()(f);
  }, Or = [], Wr = (e) => Or.push(e), ne = 0, ke = null, ce = {}, ie = null, xr = (e) => {
    if (ne--, f.monitorRunDependencies?.(ne), c(e, "removeRunDependency requires an ID"), c(ce[e]), delete ce[e], ne == 0 && (ie !== null && (clearInterval(ie), ie = null), ke)) {
      var r = ke;
      ke = null, r();
    }
  }, Lr = (e) => {
    ne++, f.monitorRunDependencies?.(ne), c(e, "addRunDependency requires an ID"), c(!ce[e]), ce[e] = 1, ie === null && globalThis.setInterval && (ie = setInterval(() => {
      if (se) {
    ...
    if (!r)
      return 6;
    c(!r.pthread_ptr, "Internal error!"), S.runningWorkers.push(r), S.pthreads[e.pthread_ptr] = r, r.pthread_ptr = e.pthread_ptr;
    var t = { cmd: "run", start_routine: e.startRoutine, arg: e.arg, pthread_ptr: e.pthread_ptr };
    return r.postMessage(t, e.transferList), 0;
  }, ue = 0, Me = () => nr || ue > 0, $r = () => pr(), Ze = (e) => Vt(e), Qe = (e) => Gt(e), R = (e, r, t, ...n) => {
    for (var o = n.length * 2, a = $r(), s = Qe(o * 8), l = s >> 3, d = 0; d < n.length; d++) {
      var _ = n[d];
      typeof _ == "bigint" ? ((u(), D)[l + 2 * d] = 1n, (u(), D)[l + 2 * d + 1] = _) : ((u(), D)[l + 2 * d] = 0n, (u(), Se)[l + 2 * d + 1] = _);
    }
    var v = $t(e, r, o, s, t);
    return Ze(a), v;
  };
  function er(e) {
    if (y) return R(0, 0, 1, e);
    le = e, Me() || (S.terminateAllThreads(), f.onExit?.(e), se = !0), Er(e, new Dr(e));
  }
  function Br(e) {
    if (y) return R(1, 0, 0, e);
    rr(e);
  }
  var cn = (e, r) => {
    if (le = e, Qi(), y)
    ...
    er(e);
  }, rr = cn, oe = (e) => (c(typeof e == "number", `ptrToString expects a number, got ${typeof e}`), e >>>= 0, "0x" + e.toString(16).padStart(8, "0")), S = { unusedWorkers: [], runningWorkers: [], tlsInitFunctions: [], pthreads: {}, nextWorkerID: 1, init() {
    y || S.initMainThread();
  }, initMainThread() {
    ...
    var r = e.pthread_ptr;
    delete S.pthreads[r], S.unusedWorkers.push(e), S.runningWorkers.splice(S.runningWorkers.indexOf(e), 1), e.pthread_ptr = 0, Bt(r);
  }, threadInitTLS() {
    ...
    e.onmessage = (a) => {
      ...
      l === "checkMailbox" ? We() : l === "spawnThread" ? Ur(s) : l === "cleanupThread" ? pt(() => Rr(s.thread)) : l === "loaded" ? (e.loaded = !0, r(e)) : s.target === "setimmediate" ? e.postMessage(s) : l === "callHandler" ? f[s.handler](...s.args) : l && w(`worker sent an unknown command ${l}`);
    }, e.onerror = (a) => {
      var s = "worker sent an error!";
      throw e.pthread_ptr && (s = `Pthread ${oe(e.pthread_ptr)} sent an error!`), w(`${s} ${a.filename}:${a.lineno}: ${a.message}`), a;
    }, c(B instanceof WebAssembly.Memory, "WebAssembly memory should have been loaded by now!"), c(re instanceof WebAssembly.Module, "WebAssembly Module should have been loaded by now!");
    var t = [], n = ["onExit", "onAbort", "print", "printErr"];
    for (var o of n)
      f.propertyIsEnumerable(o) && t.push(o);
    e.postMessage({ cmd: "load", handlers: t, wasmMemory: B, wasmModule: re, workerID: e.workerID });
    ...
    if (f.mainScriptUrlOrBlob) {
      ...
      /* @vite-ignore */
      "/assets/cp_sat_runtime-B1KD6uWN.js",
      import.meta.url
    ), { type: "module", name: "em-pthread-" + S.nextWorkerID });
  ...
  function fn(e) {
    ...
    c(r != 0), c(n != 0), c(r > n, "stackHigh must be higher then stackLow"), Ht(r, n), Ze(r), br();
  }
  var tr = [], jr = (e) => {
    var r = tr[e];
    return r || (tr[e] = r = qt.get(e), H.isAsyncExport(r) && (tr[e] = r = H.makeAsyncFunction(r))), r;
  }, Hr = async (e, r) => {
    ue = 0, nr = 0;
  ...
  Hr.isAsync = !0;
  var nr = !0, _n = (e) => S.tlsInitFunctions.push(e), Z = (e) => {
    Z.shown ||= {}, Z.shown[e] || (Z.shown[e] = 1, w(e));
    ...
    for (var a = ""; r < o; ) {
      ...
      var d = e[r++] & 63;
      if ((s & 240) == 224 ? s = (s & 15) << 12 | l << 6 | d : ((s & 248) != 240 && Z("Invalid UTF-8 leading byte " + oe(s) + " encountered when deserializing a UTF-8 string in wasm memory to a JS string!"), s = (s & 7) << 18 | l << 12 | d << 6 | e[r++] & 63), s < 65536)
        a += String.fromCharCode(s);
      else {
        var _ = s - 65536;
    ...
    return a;
  }, G = (e, r, t) => (c(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? fe((u(), L), e, r, t) : ""), mn = (e, r, t, n) => A(`Assertion failed: ${G(e)}, at: ` + [r ? G(r) : "unknown filename", t, n ? G(n) : "unknown function"]);
  class vn {
    constructor(r) {
  ...
  function qr(e, r, t, n) {
    return y ? R(2, 0, 1, e, r, t, n) : Kr(e, r, t, n);
  }
  var pn = () => !!globalThis.SharedArrayBuffer, Kr = (e, r, t, n) => {
  ...
  }, basename: (e) => e && e.match(/([^\/]+|\/)\/*$/)[1], join: (...e) => T.normalize(e.join("/")), join2: (e, r) => T.normalize(e + "/" + r) }, gn = () => (e) => e.set(crypto.getRandomValues(new Uint8Array(e.byteLength))), ir = (e) => {
    (ir = gn())(e);
  }, me = { resolve: (...e) => {
    ...
    for (var o = t, a = t + n - 1, s = 0; s < e.length; ++s) {
      ...
      if (l <= 127) {
        ...
        if (t + 3 >= a) break;
        l > 1114111 && Z("Invalid Unicode code point " + oe(l) + " encountered when serializing a JS string to a UTF-8 string in wasm memory! (Valid unicode code points should be in range 0-0x10FFFF)."), r[t++] = 240 | l >> 18, r[t++] = 128 | l >> 12 & 63, r[t++] = 128 | l >> 6 & 63, r[t++] = 128 | l & 63, s++;
      }
    }
    return r[t] = 0, t - o;
  }, ar = (e, r, t) => {
    var n = Q(e) + 1, o = new Array(n), a = Xr(e, o, 0, o.length);
    return o.length = a, o;
  }, yn = () => {
    if (!or.length) {
      var e = null;
...
`)), !e)
    ...
    ee.ttys[e] = { input: [], output: [], ops: r }, i.registerDevice(e, ee.stream_ops);
  }, stream_ops: { open(e) {
    ...
    r === null || r === 10 ? (w(fe(e.output)), e.output = []) : r != 0 && e.output.push(r);
  }, fsync(e) {
    e.output?.length > 0 && (w(fe(e.output)), e.output = []);
  } } }, En = (e, r) => (u(), L).fill(0, e, e + r), Yr = (e, r) => (c(r, "alignment argument is required"), Math.ceil(e / r) * r), Jr = (e) => {
    e = Yr(e, 65536);
    var r = Lt(65536, e);
    return r && En(r, e), r;
    ...
    var d = r ? me.resolve(T.join2(e, r)) : e, _ = Tn(`cp ${d}`);
    Lr(_);
    try {
      var v = t;
      typeof t == "string" && (v = await Sn(t)), v = await Fn(v, d), l?.(), a || kn(e, r, v, n, o, s);
    } finally {
      xr(_);
    }
  }, An = (e, r, t, n, o, a, s, l, d, _) => {
    ...
    i.mkdir("/dev"), i.registerDevice(i.makedev(1, 3), { read: () => 0, write: (n, o, a, s, l) => s, llseek: () => 0 }), i.mkdev("/dev/null", i.makedev(1, 3)), ee.register(i.makedev(5, 0), ee.default_tty_ops), ee.register(i.makedev(6, 0), ee.default_tty1_ops), i.mkdev("/dev/tty", i.makedev(5, 0)), i.mkdev("/dev/tty1", i.makedev(6, 0));
    ...
    class a {
      ...
      cacheLength() {
        ...
        var p = Number(m.getResponseHeader("Content-length")), k, b = (k = m.getResponseHeader("Accept-Ranges")) && k === "bytes", I = (k = m.getResponseHeader("Content-Encoding")) && k === "gzip", W = 1024 * 1024;
        b || (W = p);
        var x = (V, ye) => {
          V > ye && A("invalid range (" + V + ", " + ye + ") or no bytes requested!"), ye > p - 1 && A("only " + p + " bytes available! programmer error!");
          var O = new XMLHttpRequest();
          return O.open("GET", t, !1), p !== W && O.setRequestHeader("Range", "bytes=" + V + "-" + ye), O.responseType = "arraybuffer", O.overrideMimeType && O.overrideMimeType("text/plain; charset=x-user-defined"), O.send(null), O.status >= 200 && O.status < 300 || O.status === 304 || A("Couldn't load " + t + ". Status: " + O.status), O.response !== void 0 ? new Uint8Array(O.response || []) : ar(O.responseText || "");
        }, Ae = this;
        Ae.setDataGetter((V) => {
          var ye = V * W, O = (V + 1) * W - 1;
          return O = Math.min(O, p - 1), typeof Ae.chunks[V] > "u" && (Ae.chunks[V] = x(ye, O)), typeof Ae.chunks[V] > "u" && A("doXHR failed!"), Ae.chunks[V];
    ...
    return _.read = (g, m, p, k, b) => (i.forceLoadFile(d), v(g, m, p, k, b)), _.mmap = (g, m, p, k, b) => {
      i.forceLoadFile(d);
      var I = Jr(m);
      if (!I)
        throw new i.ErrnoError(48);
    ...
    (u(), h)[e >> 2] = r.dev, (u(), h)[e + 4 >> 2] = r.mode, (u(), h)[e + 8 >> 2] = r.nlink, (u(), h)[e + 12 >> 2] = r.uid, (u(), h)[e + 16 >> 2] = r.gid, (u(), h)[e + 20 >> 2] = r.rdev, (u(), D)[e + 24 >> 3] = BigInt(r.size), (u(), C)[e + 32 >> 2] = 4096, (u(), C)[e + 36 >> 2] = r.blocks;
    var t = r.atime.getTime(), n = r.mtime.getTime(), o = r.ctime.getTime();
    return (u(), D)[e + 40 >> 3] = BigInt(Math.floor(t / 1e3)), (u(), h)[e + 48 >> 2] = t % 1e3 * 1e3 * 1e3, (u(), D)[e + 56 >> 3] = BigInt(Math.floor(n / 1e3)), (u(), h)[e + 64 >> 2] = n % 1e3 * 1e3 * 1e3, (u(), D)[e + 72 >> 3] = BigInt(Math.floor(o / 1e3)), (u(), h)[e + 80 >> 2] = o % 1e3 * 1e3 * 1e3, (u(), D)[e + 88 >> 3] = BigInt(r.ino), 0;
  }, writeStatFs(e, r) {
  ...
  var Pn = () => A("native code called abort()"), U = (e) => {
    for (var r = ""; ; ) {
      var t = (u(), L)[e++];
      if (!t) return r;
      r += String.fromCharCode(t);
    }
  }, ve = {}, he = {}, Ne = {}, Cn = class extends Error {
    constructor(r) {
  ...
  function In(e, r, t = {}) {
    ...
    if (he[e] = r, delete Ne[e], ve.hasOwnProperty(e)) {
      var o = ve[e];
  ...
  var lt = (e, r, t) => {
    switch (r) {
      ...
      case 2:
        return t ? (n) => (u(), te)[n >> 1] : (n) => (u(), be)[n >> 1];
      case 4:
    ...
    if (r < t || r > n)
      throw new TypeError(`Passing a number "${Oe(r)}" from JS side to C/C++ side to an argument of type "${e}", which is outside the valid range [${t}, ${n}]!`);
  }, Dn = (e, r, t, n, o) => {
    r = U(r);
    const a = n === 0n;
    let s = (l) => l;
    ...
    z(e, { name: r, fromWireType: s, toWireType: (l, d) => {
      if (typeof d == "number")
        ...
        throw new TypeError(`Cannot convert "${Oe(d)}" to ${this.name}`);
      return dt(r, d, n, o), d;
  ...
  }, ct = [], q = [0, 1, , 1, null, 1, !0, 1, !1, 1], Rn = (e) => {
    e > 9 && --q[e + 1] === 0 && (c(q[e] !== void 0, "Decref for unallocated handle."), q[e] = void 0, ct.push(e));
  }, ut = { toValue: (e) => (e || $(`Cannot use deleted val. handle = ${e}`), c(e === 2 || q[e] !== void 0 && e % 2 === 0, `invalid handle: ${e}`), q[e]), toHandle: (e) => {
    switch (e) {
      case void 0:
        return 2;
      case null:
  ...
  var Nn = { name: "emscripten::val", fromWireType: (e) => {
    var r = ut.toValue(e);
    return Rn(e), r;
  }, toWireType: (e, r) => ut.toHandle(r), readValueFromPointer: lr, destructorFunction: null }, On = (e) => z(e, Nn), Wn = (e, r) => {
    switch (r) {
      case 4:
        return function(t) {
    ...
    r = U(r), z(e, { name: r, fromWireType: (n) => n, toWireType: (n, o) => {
      if (typeof o != "number" && typeof o != "boolean")
        throw new TypeError(`Cannot convert ${Oe(o)} to ${this.name}`);
      return o;
    }, readValueFromPointer: Wn(r, t), destructorFunction: null });
...
${_}`, new Function(g, _);
  ...
  function zn(e, r, t, n, o, a) {
    var s = r.length;
    s < 2 && $("argTypes array size mismatch! Must at least get return value and 'this' types!");
    for (var l = r[1] !== null && t !== null, d = _t(r), _ = !r[0].isVoid, v = s - 2, g = Bn(r), m = r[0], p = r[1], k = [e, $, n, o, Ln, m.fromWireType.bind(m), p?.toWireType.bind(p)], b = 2; b < s; ++b) {
      var I = r[b];
  ...
  var jn = (e, r, t) => {
    ...
    f.hasOwnProperty(e) ? ((t === void 0 || f[e].overloadTable !== void 0 && f[e].overloadTable[t] !== void 0) && $(`Cannot register public name '${e}' twice`), jn(f, e, e), f[e].overloadTable.hasOwnProperty(t) && $(`Cannot register multiple overloads of a function with the same number of arguments (${t})!`), f[e].overloadTable[t] = r) : (f[e] = r, f[e].argCount = t);
  }, Vn = (e, r) => {
    for (var t = [], n = 0; n < e; n++)
      t.push((u(), h)[r + n * 4 >> 2]);
    return t;
  ...
  var Yn = (e) => {
    ...
    throw r.forEach(o), new Xn(`${e}: ` + t.map(Yn).join([", "]));
  }, Zn = (e, r, t) => {
    e.forEach((l) => Ne[l] = r);
    function n(l) {
      var d = t(l);
    ...
    var d = Vn(r, t);
    e = U(e), e = Qn(e), o = Kn(n, o, s), Hn(e, function() {
      Jn(`Cannot call ${e} due to unbound types`, d);
    }, r - 1), Zn([], d, (_) => {
      var v = [_[0], null].concat(_.slice(1));
      return qn(e, zn(e, v, null, o, a, s), r - 1), [];
    });
  }, ri = (e, r, t, n, o) => {
    r = U(r);
    const a = n === 0;
    ...
    z(e, { name: r, fromWireType: s, toWireType: (d, _) => {
      if (typeof _ != "number" && typeof _ != "boolean")
        throw new TypeError(`Cannot convert "${Oe(_)}" to ${r}`);
      return dt(r, _, n, o), _;
  ...
  }, j = (e, r, t) => (c(typeof t == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), Xr(e, (u(), L), r, t)), ni = (e, r) => {
    r = U(r), z(e, { name: r, fromWireType(t) {
      var n = (u(), h)[t >> 2], o = t + 4, a;
      return a = G(o, n, !0), K(t), a;
    }, toWireType(t, n) {
      n instanceof ArrayBuffer && (n = new Uint8Array(n));
      var o, a = typeof n == "string";
      a || ArrayBuffer.isView(n) && n.BYTES_PER_ELEMENT == 1 || $("Cannot pass non-string to std::string"), a ? o = Q(n) : o = n.length;
      var s = Fe(4 + o + 1), l = s + 4;
      return (u(), h)[s >> 2] = o, a ? j(n, l, o + 1) : (u(), L).set(n, l), t !== null && t.push(K, s), s;
    ...
    return (u(), te)[r >> 1] = 0, r - n;
  }, ai = (e) => e.length * 2, si = (e, r, t) => {
    ...
    t = U(t);
    var n, o, a;
    r === 2 ? (n = ii, o = oi, a = ai) : (c(r === 4, "only 2-byte and 4-byte strings are currently supported"), n = si, o = li, a = di), z(e, { name: t, fromWireType: (s) => {
      var l = (u(), h)[s >> 2], d = n(s + 4, l * r, !0);
      return K(s), d;
    }, toWireType: (s, l) => {
      typeof l != "string" && $(`Cannot pass non-string to C++ string type ${t}`);
      var d = a(l), _ = Fe(4 + d + r);
    ...
    mr(e, !Y, 1, !Pe, 65536, !1), S.threadInitTLS();
  }, ht = (e) => {
    if (e instanceof Dr || e == "unwind")
      return le;
    we(), e instanceof WebAssembly.RuntimeError && pr() <= 0 && w("Stack overflow detected.  You can try increasing -sSTACK_SIZE (currently set to 65536)"), Er(1, e);
  }, _i = () => {
    if (!Me())
      try {
        if (y) {
    ...
    for (var a = o >> 3, s = 0; s < n; s++)
      (u(), D)[a + 2 * s] ? xe[s] = (u(), D)[a + 2 * s + 1] : xe[s] = (u(), Se)[a + 2 * s + 1];
    var l = r ? fr[r] : Ki[e];
    c(!(e && r)), c(l.length == n, "Call args mismatch in _emscripten_receive_on_main_thread_js"), S.currentProxiedOperationCallerThread = t;
    var d = l(...xe);
    return S.currentProxiedOperationCallerThread = 0, c(typeof d != "bigint"), d;
  }, hi = (e) => {
    y ? postMessage({ cmd: "cleanupThread", thread: e }) : Rr(e);
  }, pi = (e) => {
  }, gi = 9007199254740992, yi = -9007199254740992, cr = (e) => e < yi || e > gi ? NaN : Number(e);
  function gt(e, r, t, n, o, a, s) {
    if (y) return R(10, 0, 1, e, r, t, n, o, a, s);
    o = cr(o);
    try {
      c(!isNaN(o));
  ...
  function yt(e, r, t, n, o, a) {
    if (y) return R(11, 0, 1, e, r, t, n, o, a);
    a = cr(a);
    try {
  ...
  var Ei = (e, r, t, n) => {
    ...
    var v = (p) => {
      var k = p >= 0 ? "-" : "+", b = Math.abs(p), I = String(Math.floor(b / 60)).padStart(2, "0"), W = String(b % 60).padStart(2, "0");
      return `UTC${k}${I}${W}`;
    }, g = v(l), m = v(d);
    c(g), c(m), c(Q(g) <= 16, `timezone name truncated to fit in TZNAME_MAX (${g})`), c(Q(m) <= 16, `timezone name truncated to fit in TZNAME_MAX (${m})`), d < l ? (j(g, t, 17), j(m, n, 17)) : (j(g, n, 17), j(m, t, 17));
  ...
  function Si(e, r, t) {
    ...
    return (u(), D)[t >> 3] = BigInt(o), 0;
  }
  var Le = [], ki = (e, r) => {
    c(Array.isArray(Le)), c(r % 16 == 0), Le.length = 0;
    for (var t; t = (u(), L)[e++]; ) {
      ...
      var a = t != 105;
      a &= t != 112, r += a && r % 8 ? 4 : 0, Le.push(t == 112 ? (u(), h)[r >> 2] : t == 106 ? (u(), D)[r >> 3] : t == 105 ? (u(), C)[r >> 2] : (u(), Se)[r >> 3]), r += a ? 8 : 4;
    }
    return Le;
  }, Ti = (e, r, t) => {
    var n = ki(r, t);
    ...
    throw wt(), "unwind";
  }, bt = () => 2147483648, Ii = () => bt(), Di = () => navigator.hardwareConcurrency, ae = {}, St = (e) => {
    var r = Q(e) + 1, t = Fe(r);
    return t && j(e, t, r), t;
  }, Ue = (e) => {
    var r;
    ...
    var e = Tt().split(`
`);
    return e[0] == "Error" && e.shift(), kt(e), ae.last_addr = Ue(e[3]), ae.last_stack = e, ae.last_addr;
  }, $e = (e) => {
    var r = ae[e];
    if (!r) return 0;
    var t, n;
    if (n = /^\s+at .*\.wasm\.(.*) \(.*\)$/.exec(r))
      ...
      return 0;
    return K($e.ret ?? 0), $e.ret = St(t), $e.ret;
  }, Ri = (e) => {
    var r = B.buffer.byteLength, t = (e - r + 65535) / 65536 | 0;
    try {
      return B.grow(t), De(), 1;
    } catch (n) {
...
`), n[0] == "Error" && n.shift(), kt(n));
    for (var o = 3; n[o] && Ue(n[o]) != e; )
      ++o;
    for (var a = 0; a < t && n[a + o]; ++a)
      (u(), C)[r + a * 4 >> 2] = Ue(n[a + o]);
    return a;
  }, ur = {}, Wi = () => yr || "./this.program", Te = () => {
    if (!Te.strings) {
      var e = (typeof navigator == "object" && navigator.language || "C").replace("-", "_") + ".UTF-8", r = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: e, _: Wi() };
      for (var t in ur)
  ...
  function Ft(e, r) {
    if (y) return R(12, 0, 1, e, r);
    var t = 0, n = 0;
    for (var o of Te()) {
      var a = r + t;
      (u(), h)[e + n >> 2] = a, t += j(o, a, 1 / 0) + 1, n += 4;
    }
    return 0;
  }
  function At(e, r) {
    if (y) return R(13, 0, 1, e, r);
    var t = Te();
    (u(), h)[e >> 2] = t.length;
    var n = 0;
    for (var o of t)
  ...
  function It(e, r, t, n) {
    if (y) return R(16, 0, 1, e, r, t, n);
    r = cr(r);
    try {
      if (isNaN(r)) return 61;
      var o = P.getStreamFromFD(e);
      return i.llseek(o, r, t), (u(), D)[n >> 3] = BigInt(o.position), o.getdents && r === 0 && t === 0 && (o.getdents = null), 0;
    } catch (a) {
      if (typeof i > "u" || a.name !== "ErrnoError") throw a;
      return a.errno;
    }
  ...
  function Dt(e, r, t, n) {
    if (y) return R(17, 0, 1, e, r, t, n);
    try {
      var o = P.getStreamFromFD(e), a = Li(o, r, t);
      return (u(), h)[n >> 2] = a, 0;
    } catch (s) {
      if (typeof i > "u" || s.name !== "ErrnoError") throw s;
      return s.errno;
  ...
  var $i = () => {
    ...
    H.asyncExports = /* @__PURE__ */ new Set();
    var t = {};
    for (let [o, a] of Object.entries(e))
      if (typeof a == "function") {
        r.test(o) && (H.asyncExports.add(a), a = H.makeAsyncFunction(a));
        var n = H.instrumentFunction(a);
        t[o] = n;
      } else
        t[o] = a;
    return t;
  }, asyncExports: null, isAsyncExport(e) {
    return H.asyncExports?.has(e);
  }, handleAsync: async (e) => {
    wt();
    try {
      return await e();
  ...
  }, handleSleep: (e) => H.handleAsync(() => new Promise(e)), makeAsyncFunction(e) {
    ...
    var a = { string: (b) => {
      var I = 0;
      return b != null && b !== 0 && (I = ji(b)), I;
    }, array: (b) => {
      var I = Qe(b.length);
      return zi(b, I), I;
    } };
    function s(b) {
      return r === "string" ? G(b) : r === "boolean" ? !!b : b;
    }
    var l = Bi(e), d = [], _ = 0;
  ...
  qi.forEach(Sr);
  var Ki = [er, Br, qr, rt, tt, nt, it, ot, at, st, gt, yt, Ft, At, Pt, Ct, It, Dt];
  function Xi() {
    Jt("fetchSettings");
  }
  ...
  Nt.sig = "i";
  var Ot = F("___getTypeName"), Wt = F("__embind_initialize_bindings");
  ...
  function Be() {
    ...
    async function e() {
      c(!Kt), Kt = !0, f.calledRun = !0, !se && (Pr(), Ke?.(f), f.onRuntimeInitialized?.(), Ie("onRuntimeInitialized"), c(!f._main, 'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]'), nn());
    }
  ...
  function Qi() {
    ...
    try {
      ...
      for (var n of ["stdout", "stderr"]) {
        ...
        if (!o) return;
        var a = o.object, s = a.rdev, l = ee.ttys[s];
        l?.output?.length && (t = !0);
      }
    } catch {
    }
    J = e, w = r, t && Z("stdio streams had content in them that was not flushed. you should set EXIT_RUNTIME to 1 (see the Emscripten FAQ), or make sure to emit a newline when you printf etc.");
  }
  var X;
...
var ro = globalThis.self?.name?.startsWith("em-pthread");
ro && eo();
export {
  eo as default
};
//# sourceMappingURL=cp_sat_runtime-DZ9sEdit.js.map
