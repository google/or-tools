(async ()=>{
    ...
    async function sn(A = {}) {
        ...
        var c = A, B = !!globalThis.window, L = !!globalThis.WorkerGlobalScope, T = globalThis.process?.versions?.node && globalThis.process?.type != "renderer", me = !B && !T && !L, y = L && self.name?.startsWith("em-pthread");
...
`);
        ...
        function Me() {
            if (!_e) {
                ...
                (r != 34821223 || t != 2310721022) && I(`Stack overflow! Stack cookie has been overwritten at ${ce(e)}, expected hex dwords 0x89BACDFE and 0x2135467, but received ${ce(t)} ${ce(r)}`), (f(), h)[0] != 1668509029 && I("Runtime error: The application has corrupted its heap memory area (address zero)!");
            }
        }
        function nr(...e) {
            if (T) {
...
`);
        ...
        function Rr(e) {
            y || Object.getOwnPropertyDescriptor(c, e) || Object.defineProperty(c, e, {
                ...
                get () {
                    ...
                    mn(e) && (r += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), I(r);
                }
            });
        }
        function vn() {
        ...
        async function bn(e, r) {
            try {
                ...
                b(`failed to asynchronously prepare wasm: ${i}`), $e(e) && b(`warning: Loading from a file URI (${e}) is not supported in most browsers. See https://emscripten.org/docs/getting_started/FAQ.html#how-do-i-run-a-local-webserver-for-testing-why-does-my-program-stall-in-downloading-or-preparing`), I(i);
            }
        }
        ...
        var mr = !0, An = (e)=>w.tlsInitFunctions.push(e), ie = (e)=>{
            ...
            return a;
        }, Z = (e, r, t)=>(u(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? ye((f(), H), e, r, t) : ""), Pn = (e, r, t, n)=>I(`Assertion failed: ${Z(e)}, at: ` + [
...
`));
            ...
            writeFile (e, r, t = {}) {
                ...
                typeof r == "string" && (r = new Uint8Array(hr(r))), ArrayBuffer.isView(r) ? o.write(n, r, 0, r.byteLength, void 0, t.canOwn) : I("Unsupported data type"), o.close(n);
            },
            cwd: ()=>o.currentPath,
            chdir (e) {
                var r = o.lookupPath(e, {
            ...
            forceLoadFile (e) {
                ...
                if (globalThis.XMLHttpRequest) I("Lazy loading should have been performed (contents set) in createLazyFile, but it was not. Lazy loading only works in web workers. Use --embed-file or --preload-file in emcc on the main thread.");
                else try {
                    e.contents = Pe(e.url);
                } catch  {
                    throw new o.ErrnoError(29);
            ...
            createLazyFile (e, r, t, n, i) {
                class a {
                    ...
                    cacheLength() {
                        ...
                        S || (j = p);
                        var z = (Y, Fe)=>{
                            Y > Fe && I("invalid range (" + Y + ", " + Fe + ") or no bytes requested!"), Fe > p - 1 && I("only " + p + " bytes available! programmer error!");
                            var $ = new XMLHttpRequest();
                            return $.open("GET", t, !1), p !== j && $.setRequestHeader("Range", "bytes=" + Y + "-" + Fe), $.responseType = "arraybuffer", $.overrideMimeType && $.overrideMimeType("text/plain; charset=x-user-defined"), $.send(null), $.status >= 200 && $.status < 300 || $.status === 304 || I("Couldn't load " + t + ". Status: " + $.status), $.response !== void 0 ? new Uint8Array($.response || []) : hr($.responseText || "");
                        }, We = this;
                        We.setDataGetter((Y)=>{
                            var Fe = Y * j, $ = (Y + 1) * j - 1;
                            return $ = Math.min($, p - 1), typeof We.chunks[Y] > "u" && (We.chunks[Y] = z(Fe, $)), typeof We.chunks[Y] > "u" && I("doXHR failed!"), We.chunks[Y];
                ...
                if (globalThis.XMLHttpRequest) {
                    L || I("Cannot do synchronous binary XHRs outside webworkers in modern browsers. Use --embed-file or --preload-file in emcc");
                    var s = new a(), l = {
                        isDevice: !1,
                        contents: s
                    };
        ...
        var jn = ()=>I("native code called abort()"), V = (e)=>{
            for(var r = "";;){
                var t = (f(), H)[e++];
                if (!t) return r;
...
`), n[0] == "Error" && n.shift(), Ot(n));
        ...
        Ht.sig = "i";
        var Vt = P("___getTypeName"), Gt = P("__embind_initialize_bindings");
        ...
        var Ze = c._malloc = P("_malloc");
        c._free_buffer = P("_free_buffer");
        var re = c._free = P("_free");
        c._interrupt_solve = P("_interrupt_solve"), c._validate_model = P("_validate_model");
        var ke = P("_pthread_self"), Sr = P("_fflush"), Kt = P("_strerror"), Xt = P("_emscripten_builtin_memalign"), kr = P("__emscripten_thread_init"), qt = P("__emscripten_thread_crashed"), Tr = P("_emscripten_stack_get_end"), Yt = P("__emscripten_run_js_on_main_thread"), Jt = P("__emscripten_thread_free_data"), Fr = P("__emscripten_thread_exit"), Zt = P("__emscripten_check_mailbox"), Qt = P("_emscripten_stack_init"), en = P("_emscripten_stack_set_limits"), rn = P("__emscripten_stack_restore"), tn = P("__emscripten_stack_alloc"), Ar = P("_emscripten_stack_get_current"), nn = P("wasmTable");
        function ui(e) {
        ...
        var te;
        y || (te = await Br(), Qe()), he ? C = c : C = new Promise((e, r)=>{
            or = e, ir = r;
        });
        for (const e of Object.keys(c))e in A || Object.defineProperty(A, e, {
            configurable: !0,
            get () {
    ...
    const Ae = self;
    let D = null;
    const pi = hi().then((A)=>A()).then((A)=>(D = A, Ae.postMessage({
            type: "ready"
        }), A)).catch((A)=>{
        throw console.error("[cpsat_worker] cpSatModule init failed:", A), Ae.postMessage({
            type: "error",
            id: 0,
            error: String(A)
        }), A;
    }), dn = (A, C)=>new DataView(A, C, 4).getUint32(0, !0), Pr = (A)=>{
        if (!D || !A?.length) return 0;
        const C = D._malloc(A.length);
        return D.HEAPU8.set(A, C), C;
    };
    async function gi(A, C) {
        if (!D) throw new Error("Module not initialized.");
        const c = D._malloc(4), B = Pr(A), L = Pr(C ?? null);
        let T = 0;
        try {
    ...
    async function yi(A) {
        ...
        const L = dn(D.HEAPU8.buffer, C);
        if (D._free(C), !B || L === 0) return B && D._free_buffer(B), {
            ok: !0,
            message: ""
        };
    ...
    Ae.onmessage = async (A)=>{
        ...
        try {
            ...
            if (C.type === "solve") {
                const c = await gi(C.modelBytes, C.paramsBytes);
                Ae.postMessage({
                    type: "solveResult",
                    id: C.id,
                    bytes: c
            ...
            console.error("[cpsat_worker] request failed", C?.type, c), Ae.postMessage({
                type: "error",
                id: C?.id ?? 0,
                error: String(c)
            });
