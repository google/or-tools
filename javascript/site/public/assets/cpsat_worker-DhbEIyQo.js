...
`);
        ...
        var U, H, le, Re, D, p, xr, De, O, Lr, pe = !1;
        function je() {
            var e = K.buffer;
            U = new Int8Array(e), le = new Int16Array(e), c.HEAPU8 = H = new Uint8Array(e), Re = new Uint16Array(e), D = new Int32Array(e), p = new Uint32Array(e), xr = new Float32Array(e), De = new Float64Array(e), O = new BigInt64Array(e), Lr = new BigUint64Array(e);
        }
        function pn() {
            if (!y) {
        ...
        var zr = (e)=>{
            ...
            for(var i = n.length * 2, a = Jr(), s = dr(i * 8), l = s >> 3, d = 0; d < n.length; d++){
                var m = n[d];
                typeof m == "bigint" ? ((f(), O)[l + 2 * d] = 1n, (f(), O)[l + 2 * d + 1] = m) : ((f(), O)[l + 2 * d] = 0n, (f(), De)[l + 2 * d + 1] = m);
            }
            var v = Yt(e, r, i, s, t);
            return lr(a), v;
        };
        ...
        var kn = (e, r)=>{
            ...
            initMainThread () {
                for(var e = 8; e--;)w.allocateUnusedWorker();
                Kr(async ()=>{
            ...
            allocateUnusedWorker () {
                ...
                } else e = new Worker(new URL("/assets/cp_sat_runtime-YPUZiRY1.js", import.meta.url), {
                    type: "module",
                    workerData: "em-pthread",
                    name: "em-pthread-" + w.nextWorkerID
                });
        ...
        function Fn(e) {
            ...
            u(r != 0), u(n != 0), u(r > n, "stackHigh must be higher then stackLow"), en(r, n), lr(r), Rr();
        }
        var fr = [], et = (e)=>{
            var r = fr[e];
...
`));
            ...
            rename (e, r) {
                ...
                if (m !== g) {
                    var _ = o.isDir(m.mode), h = o.mayDelete(l, i, _);
                    if (h) throw new o.ErrnoError(h);
                    if (h = g ? o.mayDelete(d, a, _) : o.mayCreate(d, a), h) throw new o.ErrnoError(h);
            ...
            createLazyFile (e, r, t, n, i) {
                class a {
                    ...
                    get(_) {
                        if (!(_ > this.length - 1 || _ < 0)) {
                            var h = _ % this.chunkSize, k = _ / this.chunkSize | 0;
                    ...
                    cacheLength() {
                        ...
                        var h = Number(_.getResponseHeader("Content-length")), k, S = (k = _.getResponseHeader("Accept-Ranges")) && k === "bytes", N = (k = _.getResponseHeader("Content-Encoding")) && k === "gzip", j = 1024 * 1024;
                        S || (j = h);
                        var z = (Y, Fe)=>{
                ...
                var m = {};
                for (const [g, _] of Object.entries(d.stream_ops))m[g] = (...h)=>(o.forceLoadFile(d), _(...h));
                function v(g, _, h, k, S) {
                    var N = g.node.contents;
                    if (S >= N.length) return 0;
                    var j = Math.min(N.length - S, k);
                    if (u(j >= 0), N.slice) for(var z = 0; z < j; z++)_[h + z] = N[S + z];
                    else for(var z = 0; z < j; z++)_[h + z] = N.get(S + z);
                    return j;
                }
                return m.read = (g, _, h, k, S)=>(o.forceLoadFile(d), v(g, _, h, k, S)), m.mmap = (g, _, h, k, S)=>{
                    o.forceLoadFile(d);
                    var N = lt(_);
                    if (!N) throw new o.ErrnoError(48);
                    return v(g, (f(), U), N, _, h), {
                        ptr: N,
                        allocated: !0
                    };
                }, d.stream_ops = m, d;
            ...
            writeStat (e, r) {
                (f(), p)[e >> 2] = r.dev, (f(), p)[e + 4 >> 2] = r.mode, (f(), p)[e + 8 >> 2] = r.nlink, (f(), p)[e + 12 >> 2] = r.uid, (f(), p)[e + 16 >> 2] = r.gid, (f(), p)[e + 20 >> 2] = r.rdev, (f(), O)[e + 24 >> 3] = BigInt(r.size), (f(), D)[e + 32 >> 2] = 4096, (f(), D)[e + 36 >> 2] = r.blocks;
                    ...
                    case 21505:
                        {
                            ...
                            if (n.tty.ops.ioctl_tcgets) {
                                ...
                                (f(), D)[a >> 2] = i.c_iflag || 0, (f(), D)[a + 4 >> 2] = i.c_oflag || 0, (f(), D)[a + 8 >> 2] = i.c_cflag || 0, (f(), D)[a + 12 >> 2] = i.c_lflag || 0;
                    ...
                    case 21508:
                        {
                            ...
                            if (n.tty.ops.ioctl_tcsets) {
                                for(var a = Ee(), l = (f(), D)[a >> 2], d = (f(), D)[a + 4 >> 2], m = (f(), D)[a + 8 >> 2], v = (f(), D)[a + 12 >> 2], g = [], s = 0; s < 32; s++)g.push((f(), U)[a + s + 17]);
        ...
        var yt = (e, r, t)=>{
            switch(r){
                ...
                case 2:
                    return t ? (n)=>(f(), le)[n >> 1] : (n)=>(f(), Re)[n >> 1];
                case 4:
                    return t ? (n)=>(f(), D)[n >> 2] : (n)=>(f(), p)[n >> 2];
                case 8:
        ...
        var Xn = {
            ...
            switch(r){
                ...
                case 8:
                    return function(t) {
                        return this.fromWireType((f(), De)[t >> 3]);
                    };
                default:
...
return ret;
`), m += `}
`, m += "return " + (n ? "rv.then(onDone)" : `onDone(${h})`) + ";", m += `}
...
${m}`, new Function(g, m);
        ...
        function to(e, r, t, n, i, a) {
            ...
            for(var l = r[1] !== null && t !== null, d = kt(r), m = !r[0].isVoid, v = s - 2, g = ro(r), _ = r[0], h = r[1], k = [
                e,
                G,
                n,
                i,
        ...
        var uo = (e)=>{
            ...
            var n = e >> 1, i = nt((f(), Re), n, r / 2, t);
            if (i - n > 16 && Ft) return Ft.decode((f(), Re).slice(n, i));
            for(var a = "", s = n; s < i; ++s){
                var l = (f(), Re)[s];
            ...
            for(var n = r, i = n + t - 4, a = 0; a < e.length; ++a){
                ...
                if (s > 65535 && a++, (f(), D)[r >> 2] = s, r += 4, r + 4 > i) break;
            }
            ...
            r === 2 ? (n = yo, i = Eo, a = wo) : (u(r === 4, "only 2-byte and 4-byte strings are currently supported"), n = bo, i = So, a = ko), X(e, {
                ...
                toWireType: (s, l)=>{
                    ...
                    return (f(), p)[m >> 2] = d / r, i(l, m + 4, d + r), s !== null && s.push(re, m), m;
                },
                readValueFromPointer: gr,
            ...
            n /= 2, Xe.length = n;
            for(var a = i >> 3, s = 0; s < n; s++)(f(), O)[a + 2 * s] ? Xe[s] = (f(), O)[a + 2 * s + 1] : Xe[s] = (f(), De)[a + 2 * s + 1];
            var l = r ? br[r] : di[e];
            ...
            T && w.pthreads[e].ref();
        }, Do = 9007199254740992, No = -9007199254740992, Er = (e)=>e < No || e > Do ? NaN : Number(e);
        function Ct(e, r, t, n, i, a, s) {
            ...
            try {
                ...
                return (f(), D)[a >> 2] = d.allocated, (f(), p)[s >> 2] = m, 0;
            } catch (v) {
        ...
        var qe = [], Uo = (e, r)=>{
            ...
            for(var t; t = (f(), H)[e++];){
                ...
                var a = t != 105;
                a &= t != 112, r += a && r % 8 ? 4 : 0, qe.push(t == 112 ? (f(), p)[r >> 2] : t == 106 ? (f(), O)[r >> 3] : t == 105 ? (f(), D)[r >> 2] : (f(), De)[r >> 3]), r += a ? 8 : 4;
            }
            return qe;
        }, $o = (e, r, t)=>{
            var n = Uo(r, t);
            ...
            throw Rt(), "unwind";
        }, Dt = ()=>2147483648, Vo = ()=>Dt(), Go = ()=>T ? J("os").cpus().length : navigator.hardwareConcurrency, fe = {}, Nt = (e)=>{
            var r = ue(e) + 1, t = Ze(r);
            return t && ee(e, t, r), t;
        }, Ye = (e)=>{
            var r;
...
`), n[0] == "Error" && n.shift(), Ot(n));
            ...
            for(var a = 0; a < t && n[a + i]; ++a)(f(), D)[r + a * 4 >> 2] = Ye(n[a + i]);
            return a;
        ...
        function fi() {
            Te = {
                ...
                _emscripten_thread_set_strongref: Ro,
                _mmap_js: Ct,
                _munmap_js: It,
                _tzset_js: Oo,
                clock_time_get: Lo,
    ...
    const Ae = self;
    let R = null;
    const hi = pi().then((M)=>(R = M, Ae.postMessage({
            type: "ready"
        }), M)).catch((M)=>{
        ...
        const P = R._malloc(M.length);
        return R.HEAPU8.set(M, P), P;
    };
    async function gi(M, P) {
        if (!R) throw new Error("Module not initialized.");
        const c = R._malloc(4), B = Pr(M), L = Pr(P ?? null);
        let T = 0;
        try {
            T = await R.ccall("solve_model", "number", [
                "number",
                "number",
                "number",
                "number",
            ...
            B && R._free(B), L && R._free(L);
        }
        const me = dn(R.HEAPU8.buffer, c);
        if (R._free(c), !T || me === 0) return T && R._free_buffer(T), new Uint8Array();
        const y = R.HEAPU8.slice(T, T + me);
        return R._free_buffer(T), y;
    }
    async function yi(M) {
        if (!R) throw new Error("Module not initialized.");
        const P = R._malloc(4), c = Pr(M);
        let B = 0;
        try {
            B = R.ccall("validate_model", "number", [
                "number",
                "number",
                "number"
            ], [
        ...
        const L = dn(R.HEAPU8.buffer, P);
        if (R._free(P), !B || L === 0) return B && R._free_buffer(B), {
            ok: !0,
            message: ""
        };
        const T = R.HEAPU8.slice(B, B + L);
        return R._free_buffer(B), {
            ok: !1,
    ...
    Ae.onmessage = async (M)=>{
        const P = M.data;
        try {
            if (await hi, !R) throw new Error("Module not initialized.");
            if (P.type === "validate") {
