(async ()=>{
    ...
    async function sn(I = {}) {
        ...
        var c = I, B = !!globalThis.window, L = !!globalThis.WorkerGlobalScope, T = globalThis.process?.versions?.node && globalThis.process?.type != "renderer", me = !B && !T && !L, y = L && self.name?.startsWith("em-pthread");
        if (y && (u(!globalThis.moduleLoaded, "module should only be loaded once on each pthread worker"), globalThis.moduleLoaded = !0), T) {
            ...
            var J = e(import.meta.url), We = J("worker_threads");
            global.Worker = We.Worker, L = !We.isMainThread, y = L && We.workerData == "em-pthread";
        }
        ...
        var Cr = console.log.bind(console), Mr = console.error.bind(console);
        if (T) {
            var un = J("util"), Ir = (e)=>typeof e == "object" ? un.inspect(e) : e;
            Cr = (...e)=>Ce.writeSync(1, e.map(Ir).join(" ") + `
`), Mr = (...e)=>Ce.writeSync(2, e.map(Ir).join(" ") + `
`);
        }
        var ne = Cr, b = Mr;
...
`);
        ...
        var U, H, le, De, R, h, Wr, Re, O, Lr, he = !1;
        function je() {
            var e = K.buffer;
            U = new Int8Array(e), le = new Int16Array(e), c.HEAPU8 = H = new Uint8Array(e), De = new Uint16Array(e), R = new Int32Array(e), h = new Uint32Array(e), Wr = new Float32Array(e), Re = new Float64Array(e), O = new BigInt64Array(e), Lr = new BigUint64Array(e);
        }
        function hn() {
            if (!y) {
        ...
        function Ur() {
            if (u(!he), he = !0, y) return xr();
            Ie(), !c.noFSInit && !o.initialized && o.init(), te.__wasm_call_ctors(), o.ignorePermissions = !1;
        }
        function gn() {
            if (Ie(), !y) {
        ...
        function En(e) {
            if (e == sr && Me) return new Uint8Array(Me);
            if (Pe) return Pe(e);
        ...
        }, ge = 0, ze = ()=>mr || ge > 0, Jr = ()=>Ar(), lr = (e)=>rn(e), dr = (e)=>tn(e), W = (e, r, t, ...n)=>{
        ...
        var kn = (e, r)=>{
            ...
            initMainThread () {
                for(var e = Math.max(1, Math.min(8, typeof navigator < "u" && navigator.hardwareConcurrency || 8)); e--;)w.allocateUnusedWorker();
                Kr(async ()=>{
            ...
            allocateUnusedWorker () {
                ...
                } else e = new Worker(new URL("/assets/cp_sat_runtime-DgT0JG6O.js", import.meta.url), {
                    type: "module",
                    workerData: "em-pthread",
                    name: "em-pthread-" + w.nextWorkerID
                });
        ...
        function ot(e, r, t, n) {
            return y ? W(2, 0, 1, e, r, t, n) : it(e, r, t, n);
        }
        var In = ()=>!!globalThis.SharedArrayBuffer, it = (e, r, t, n)=>{
            if (!In()) return nr("pthread_create: environment does not support SharedArrayBuffer, pthreads are not available"), 6;
            var i = [], a = 0;
...
`));
            ...
            try {
                var v = t;
                typeof t == "string" && (v = await Wn(t)), v = await $n(v, d), l?.(), a || Ln(e, r, v, n, i, s);
            } finally{
                Xr(m);
            }
            ...
            createLazyFile (e, r, t, n, i) {
                class a {
                    ...
                    cacheLength() {
                        ...
                        xe.setDataGetter((Y)=>{
                            var Fe = Y * j, $ = (Y + 1) * j - 1;
                            return $ = Math.min($, p - 1), typeof xe.chunks[Y] > "u" && (xe.chunks[Y] = z(Fe, $)), typeof xe.chunks[Y] > "u" && C("doXHR failed!"), xe.chunks[Y];
        ...
        function mt(e, r) {
            ...
            try {
                return M.writeStat(r, o.fstat(e));
            } catch (t) {
        ...
        function vt(e, r) {
            ...
            try {
                return e = M.getStr(e), M.writeStat(r, o.lstat(e));
            } catch (t) {
                if (typeof o > "u" || t.name !== "ErrnoError") throw t;
                return -t.errno;
            }
        ...
        function ht(e, r, t, n) {
            ...
            try {
                ...
                return n = n & -6401, u(!n, `unknown flags in __syscall_newfstatat: ${n}`), r = M.calculateAt(e, r, a), M.writeStat(t, i ? o.lstat(r) : o.stat(r));
            } catch (s) {
        ...
        function gt(e, r) {
            ...
            try {
                return e = M.getStr(e), M.writeStat(r, o.stat(e));
            } catch (t) {
                if (typeof o > "u" || t.name !== "ErrnoError") throw t;
                return -t.errno;
            }
        ...
        var Xn = {
            ...
            switch(r){
                case 4:
                    return function(t) {
                        return this.fromWireType((f(), Wr)[t >> 2]);
                    };
                case 8:
                    return function(t) {
...
${m}`, new Function(g, m);
        ...
        var uo = (e)=>{
            ...
            Ie(), e instanceof WebAssembly.RuntimeError && Ar() <= 0 && b("Stack overflow detected.  You can try increasing -sSTACK_SIZE (currently set to 65536)"), rr(1, e);
        }, Po = ()=>{
            if (!ze()) try {
                if (y) {
                    ke() && Fr(ve);
        ...
        function Ct(e, r, t, n, i, a, s) {
            ...
            try {
                u(!isNaN(i));
                var l = M.getStreamFromFD(n), d = o.mmap(l, e, i, r, t), m = d.ptr;
        ...
        function Mt(e, r, t, n, i, a) {
            ...
            a = Er(a);
            try {
                var s = M.getStreamFromFD(i);
                t & 2 && M.doMsync(e, s, r, n, a);
            } catch (l) {
                if (typeof o > "u" || l.name !== "ErrnoError") throw l;
                return -l.errno;
            }
        ...
        }, It = ()=>performance.timeOrigin + performance.now(), xo = ()=>Date.now(), Wo = (e)=>e >= 0 && e <= 3;
        function Lo(e, r, t) {
            if (!Wo(e)) return 28;
            var n;
            e === 0 ? n = xo() : n = It();
        ...
        }, xt = ()=>new Error().stack.toString(), Ko = ()=>{
            var e = xt().split(`
`);
            ...
            var n;
            fe.last_addr == e ? n = fe.last_stack : (n = xt().split(`
`), n[0] == "Error" && n.shift(), Ot(n));
        ...
        function $t(e, r, t, n) {
            ...
            try {
                var i = M.getStreamFromFD(e), a = Zo(i, r, t);
                return (f(), h)[n >> 2] = a, 0;
            } catch (s) {
                if (typeof o > "u" || s.name !== "ErrnoError") throw s;
                return s.errno;
        ...
        function jt(e, r, t, n) {
            ...
            try {
                var i = M.getStreamFromFD(e), a = Qo(i, r, t);
                return (f(), h)[n >> 2] = a, 0;
            } catch (s) {
                if (typeof o > "u" || s.name !== "ErrnoError") throw s;
                return s.errno;
        ...
        function fi() {
            Te = {
                ...
                _emscripten_receive_on_main_thread_js: Mo,
                _emscripten_thread_cleanup: Io,
        ...
        for (const e of Object.keys(c))e in I || Object.defineProperty(I, e, {
            configurable: !0,
            get () {
    ...
    const Ae = self;
    let D = null;
    const pi = hi().then((I)=>(D = I, Ae.postMessage({
            type: "ready"
        }), I)).catch((I)=>{
        throw console.error("[cpsat_worker] cpSatModule init failed:", I), Ae.postMessage({
            type: "error",
            id: 0,
            error: String(I)
        }), I;
    }), dn = (I, P)=>new DataView(I, P, 4).getUint32(0, !0), Pr = (I)=>{
        if (!D || !I?.length) return 0;
        const P = D._malloc(I.length);
        return D.HEAPU8.set(I, P), P;
    };
    async function gi(I, P) {
        if (!D) throw new Error("Module not initialized.");
        const c = D._malloc(4), B = Pr(I), L = Pr(P ?? null);
        let T = 0;
        try {
