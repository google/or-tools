(async ()=>{
    ...
    async function sn(M = {}) {
        ...
        var c = M, B = !!globalThis.window, L = !!globalThis.WorkerGlobalScope, T = globalThis.process?.versions?.node && globalThis.process?.type != "renderer", _e = !B && !T && !L, y = L && self.name?.startsWith("em-pthread");
...
`);
        ...
        var ne = Cr, b = Ir;
        u(B || L || T, "Pthreads do not work in this environment yet (need Web Workers, or an alternative to them)"), u(!_e, "shell environment detected but not enabled at build time.  Add `shell` to `-sENVIRONMENT` to enable.");
        var Ie;
        ...
        function Dr() {
            var e = Tr();
            u((e & 3) == 0), e == 0 && (e += 4), (f(), p)[e >> 2] = 34821223, (f(), p)[e + 4 >> 2] = 2310721022, (f(), p)[0] = 1668509029;
        }
        function Me() {
            if (!me) {
                var e = Tr();
                e == 0 && (e += 4);
                var r = (f(), p)[e >> 2], t = (f(), p)[e + 4 >> 2];
                (r != 34821223 || t != 2310721022) && C(`Stack overflow! Stack cookie has been overwritten at ${ce(e)}, expected hex dwords 0x89BACDFE and 0x2135467, but received ${ce(t)} ${ce(r)}`), (f(), p)[0] != 1668509029 && C("Runtime error: The application has corrupted its heap memory area (address zero)!");
            }
        }
        function nr(...e) {
            if (T) {
...
`);
        ...
        function Rr(e) {
            y || Object.getOwnPropertyDescriptor(c, e) || Object.defineProperty(c, e, {
                ...
                get () {
                    ...
                    _n(e) && (r += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), C(r);
                }
            });
        }
        function vn() {
            function e() {
                var t = 0;
                return pe && typeof ke < "u" && (t = ke()), `w:${Or},t:${ce(t)}:`;
            }
            var r = nr;
            nr = (...t)=>r(e(), ...t);
        }
        ...
        var U, H, le, De, R, p, xr, Re, O, Lr, pe = !1;
        function je() {
            var e = K.buffer;
            U = new Int8Array(e), le = new Int16Array(e), c.HEAPU8 = H = new Uint8Array(e), De = new Uint16Array(e), R = new Int32Array(e), p = new Uint32Array(e), xr = new Float32Array(e), Re = new Float64Array(e), O = new BigInt64Array(e), Lr = new BigUint64Array(e);
        }
        function pn() {
            if (!y) {
        ...
        function W(e, r) {
            return (...t)=>{
                u(pe, `native function \`${e}\` called before runtime initialization`);
                var n = te[e];
        ...
        }, Gr = [], Kr = (e)=>Gr.push(e), de = 0, Ne = null, he = {}, oe = null, Xr = (e)=>{
            if (de--, c.monitorRunDependencies?.(de), u(e, "removeRunDependency requires an ID"), u(he[e]), delete he[e], de == 0 && (oe !== null && (clearInterval(oe), oe = null), Ne)) {
                var r = Ne;
                Ne = null, r();
            }
        }, qr = (e)=>{
            de++, c.monitorRunDependencies?.(de), u(e, "addRunDependency requires an ID"), u(!he[e]), he[e] = 1, oe === null && globalThis.setInterval && (oe = setInterval(()=>{
                if (me) {
                    clearInterval(oe), oe = null;
                    return;
                }
                var r = !1;
                for(var t in he)r || (r = !0, b("still waiting on run dependencies:")), b(`dependency: ${t}`);
                r && b("(end of list)");
            }, 1e4), oe.unref?.());
        }, Yr = (e)=>{
        ...
        }, ge = 0, ze = ()=>_r || ge > 0, Jr = ()=>Ar(), lr = (e)=>rn(e), dr = (e)=>tn(e), x = (e, r, t, ...n)=>{
            for(var i = n.length * 2, a = Jr(), s = dr(i * 8), l = s >> 3, d = 0; d < n.length; d++){
                var _ = n[d];
                typeof _ == "bigint" ? ((f(), O)[l + 2 * d] = 1n, (f(), O)[l + 2 * d + 1] = _) : ((f(), O)[l + 2 * d] = 0n, (f(), Re)[l + 2 * d + 1] = _);
            }
            var v = Yt(e, r, i, s, t);
            return lr(a), v;
        };
        function cr(e) {
            ...
            ve = e, ze() || (w.terminateAllThreads(), c.onExit?.(e), me = !0), rr(e, new jr(e));
        }
        function Zr(e) {
        ...
        var kn = (e, r)=>{
            if (ve = e, mi(), y) throw u(!r), Zr(e), "unwind";
            if (ze() && !r) {
            ...
            initMainThread () {
                for(var e = 9; e--;)w.allocateUnusedWorker();
                Kr(async ()=>{
            ...
            allocateUnusedWorker () {
                ...
                } else e = new Worker(new URL("/assets/cp_sat_runtime-DB_GZAUZ.js", import.meta.url), {
                    type: "module",
                    workerData: "em-pthread",
                    name: "em-pthread-" + w.nextWorkerID
                });
        ...
        function Fn(e) {
            var r = (f(), p)[e + 52 >> 2], t = (f(), p)[e + 56 >> 2], n = r - t;
        ...
        rt.isAsync = !0;
        var _r = !0, An = (e)=>w.tlsInitFunctions.push(e), ie = (e)=>{
        ...
        class Cn {
            ...
            get_type() {
                return (f(), p)[this.ptr + 4 >> 2];
            }
            set_destructor(r) {
                (f(), p)[this.ptr + 8 >> 2] = r;
            }
            get_destructor() {
                return (f(), p)[this.ptr + 8 >> 2];
            }
            set_caught(r) {
...
`));
            ...
            var d = r ? we.resolve(F.join2(e, r)) : e, _ = Un(`cp ${d}`);
            qr(_);
            try {
                var v = t;
        ...
        }, Bn = (e, r, t, n, i, a, s, l, d, _)=>{
            ut(e, r, t, n, i, l, d, _).then(a).catch(s);
        }, o = {
            root: null,
            mounts: [],
            devices: {},
            ...
            rename (e, r) {
                ...
                var _ = o.lookupNode(l, i), v = we.relative(e, n);
                ...
                if (_ !== g) {
                    var m = o.isDir(_.mode), h = o.mayDelete(l, i, m);
                    if (h) throw new o.ErrnoError(h);
                    if (h = g ? o.mayDelete(d, a, m) : o.mayCreate(d, a), h) throw new o.ErrnoError(h);
                    if (!l.node_ops.rename) throw new o.ErrnoError(63);
                    if (o.isMountpoint(_) || g && o.isMountpoint(g)) throw new o.ErrnoError(10);
                    if (d !== l && (h = o.nodePermissions(l, "w"), h)) throw new o.ErrnoError(h);
                    o.hashRemoveNode(_);
                    try {
            ...
            writeFile (e, r, t = {}) {
                ...
                typeof r == "string" && (r = new Uint8Array(pr(r))), ArrayBuffer.isView(r) ? o.write(n, r, 0, r.byteLength, void 0, t.canOwn) : C("Unsupported data type"), o.close(n);
            },
            cwd: ()=>o.currentPath,
            chdir (e) {
                var r = o.lookupPath(e, {
            ...
            createDefaultDevices () {
                ...
                var e = new Uint8Array(1024), r = 0, t = ()=>(r === 0 && (mr(e), r = e.byteLength), e[--r]);
            ...
            createFile (e, r, t, n, i) {
                var a = F.join2(typeof e == "string" ? e : o.getPath(e), r), s = hr(n, i);
                return o.create(a, s);
            },
            createDataFile (e, r, t, n, i, a) {
                var s = r;
                e && (e = typeof e == "string" ? e : o.getPath(e), s = r ? F.join2(e, r) : e);
                var l = hr(n, i), d = o.create(s, l);
                if (t) {
                    if (typeof t == "string") {
            ...
            createDevice (e, r, t, n) {
                var i = F.join2(typeof e == "string" ? e : o.getPath(e), r), a = hr(!!t, !!n);
                ...
                return o.registerDevice(s, {
                    ...
                    read (l, d, _, v, g) {
                        for(var m = 0, h = 0; h < v; h++){
                            ...
                            if (k === void 0 && m === 0) throw new o.ErrnoError(6);
                            if (k == null) break;
                            m++, d[_ + h] = k;
                        }
            ...
            createLazyFile (e, r, t, n, i) {
                class a {
                    ...
                    get(m) {
                        if (!(m > this.length - 1 || m < 0)) {
                            var h = m % this.chunkSize, k = m / this.chunkSize | 0;
                            return this.getter(k)[h];
                        }
                    }
                    setDataGetter(m) {
                        this.getter = m;
                    ...
                    cacheLength() {
                        ...
                        var h = Number(m.getResponseHeader("Content-length")), k, S = (k = m.getResponseHeader("Accept-Ranges")) && k === "bytes", N = (k = m.getResponseHeader("Content-Encoding")) && k === "gzip", j = 1024 * 1024;
                        S || (j = h);
                        var z = (Y, Fe)=>{
                            Y > Fe && C("invalid range (" + Y + ", " + Fe + ") or no bytes requested!"), Fe > h - 1 && C("only " + h + " bytes available! programmer error!");
                            var $ = new XMLHttpRequest();
                            return $.open("GET", t, !1), h !== j && $.setRequestHeader("Range", "bytes=" + Y + "-" + Fe), $.responseType = "arraybuffer", $.overrideMimeType && $.overrideMimeType("text/plain; charset=x-user-defined"), $.send(null), $.status >= 200 && $.status < 300 || $.status === 304 || C("Couldn't load " + t + ". Status: " + $.status), $.response !== void 0 ? new Uint8Array($.response || []) : pr($.responseText || "");
                        }, We = this;
                        We.setDataGetter((Y)=>{
                            var Fe = Y * j, $ = (Y + 1) * j - 1;
                            return $ = Math.min($, h - 1), typeof We.chunks[Y] > "u" && (We.chunks[Y] = z(Fe, $)), typeof We.chunks[Y] > "u" && C("doXHR failed!"), We.chunks[Y];
                        }), (N || !h) && (j = h = 1, h = this.getter(0).length, j = h, ne("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = h, this._chunkSize = j, this.lengthKnown = !0;
                    }
                    get length() {
                ...
                var _ = {};
                for (const [g, m] of Object.entries(d.stream_ops))_[g] = (...h)=>(o.forceLoadFile(d), m(...h));
                function v(g, m, h, k, S) {
                    var N = g.node.contents;
                    if (S >= N.length) return 0;
                    var j = Math.min(N.length - S, k);
                    if (u(j >= 0), N.slice) for(var z = 0; z < j; z++)m[h + z] = N[S + z];
                    else for(var z = 0; z < j; z++)m[h + z] = N.get(S + z);
                    return j;
                }
                return _.read = (g, m, h, k, S)=>(o.forceLoadFile(d), v(g, m, h, k, S)), _.mmap = (g, m, h, k, S)=>{
                    o.forceLoadFile(d);
                    var N = lt(m);
                    if (!N) throw new o.ErrnoError(48);
                    return v(g, (f(), U), N, m, h), {
                        ptr: N,
                        allocated: !0
                    };
                }, d.stream_ops = _, d;
            ...
            writeStat (e, r) {
                (f(), p)[e >> 2] = r.dev, (f(), p)[e + 4 >> 2] = r.mode, (f(), p)[e + 8 >> 2] = r.nlink, (f(), p)[e + 12 >> 2] = r.uid, (f(), p)[e + 16 >> 2] = r.gid, (f(), p)[e + 20 >> 2] = r.rdev, (f(), O)[e + 24 >> 3] = BigInt(r.size), (f(), R)[e + 32 >> 2] = 4096, (f(), R)[e + 36 >> 2] = r.blocks;
                var t = r.atime.getTime(), n = r.mtime.getTime(), i = r.ctime.getTime();
                return (f(), O)[e + 40 >> 3] = BigInt(Math.floor(t / 1e3)), (f(), p)[e + 48 >> 2] = t % 1e3 * 1e3 * 1e3, (f(), O)[e + 56 >> 3] = BigInt(Math.floor(n / 1e3)), (f(), p)[e + 64 >> 2] = n % 1e3 * 1e3 * 1e3, (f(), O)[e + 72 >> 3] = BigInt(Math.floor(i / 1e3)), (f(), p)[e + 80 >> 2] = i % 1e3 * 1e3 * 1e3, (f(), O)[e + 88 >> 3] = BigInt(r.ino), 0;
            },
            writeStatFs (e, r) {
                (f(), p)[e + 4 >> 2] = r.bsize, (f(), p)[e + 60 >> 2] = r.bsize, (f(), O)[e + 8 >> 3] = BigInt(r.blocks), (f(), O)[e + 16 >> 3] = BigInt(r.bfree), (f(), O)[e + 24 >> 3] = BigInt(r.bavail), (f(), O)[e + 32 >> 3] = BigInt(r.files), (f(), O)[e + 40 >> 3] = BigInt(r.ffree), (f(), p)[e + 48 >> 2] = r.fsid, (f(), p)[e + 64 >> 2] = r.flags, (f(), p)[e + 56 >> 2] = r.namelen;
            },
            doMsync (e, r, t, n, i) {
                    ...
                    case 21508:
                        {
                            ...
                            if (n.tty.ops.ioctl_tcsets) {
                                for(var a = Ee(), l = (f(), R)[a >> 2], d = (f(), R)[a + 4 >> 2], _ = (f(), R)[a + 8 >> 2], v = (f(), R)[a + 12 >> 2], g = [], s = 0; s < 32; s++)g.push((f(), U)[a + s + 17]);
                    ...
                    case 21523:
                        {
                            ...
                            if (n.tty.ops.ioctl_tiocgwinsz) {
                                var m = n.tty.ops.ioctl_tiocgwinsz(n.tty), a = Ee();
                                (f(), le)[a >> 1] = m[0], (f(), le)[a + 2 >> 1] = m[1];
                            }
                            return 0;
                        }
                    case 21524:
        ...
        function gr(e) {
            return this.fromWireType((f(), p)[e >> 2]);
        }
        var Xn = {
            name: "emscripten::val",
            fromWireType: (e)=>{
...
return ret;
`), _ += `}
`, _ += "return " + (n ? "rv.then(onDone)" : `onDone(${h})`) + ";", _ += `}
...
${_}`, new Function(g, _);
        ...
        function to(e, r, t, n, i, a) {
            ...
            for(var l = r[1] !== null && t !== null, d = kt(r), _ = !r[0].isVoid, v = s - 2, g = ro(r), m = r[0], h = r[1], k = [
                e,
                G,
                n,
                i,
        ...
        var no = (e, r, t)=>{
            ...
            for(var t = [], n = 0; n < e; n++)t.push((f(), p)[r + n * 4 >> 2]);
            return t;
        ...
        var uo = (e)=>{
            ...
            function n(l) {
                ...
                for(var _ = 0; _ < e.length; ++_)X(e[_], d[_]);
            }
            ...
            var d = io(r, t);
            e = V(e), e = mo(e), i = lo(n, i, s), oo(e, function() {
            ...
            X(e, {
                ...
                fromWireType: s,
                toWireType: (d, _)=>{
                    if (typeof _ != "number" && typeof _ != "boolean") throw new TypeError(`Cannot convert "${Ge(_)}" to ${r}`);
                    return Et(r, _, n, i), _;
                },
            ...
            r = V(r), X(e, {
                ...
                toWireType (t, n) {
                    ...
                    return (f(), p)[s >> 2] = i, a ? ee(n, l, i + 1) : (f(), H).set(n, l), t !== null && t.push(re, s), s;
                },
                readValueFromPointer: gr,
            ...
            r === 2 ? (n = yo, i = Eo, a = wo) : (u(r === 4, "only 2-byte and 4-byte strings are currently supported"), n = bo, i = So, a = ko), X(e, {
                name: t,
                fromWireType: (s)=>{
                    var l = (f(), p)[s >> 2], d = n(s + 4, l * r, !0);
                    return re(s), d;
                },
                toWireType: (s, l)=>{
                    typeof l != "string" && G(`Cannot pass non-string to C++ string type ${t}`);
                    var d = a(l), _ = Ze(4 + d + r);
                    return (f(), p)[_ >> 2] = d / r, i(l, _ + 4, d + r), s !== null && s.push(re, _), _;
                },
                readValueFromPointer: gr,
        ...
        function Ct(e, r, t, n, i, a, s) {
            ...
            try {
                ...
                return (f(), R)[a >> 2] = d.allocated, (f(), p)[s >> 2] = _, 0;
            } catch (v) {
        ...
        var Oo = (e, r, t, n)=>{
            var i = (new Date()).getFullYear(), a = new Date(i, 0, 1), s = new Date(i, 6, 1), l = a.getTimezoneOffset(), d = s.getTimezoneOffset(), _ = Math.max(l, d);
            (f(), p)[e >> 2] = _ * 60, (f(), R)[r >> 2] = +(l != d);
            var v = (h)=>{
                var k = h >= 0 ? "-" : "+", S = Math.abs(h), N = String(Math.floor(S / 60)).padStart(2, "0"), j = String(S % 60).padStart(2, "0");
                return `UTC${k}${N}${j}`;
            }, g = v(l), m = v(d);
            u(g), u(m), u(ue(g) <= 16, `timezone name truncated to fit in TZNAME_MAX (${g})`), u(ue(m) <= 16, `timezone name truncated to fit in TZNAME_MAX (${m})`), d < l ? (ee(g, t, 17), ee(m, n, 17)) : (ee(g, n, 17), ee(m, t, 17));
        ...
        var qe = [], Uo = (e, r)=>{
            ...
            for(var t; t = (f(), H)[e++];){
                ...
                var a = t != 105;
                a &= t != 112, r += a && r % 8 ? 4 : 0, qe.push(t == 112 ? (f(), p)[r >> 2] : t == 106 ? (f(), O)[r >> 3] : t == 105 ? (f(), R)[r >> 2] : (f(), Re)[r >> 3]), r += a ? 8 : 4;
            }
            return qe;
        }, $o = (e, r, t)=>{
            var n = Uo(r, t);
...
`), n[0] == "Error" && n.shift(), Ot(n));
        ...
        function xt(e, r) {
            ...
            for (var i of Oe()){
                var a = r + t;
                (f(), p)[e + n >> 2] = a, t += ee(i, a, 1 / 0) + 1, n += 4;
            }
            return 0;
        }
        function Lt(e, r) {
        ...
        function ei(e, r) {
            try {
                return mr((f(), H).subarray(e, e + r)), 0;
            } catch (t) {
                if (typeof o > "u" || t.name !== "ErrnoError") throw t;
                return t.errno;
            }
        ...
        function fi() {
            Te = {
                ...
                __syscall_fstat64: _t,
                __syscall_ioctl: mt,
                __syscall_lstat64: vt,
                __syscall_newfstatat: pt,
                __syscall_openat: ht,
                __syscall_stat64: gt,
                _abort_js: jn,
                ...
                _embind_register_memory_view: ho,
        ...
        function Qe() {
            ...
            async function e() {
                u(!on), on = !0, c.calledRun = !0, !me && (Ur(), or?.(c), c.onRuntimeInitialized?.(), Be("onRuntimeInitialized"), u(!c._main, 'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]'), gn());
            }
        ...
        var te;
        y || (te = await Br(), Qe()), pe ? P = c : P = new Promise((e, r)=>{
            or = e, ir = r;
        });
    ...
    const Ae = self;
    let D = null;
    const hi = pi().then((M)=>(D = M, Ae.postMessage({
            type: "ready"
        }), M)).catch((M)=>{
    ...
    async function gi(M, P) {
        ...
        const _e = dn(D.HEAPU8.buffer, c);
        if (D._free(c), !T || _e === 0) return T && D._free_buffer(T), new Uint8Array();
        const y = D.HEAPU8.slice(T, T + _e);
    ...
    Ae.onmessage = async (M)=>{
        const P = M.data;
        try {
            if (await hi, !D) throw new Error("Module not initialized.");
            if (P.type === "validate") {
