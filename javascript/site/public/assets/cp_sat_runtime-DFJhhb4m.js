async function eo(ze = {}) {
    ...
    async function e(r) {
      try {
        ...
        if (n === "load") {
          ...
          B = t.wasmMemory, Re(), re = t.wasmModule, Ir(), Be();
        } else if (n === "run") {
  ...
  var N, L, te, be, C, h, Fr, Se, R, Ar, de = !1;
  function Re() {
    var e = B.buffer;
    N = new Int8Array(e), te = new Int16Array(e), f.HEAPU8 = L = new Uint8Array(e), be = new Uint16Array(e), C = new Int32Array(e), h = new Uint32Array(e), Fr = new Float32Array(e), Se = new Float64Array(e), R = new BigInt64Array(e), Ar = new BigUint64Array(e);
  }
  function rn() {
    if (!y) {
      if (f.wasmMemory)
  ...
  }, ue = 0, Me = () => nr || ue > 0, $r = () => pr(), Ze = (e) => Vt(e), Qe = (e) => Gt(e), D = (e, r, t, ...n) => {
    for (var o = n.length * 2, a = $r(), s = Qe(o * 8), l = s >> 3, d = 0; d < n.length; d++) {
      var _ = n[d];
      typeof _ == "bigint" ? ((u(), R)[l + 2 * d] = 1n, (u(), R)[l + 2 * d + 1] = _) : ((u(), R)[l + 2 * d] = 0n, (u(), Se)[l + 2 * d + 1] = _);
    }
    var v = $t(e, r, o, s, t);
    return Ze(a), v;
  };
  function er(e) {
    ...
    le = e, Me() || (S.terminateAllThreads(), f.onExit?.(e), se = !0), Er(e, new Rr(e));
  }
  function Br(e) {
  ...
  var cn = (e, r) => {
    ...
    e.onmessage = (a) => {
      ...
      l === "checkMailbox" ? We() : l === "spawnThread" ? Ur(s) : l === "cleanupThread" ? pt(() => Dr(s.thread)) : l === "loaded" ? (e.loaded = !0, r(e)) : s.target === "setimmediate" ? e.postMessage(s) : l === "callHandler" ? f[s.handler](...s.args) : l && w(`worker sent an unknown command ${l}`);
    }, e.onerror = (a) => {
  ...
  }, _e = De, T = { isAbs: (e) => e.charAt(0) === "/", splitPath: (e) => {
    var r = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/;
...
`)), !e)
    ...
    (u(), h)[e >> 2] = r.dev, (u(), h)[e + 4 >> 2] = r.mode, (u(), h)[e + 8 >> 2] = r.nlink, (u(), h)[e + 12 >> 2] = r.uid, (u(), h)[e + 16 >> 2] = r.gid, (u(), h)[e + 20 >> 2] = r.rdev, (u(), R)[e + 24 >> 3] = BigInt(r.size), (u(), C)[e + 32 >> 2] = 4096, (u(), C)[e + 36 >> 2] = r.blocks;
    var t = r.atime.getTime(), n = r.mtime.getTime(), o = r.ctime.getTime();
    return (u(), R)[e + 40 >> 3] = BigInt(Math.floor(t / 1e3)), (u(), h)[e + 48 >> 2] = t % 1e3 * 1e3 * 1e3, (u(), R)[e + 56 >> 3] = BigInt(Math.floor(n / 1e3)), (u(), h)[e + 64 >> 2] = n % 1e3 * 1e3 * 1e3, (u(), R)[e + 72 >> 3] = BigInt(Math.floor(o / 1e3)), (u(), h)[e + 80 >> 2] = o % 1e3 * 1e3 * 1e3, (u(), R)[e + 88 >> 3] = BigInt(r.ino), 0;
  }, writeStatFs(e, r) {
    (u(), h)[e + 4 >> 2] = r.bsize, (u(), h)[e + 60 >> 2] = r.bsize, (u(), R)[e + 8 >> 3] = BigInt(r.blocks), (u(), R)[e + 16 >> 3] = BigInt(r.bfree), (u(), R)[e + 24 >> 3] = BigInt(r.bavail), (u(), R)[e + 32 >> 3] = BigInt(r.files), (u(), R)[e + 40 >> 3] = BigInt(r.ffree), (u(), h)[e + 48 >> 2] = r.fsid, (u(), h)[e + 64 >> 2] = r.flags, (u(), h)[e + 56 >> 2] = r.namelen;
  }, doMsync(e, r, t, n, o) {
  ...
  }, ct = [], q = [0, 1, , 1, null, 1, !0, 1, !1, 1], Dn = (e) => {
...
${_}`, new Function(g, _);
  ...
  var Yn = (e) => {
    ...
    for (var a = o >> 3, s = 0; s < n; s++)
      (u(), R)[a + 2 * s] ? xe[s] = (u(), R)[a + 2 * s + 1] : xe[s] = (u(), Se)[a + 2 * s + 1];
    var l = r ? fr[r] : Ki[e];
  ...
  var Le = [], ki = (e, r) => {
    ...
    for (var t; t = (u(), L)[e++]; ) {
      ...
      var a = t != 105;
      a &= t != 112, r += a && r % 8 ? 4 : 0, Le.push(t == 112 ? (u(), h)[r >> 2] : t == 106 ? (u(), R)[r >> 3] : t == 105 ? (u(), C)[r >> 2] : (u(), Se)[r >> 3]), r += a ? 8 : 4;
    }
    return Le;
  }, Ti = (e, r, t) => {
    var n = ki(r, t);
    ...
    throw wt(), "unwind";
  }, bt = () => 2147483648, Ii = () => bt(), Ri = () => navigator.hardwareConcurrency, ae = {}, St = (e) => {
    var r = Q(e) + 1, t = Fe(r);
    return t && j(e, t, r), t;
  }, Ue = (e) => {
    var r;
...
`);
    ...
    for (var n = 1; n <= 4; n *= 2) {
      ...
      var a = Math.min(t, Yr(Math.max(e, o), 65536)), s = Di(a);
      if (s)
        return !0;
    }
...
`), n[0] == "Error" && n.shift(), kt(n));
  ...
  function It(e, r, t, n) {
    ...
    try {
      ...
      var o = P.getStreamFromFD(e);
      return i.llseek(o, r, t), (u(), R)[n >> 3] = BigInt(o.position), o.getdents && r === 0 && t === 0 && (o.getdents = null), 0;
    } catch (a) {
      if (typeof i > "u" || a.name !== "ErrnoError") throw a;
      return a.errno;
    }
  ...
  qi.forEach(Sr);
  var Ki = [er, Br, qr, rt, tt, nt, it, ot, at, st, gt, yt, Ft, At, Pt, Ct, It, Rt];
  function Xi() {
    Jt("fetchSettings");
  }
  ...
  var ge;
  function Ji() {
    ge = { GetHostCString: Dt, HaveOffsetConverter: Nt, __assert_fail: mn, __cxa_throw: hn, __pthread_create_js: Kr, __syscall_fcntl64: rt, __syscall_fstat64: tt, __syscall_ioctl: nt, __syscall_lstat64: it, __syscall_newfstatat: ot, __syscall_openat: at, __syscall_stat64: st, _abort_js: Pn, _embind_register_bigint: Rn, _embind_register_bool: Mn, _embind_register_emval: On, _embind_register_float: xn, _embind_register_function: ei, _embind_register_integer: ri, _embind_register_memory_view: ti, _embind_register_std_string: ni, _embind_register_std_wstring: ci, _embind_register_void: ui, _emscripten_init_main_thread_js: fi, _emscripten_notify_mailbox_postmessage: mi, _emscripten_receive_on_main_thread_js: vi, _emscripten_thread_cleanup: hi, _emscripten_thread_mailbox_await: dr, _emscripten_thread_set_strongref: pi, _mmap_js: gt, _munmap_js: yt, _tzset_js: Ei, clock_time_get: Si, emscripten_asm_const_int: Fi, emscripten_check_blocking_allowed: Ai, emscripten_errn: Pi, emscripten_exit_with_live_runtime: Ci, emscripten_get_heap_max: Ii, emscripten_get_now: Et, emscripten_num_logical_cores: Ri, emscripten_pc_get_function: $e, emscripten_resize_heap: Ni, emscripten_stack_snapshot: Mi, emscripten_stack_unwind_buffer: Oi, environ_get: Ft, environ_sizes_get: At, exit: rr, fd_close: Pt, fd_read: Ct, fd_seek: It, fd_write: Rt, memory: B, proc_exit: er, random_get: Ui };
  }
  var Kt;
  function Zi() {
    c(!y), jt(), br();
...
//# sourceMappingURL=cp_sat_runtime-DFJhhb4m.js.map
