async function sa(He = {}) {
  ...
  function be() {
    if (!K) {
      ...
      (r != 34821223 || t != 2310721022) && P(`Stack overflow! Stack cookie has been overwritten at ${se(e)}, expected hex dwords 0x89BACDFE and 0x2135467, but received ${se(t)} ${se(r)}`), (u(), y)[0] != 1668509029 && P("Runtime error: The application has corrupted its heap memory area (address zero)!");
    }
  }
  function Ye(...e) {
    console.warn(...e);
  ...
  function nn() {
    function e() {
      var t = 0;
      return ce && typeof ge < "u" && (t = ge()), `w:${Cr},t:${se(t)}:`;
    }
    var r = Ye;
    Ye = (...t) => r(e(), ...t);
  }
    ...
    let e = function(r) {
      try {
        ...
        if (n === "load") {
          ...
          z = t.wasmMemory, Re(), ne = t.wasmModule, Mr(), ze();
        } else if (n === "run") {
        ...
        } else t.target === "setimmediate" || (n === "checkMailbox" ? Ze && je() : n && (k(`worker: received unknown command ${n}`), k(t)));
      } catch (a) {
        throw k(`worker: onmessage() captured an uncaught exception: ${a}`), a?.stack && k(a.stack), jt(), a;
      }
    };
    var Ze = !1;
  ...
  var L, U, ie, ke, M, y, Pr, Te, O, Ir, ce = !1;
  function Re() {
    var e = z.buffer;
    L = new Int8Array(e), ie = new Int16Array(e), f.HEAPU8 = U = new Uint8Array(e), ke = new Uint16Array(e), M = new Int32Array(e), y = new Uint32Array(e), Pr = new Float32Array(e), Te = new Float64Array(e), O = new BigInt64Array(e), Ir = new BigUint64Array(e);
  }
  function an() {
    if (!S) {
      if (f.wasmMemory)
  ...
  function Dr() {
    ...
    be(), !f.noFSInit && !i.initialized && i.init(), J.__wasm_call_ctors(), i.ignorePermissions = !1;
  }
  function sn() {
    if (be(), !S) {
      if (f.postRun)
  ...
  function P(e) {
    f.onAbort?.(e), e = "Aborted(" + e + ")", k(e), K = !0, e.indexOf("RuntimeError: unreachable") >= 0 && (e += '. "unreachable" may be due to ASYNCIFY_STACK_SIZE not being large enough (try increasing it)');
  ...
  var Qe;
  function ln() {
    return f.locateFile ? Qt("cp_sat_runtime_asyncify.wasm") : new URL("/assets/cp_sat_runtime_asyncify-Dh0Wekt1.wasm", import.meta.url).href;
  }
  function dn(e) {
    if (e == Qe && Se)
  ...
  function Rr() {
    ia(), we.__instrumented || (we.__instrumented = !0, m.instrumentWasmImports(we));
    var e = { env: we, wasi_snapshot_preview1: we };
    return e;
  }
  async function Mr() {
    function e(l, c) {
      return J = l.exports, J = m.instrumentWasmExports(J), yn(J._emscripten_tls_init), na(J), ne = c, J;
    }
    var r = f;
    function t(l) {
    ...
    if (S) {
      d(ne, "wasmModule should have been received via postMessage");
      var a = new WebAssembly.Instance(ne, Rr());
      return e(a, ne);
    }
    Qe ??= ln();
    var o = await fn(Se, Qe, n), s = t(o);
    return s;
  }
  class Nr {
    name = "ExitStatus";
  ...
  var Or = (e) => {
    ...
    for (; e.length > 0; )
      e.shift()(f);
  }, jr = [], xr = (e) => jr.push(e), ae = 0, Fe = null, ue = {}, oe = null, Ur = (e) => {
    if (ae--, f.monitorRunDependencies?.(ae), d(e, "removeRunDependency requires an ID"), d(ue[e]), delete ue[e], ae == 0 && (oe !== null && (clearInterval(oe), oe = null), Fe)) {
      var r = Fe;
      Fe = null, r();
    }
  }, $r = (e) => {
    ae++, f.monitorRunDependencies?.(ae), d(e, "addRunDependency requires an ID"), d(!ue[e]), ue[e] = 1, oe === null && globalThis.setInterval && (oe = setInterval(() => {
      if (K) {
    ...
    for (var a = n.length * 2, o = zr(), s = rr(a * 8), l = s >> 3, c = 0; c < n.length; c++) {
      var _ = n[c];
      typeof _ == "bigint" ? ((u(), O)[l + 2 * c] = 1n, (u(), O)[l + 2 * c + 1] = _) : ((u(), O)[l + 2 * c] = 0n, (u(), Te)[l + 2 * c + 1] = _);
    }
    var h = xt(e, r, a, s, t);
    return er(o), h;
  };
  function tr(e) {
    ...
    de = e, Me() || (T.terminateAllThreads(), f.onExit?.(e), K = !0), br(e, new Nr(e));
  }
  function Hr(e) {
  ...
  var _n = (e, r) => {
    ...
    tr(e);
  }, nr = _n, se = (e) => (d(typeof e == "number", `ptrToString expects a number, got ${typeof e}`), e >>>= 0, "0x" + e.toString(16).padStart(8, "0")), T = { unusedWorkers: [], runningWorkers: [], tlsInitFunctions: [], pthreads: {}, nextWorkerID: 1, init() {
    S || T.initMainThread();
  }, initMainThread() {
    ...
    e.onmessage = (o) => {
      ...
      if (s.targetThread && s.targetThread != ge()) {
      ...
      l === "checkMailbox" ? je() : l === "spawnThread" ? Br(s) : l === "cleanupThread" ? cr(() => Wr(s.thread)) : l === "loaded" ? (e.loaded = !0, r(e)) : s.target === "setimmediate" ? e.postMessage(s) : l === "callHandler" ? f[s.handler](...s.args) : l && k(`worker sent an unknown command ${l}`);
    }, e.onerror = (o) => {
      var s = "worker sent an error!";
      throw e.pthread_ptr && (s = `Pthread ${se(e.pthread_ptr)} sent an error!`), k(`${s} ${o.filename}:${o.lineno}: ${o.message}`), o;
    }, d(z instanceof WebAssembly.Memory, "WebAssembly memory should have been loaded by now!"), d(ne instanceof WebAssembly.Module, "WebAssembly Module should have been loaded by now!");
    var t = [], n = ["onExit", "onAbort", "print", "printErr"];
    for (var a of n)
      f.propertyIsEnumerable(a) && t.push(a);
    e.postMessage({ cmd: "load", handlers: t, wasmMemory: z, wasmModule: ne, workerID: e.workerID });
    ...
    if (f.mainScriptUrlOrBlob) {
      ...
      /* @vite-ignore */
      "/assets/cp_sat_runtime_asyncify-DjREK6CK.js",
      import.meta.url
    ), { type: "module", name: "em-pthread-" + T.nextWorkerID });
  ...
  var ir = !0, yn = (e) => T.tlsInitFunctions.push(e), ee = (e) => {
    ...
    for (var o = ""; r < a; ) {
      ...
      var c = e[r++] & 63;
      if ((s & 240) == 224 ? s = (s & 15) << 12 | l << 6 | c : ((s & 248) != 240 && ee("Invalid UTF-8 leading byte " + se(s) + " encountered when deserializing a UTF-8 string in wasm memory to a JS string!"), s = (s & 7) << 18 | l << 12 | c << 6 | e[r++] & 63), s < 65536)
        o += String.fromCharCode(s);
      else {
        var _ = s - 65536;
    ...
    return o;
  }, Y = (e, r, t) => (d(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? _e((u(), U), e, r, t) : ""), gn = (e, r, t, n) => P(`Assertion failed: ${Y(e)}, at: ` + [r ? Y(r) : "unknown filename", t, n ? Y(n) : "unknown function"]);
  class wn {
    constructor(r) {
  ...
  function Yr(e, r, t, n) {
    return S ? W(2, 0, 1, e, r, t, n) : Xr(e, r, t, n);
  }
  var Sn = () => !!globalThis.SharedArrayBuffer, Xr = (e, r, t, n) => {
    if (!Sn())
    ...
    for (var a = t, o = t + n - 1, s = 0; s < e.length; ++s) {
      ...
      if (l <= 127) {
        ...
        if (t + 3 >= o) break;
        l > 1114111 && ee("Invalid Unicode code point " + se(l) + " encountered when serializing a JS string to a UTF-8 string in wasm memory! (Valid unicode code points should be in range 0-0x10FFFF)."), r[t++] = 240 | l >> 18, r[t++] = 128 | l >> 12 & 63, r[t++] = 128 | l >> 6 & 63, r[t++] = 128 | l & 63, s++;
      }
    }
    return r[t] = 0, t - a;
  }, sr = (e, r, t) => {
    var n = re(e) + 1, a = new Array(n), o = Jr(e, a, 0, a.length);
    return a.length = o, a;
  }, kn = () => {
    if (!or.length) {
      var e = null;
...
`)), !e)
    ...
    te.ttys[e] = { input: [], output: [], ops: r }, i.registerDevice(e, te.stream_ops);
  }, stream_ops: { open(e) {
    ...
    i.mkdir("/dev"), i.registerDevice(i.makedev(1, 3), { read: () => 0, write: (n, a, o, s, l) => s, llseek: () => 0 }), i.mkdev("/dev/null", i.makedev(1, 3)), te.register(i.makedev(5, 0), te.default_tty_ops), te.register(i.makedev(6, 0), te.default_tty1_ops), i.mkdev("/dev/tty", i.makedev(5, 0)), i.mkdev("/dev/tty1", i.makedev(6, 0));
    ...
    class o {
      ...
      cacheLength() {
        ...
        R || (N = g);
        var x = (q, Ee) => {
          q > Ee && P("invalid range (" + q + ", " + Ee + ") or no bytes requested!"), Ee > g - 1 && P("only " + g + " bytes available! programmer error!");
          var j = new XMLHttpRequest();
          return j.open("GET", t, !1), g !== N && j.setRequestHeader("Range", "bytes=" + q + "-" + Ee), j.responseType = "arraybuffer", j.overrideMimeType && j.overrideMimeType("text/plain; charset=x-user-defined"), j.send(null), j.status >= 200 && j.status < 300 || j.status === 304 || P("Couldn't load " + t + ". Status: " + j.status), j.response !== void 0 ? new Uint8Array(j.response || []) : sr(j.responseText || "");
        }, Ae = this;
        Ae.setDataGetter((q) => {
          var Ee = q * N, j = (q + 1) * N - 1;
          return j = Math.min(j, g - 1), typeof Ae.chunks[q] > "u" && (Ae.chunks[q] = x(Ee, j)), typeof Ae.chunks[q] > "u" && P("doXHR failed!"), Ae.chunks[q];
  ...
  var ct = (e, r, t) => {
    switch (r) {
      ...
      case 2:
        return t ? (n) => (u(), ie)[n >> 1] : (n) => (u(), ke)[n >> 1];
      case 4:
  ...
  }, ft = [], X = [0, 1, , 1, null, 1, !0, 1, !1, 1], jn = (e) => {
  ...
  var xn = { name: "emscripten::val", fromWireType: (e) => {
    var r = _t.toValue(e);
    return jn(e), r;
  }, toWireType: (e, r) => _t.toHandle(r), readValueFromPointer: dr, destructorFunction: null }, Un = (e) => H(e, xn), $n = (e, r) => {
    switch (r) {
      case 4:
        return function(t) {
      ...
      case 8:
        return function(t) {
          return this.fromWireType((u(), Te)[t >> 3]);
        };
      default:
...
${_}`, new Function(w, _);
  ...
  var Le = (e) => {
    ...
    if (e instanceof Nr || e == "unwind")
      return de;
    be(), e instanceof WebAssembly.RuntimeError && wr() <= 0 && k("Stack overflow detected.  You can try increasing -sSTACK_SIZE (currently set to 65536)"), br(1, e);
  }, Gn = () => {
    if (!Me())
      try {
        if (S) {
    ...
    if (d(m.state !== m.State.Disabled, "Asyncify cannot be done during or after the runtime exits"), !K) {
      if (m.state === m.State.Normal) {
        var r = !1, t = !1;
        e((n = 0) => {
          if (d(!n || typeof n == "number" || typeof n == "boolean"), !K && (m.handleSleepReturnValue = n, r = !0, !!t)) {
            d(!m.exportCallStack.length, "Waking up (starting to rewind) must be done from JS, without compiled code on the stack."), m.state = m.State.Rewinding, Le(() => Yt(m.currData)), typeof MainLoop < "u" && MainLoop.func && MainLoop.resume();
            var a, o = !1;
            try {
      ...
      } else m.state === m.State.Rewinding ? (m.state = m.State.Normal, Le(Xt), G(m.currData), m.currData = null, m.sleepCallbacks.forEach(cr)) : P(`invalid state: ${m.state}`);
  ...
  var Yn = (e, r, t) => {
    ...
    f.hasOwnProperty(e) ? ((t === void 0 || f[e].overloadTable !== void 0 && f[e].overloadTable[t] !== void 0) && B(`Cannot register public name '${e}' twice`), Yn(f, e, e), f[e].overloadTable.hasOwnProperty(t) && B(`Cannot register multiple overloads of a function with the same number of arguments (${t})!`), f[e].overloadTable[t] = r) : (f[e] = r, f[e].argCount = t);
  }, Jn = (e, r) => {
    for (var t = [], n = 0; n < e; n++)
      t.push((u(), y)[r + n * 4 >> 2]);
    return t;
  ...
  var ni = (e) => {
    ...
    var c = Jn(r, t);
    e = $(e), e = oi(e), a = ri(n, a, s), Xn(e, function() {
  ...
  }, V = (e, r, t) => (d(typeof t == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), Jr(e, (u(), U), r, t)), ci = (e, r) => {
    r = $(r), H(e, { name: r, fromWireType(t) {
      var n = (u(), y)[t >> 2], a = t + 4, o;
      return o = Y(a, n, !0), G(t), o;
    }, toWireType(t, n) {
      n instanceof ArrayBuffer && (n = new Uint8Array(n));
      var a, o = typeof n == "string";
      o || ArrayBuffer.isView(n) && n.BYTES_PER_ELEMENT == 1 || B("Cannot pass non-string to std::string"), o ? a = re(n) : a = n.length;
      var s = ye(4 + a + 1), l = s + 4;
      return (u(), y)[s >> 2] = a, o ? V(n, l, a + 1) : (u(), U).set(n, l), t !== null && t.push(G, s), s;
    ...
    var n = e >> 1, a = Kr((u(), ke), n, r / 2, t);
    if (a - n > 16 && gt) return gt.decode((u(), ke).slice(n, a));
    for (var o = "", s = n; s < a; ++s) {
      var l = (u(), ke)[s];
    ...
    r === 2 ? (n = ui, a = fi, o = _i) : (d(r === 4, "only 2-byte and 4-byte strings are currently supported"), n = mi, a = vi, o = pi), H(e, { name: t, fromWireType: (s) => {
      ...
      var c = o(l), _ = ye(4 + c + r);
      return (u(), y)[_ >> 2] = c / r, a(l, _ + 4, c + r), s !== null && s.push(G, _), _;
    ...
    for (var o = a >> 3, s = 0; s < n; s++)
      (u(), O)[o + 2 * s] ? xe[s] = (u(), O)[o + 2 * s + 1] : xe[s] = (u(), Te)[o + 2 * s + 1];
    var l = r ? vr[r] : Qi[e];
  ...
  var Fi = (e, r, t, n) => {
    ...
    d(w), d(p), d(re(w) <= 16, `timezone name truncated to fit in TZNAME_MAX (${w})`), d(re(p) <= 16, `timezone name truncated to fit in TZNAME_MAX (${p})`), c < l ? (V(w, t, 17), V(p, n, 17)) : (V(w, n, 17), V(p, t, 17));
  ...
  var Ue = [], Ii = (e, r) => {
    ...
    for (var t; t = (u(), U)[e++]; ) {
      ...
      var o = t != 105;
      o &= t != 112, r += o && r % 8 ? 4 : 0, Ue.push(t == 112 ? (u(), y)[r >> 2] : t == 106 ? (u(), O)[r >> 3] : t == 105 ? (u(), M)[r >> 2] : (u(), Te)[r >> 3]), r += o ? 8 : 4;
    }
    return Ue;
  }, Di = (e, r, t) => {
    var n = Ii(r, t);
  ...
  }, Ft = () => new Error().stack.toString(), ji = () => {
    var e = Ft().split(`
`);
    ...
    if (n = /^\s+at .*\.wasm\.(.*) \(.*\)$/.exec(r))
      ...
      return 0;
    return G(Be.ret ?? 0), Be.ret = kt(t), Be.ret;
  }, xi = (e) => {
    ...
    for (var n = 1; n <= 4; n *= 2) {
      ...
      var o = Math.min(t, Zr(Math.max(e, a), 65536)), s = xi(o);
      if (s)
        return !0;
    }
...
`), n[0] == "Error" && n.shift(), Tt(n));
  ...
  var Gi = (e) => {
    ...
    function s(A) {
      return r === "string" ? Y(A) : r === "boolean" ? !!A : A;
    }
    var l = Gi(e), c = [], _ = 0;
  ...
  Zi.forEach(Fr);
  var Qi = [tr, Hr, Yr, nt, it, at, ot, st, lt, dt, wt, Et, Ct, At, Pt, It, Dt, Rt];
  function ea() {
    en("fetchSettings");
  }
  ...
  function ze() {
    ...
    function e() {
      d(!Jt), Jt = !0, f.calledRun = !0, !K && (Dr(), Xe?.(f), f.onRuntimeInitialized?.(), De("onRuntimeInitialized"), d(!f._main, 'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]'), sn());
    }
  ...
  function oa() {
    ...
    try {
      ...
      for (var n of ["stdout", "stderr"]) {
        ...
        if (!a) return;
        var o = a.object, s = o.rdev, l = te.ttys[s];
        l?.output?.length && (t = !0);
      }
    } catch {
    }
...
var la = globalThis.self?.name?.startsWith("em-pthread");
la && sa();
export {
  sa as default
};
//# sourceMappingURL=cp_sat_runtime_asyncify-CH08lFVU.js.map
