async function Zt(M = {}) {
  ...
  var c = M, U = !!globalThis.window, $ = !!globalThis.WorkerGlobalScope, z = globalThis.process?.versions?.node && globalThis.process?.type != "renderer", fe = !U && !z && !$, y = $ && self.name?.startsWith("em-pthread");
  ...
  var te = console.log.bind(console), w = console.error.bind(console);
  ...
  function Fr(e) {
    y || Object.getOwnPropertyDescriptor(c, e) || Object.defineProperty(c, e, { configurable: !0, get() {
      ...
      nn(e) && (r += ". Alternatively, forcing filesystem support (-sFORCE_FILESYSTEM) can export this for you"), C(r);
    } });
  }
  function an() {
    function e() {
      var t = 0;
      return ve && typeof Se < "u" && (t = Se()), `w:${Ar},t:${ce(t)}:`;
    }
    var r = Ye;
    Ye = (...t) => r(e(), ...t);
  }
      ...
      try {
        ...
        if (n === "load") {
          ...
          for (const a of t.handlers)
            ...
            }, a == "print" && (te = c[a]), a == "printErr" && (w = c[a]));
          q = t.wasmMemory, We(), ae = t.wasmModule, Dr(), qe();
        } else if (n === "run") {
          u(t.pthread_ptr), pn(t.pthread_ptr), pr(t.pthread_ptr, 0, 0, 1, 0, 0), S.threadInitTLS(), fr(t.pthread_ptr), Qe || (Ut(), Qe = !0);
          try {
        ...
        } else t.target === "setimmediate" || (n === "checkMailbox" ? Qe && ze() : n && (w(`worker: received unknown command ${n}`), w(t)));
      } catch (i) {
        throw w(`worker: onmessage() captured an uncaught exception: ${i}`), i?.stack && w(i.stack), zt(), i;
      }
    }
    self.onmessage = e;
  }
  var W, j, se, Ce, R, h, Cr, Ie, N, Ir, ve = !1;
  function We() {
    var e = q.buffer;
    W = new Int8Array(e), se = new Int16Array(e), c.HEAPU8 = j = new Uint8Array(e), Ce = new Uint16Array(e), R = new Int32Array(e), h = new Uint32Array(e), Cr = new Float32Array(e), Ie = new Float64Array(e), N = new BigInt64Array(e), Ir = new BigUint64Array(e);
  }
  function sn() {
    if (!y) {
      if (c.wasmMemory)
  ...
  function C(e) {
    c.onAbort?.(e), e = "Aborted(" + e + ")", w(e), _e = !0;
  ...
  async function _n(e, r) {
    try {
      ...
      w(`failed to asynchronously prepare wasm: ${i}`), kr(e) && w(`warning: Loading from a file URI (${e}) is not supported in most browsers. See https://emscripten.org/docs/getting_started/FAQ.html#how-do-i-run-a-local-webserver-for-testing-why-does-my-program-stall-in-downloading-or-preparing`), C(i);
    }
  }
  ...
  function Rr() {
    ni(), ke.__instrumented || (ke.__instrumented = !0, Y.instrumentWasmImports(ke));
    var e = { env: ke, wasi_snapshot_preview1: ke };
    return e;
  }
  async function Dr() {
    function e(l, d) {
      return re = l.exports, re = Y.instrumentWasmExports(re), gn(re._emscripten_tls_init), ti(re), ae = d, re;
    }
    var r = c;
    function t(l) {
    ...
    if (c.instantiateWasm)
      return new Promise((l, d) => {
        try {
          ...
          w(`Module.instantiateWasm callback failed with error: ${_}`), d(_);
        }
      });
    if (y) {
      u(ae, "wasmModule should have been received via postMessage");
      var i = new WebAssembly.Instance(ae, Rr());
      return e(i, ae);
    }
    er ??= cn();
    var a = await mn(Ae, er, n), s = t(a);
    return s;
  }
  class Nr {
    name = "ExitStatus";
  ...
  var Or = (e) => {
    ...
    var r = S.pthreads[e];
    u(r), S.returnWorkerToPool(r);
  }, Wr = (e) => {
    for (; e.length > 0; )
      e.shift()(c);
  }, xr = [], Ur = (e) => xr.push(e), le = 0, Me = null, he = {}, de = null, $r = (e) => {
    if (le--, c.monitorRunDependencies?.(le), u(e, "removeRunDependency requires an ID"), u(he[e]), delete he[e], le == 0 && (de !== null && (clearInterval(de), de = null), Me)) {
      var r = Me;
      Me = null, r();
    }
  }, Br = (e) => {
    le++, c.monitorRunDependencies?.(le), u(e, "addRunDependency requires an ID"), u(!he[e]), he[e] = 1, de === null && globalThis.setInterval && (de = setInterval(() => {
      if (_e) {
    ...
    if (!r)
      return 6;
    u(!r.pthread_ptr, "Internal error!"), S.runningWorkers.push(r), S.pthreads[e.pthread_ptr] = r, r.pthread_ptr = e.pthread_ptr;
    var t = { cmd: "run", start_routine: e.startRoutine, arg: e.arg, pthread_ptr: e.pthread_ptr };
    return r.postMessage(t, e.transferList), 0;
  }, pe = 0, xe = () => ar || pe > 0, Hr = () => Er(), rr = (e) => Kt(e), tr = (e) => Xt(e), L = (e, r, t, ...n) => {
  ...
  function nr(e) {
    ...
    me = e, xe() || (S.terminateAllThreads(), c.onExit?.(e), _e = !0), Sr(e, new Nr(e));
  }
  function jr(e) {
  ...
  var vn = (e, r) => {
    ...
    nr(e);
  }, or = vn, ce = (e) => (u(typeof e == "number", `ptrToString expects a number, got ${typeof e}`), e >>>= 0, "0x" + e.toString(16).padStart(8, "0")), S = { unusedWorkers: [], runningWorkers: [], tlsInitFunctions: [], pthreads: {}, nextWorkerID: 1, init() {
    y || S.initMainThread();
  }, initMainThread() {
    for (var e = navigator.hardwareConcurrency; e--; )
      S.allocateUnusedWorker();
    Ur(async () => {
      var r = S.loadWasmModuleToAllWorkers();
    ...
    for (var e of S.runningWorkers)
      Or(e);
    for (var e of S.unusedWorkers)
      Or(e);
    S.unusedWorkers = [], S.runningWorkers = [], S.pthreads = {};
  }, returnWorkerToPool: (e) => {
    var r = e.pthread_ptr;
    delete S.pthreads[r], S.unusedWorkers.push(e), S.runningWorkers.splice(S.runningWorkers.indexOf(e), 1), e.pthread_ptr = 0, jt(r);
  }, threadInitTLS() {
    S.tlsInitFunctions.forEach((e) => e());
  }, loadWasmModuleToWorker: (e) => new Promise((r) => {
    e.onmessage = (a) => {
      var s = a.data, l = s.cmd;
      if (s.targetThread && s.targetThread != Se()) {
        var d = S.pthreads[s.targetThread];
      ...
      l === "checkMailbox" ? ze() : l === "spawnThread" ? zr(s) : l === "cleanupThread" ? Et(() => Lr(s.thread)) : l === "loaded" ? (e.loaded = !0, r(e)) : s.target === "setimmediate" ? e.postMessage(s) : l === "callHandler" ? c[s.handler](...s.args) : l && w(`worker sent an unknown command ${l}`);
    }, e.onerror = (a) => {
      var s = "worker sent an error!";
      throw e.pthread_ptr && (s = `Pthread ${ce(e.pthread_ptr)} sent an error!`), w(`${s} ${a.filename}:${a.lineno}: ${a.message}`), a;
    }, u(q instanceof WebAssembly.Memory, "WebAssembly memory should have been loaded by now!"), u(ae instanceof WebAssembly.Module, "WebAssembly Module should have been loaded by now!");
    var t = [], n = ["onExit", "onAbort", "print", "printErr"];
    for (var i of n)
      c.propertyIsEnumerable(i) && t.push(i);
    e.postMessage({ cmd: "load", handlers: t, wasmMemory: q, wasmModule: ae, workerID: e.workerID });
  }), async loadWasmModuleToAllWorkers() {
    return y ? void 0 : Promise.all(S.unusedWorkers.map(S.loadWasmModuleToWorker));
  }, allocateUnusedWorker() {
    var e;
    if (c.mainScriptUrlOrBlob) {
      var r = c.mainScriptUrlOrBlob;
      typeof r != "string" && (r = URL.createObjectURL(r)), e = new Worker(r, { type: "module", name: "em-pthread-" + S.nextWorkerID });
    } else e = new Worker(new URL(
      /* @vite-ignore */
      "/assets/cp_sat_runtime-CiW5s7R3.js",
      import.meta.url
    ), { type: "module", name: "em-pthread-" + S.nextWorkerID });
    e.workerID = S.nextWorkerID++, S.unusedWorkers.push(e);
  }, getNewWorker() {
    if (S.unusedWorkers.length == 0) {
      w("Tried to spawn a new thread, but the thread pool is exhausted.\nThis might result in a deadlock unless some threads eventually exit or the code explicitly breaks out to the event loop.\nIf you want to increase the pool size, use setting `-sPTHREAD_POOL_SIZE=...`.");
      return;
    }
    return S.unusedWorkers.pop();
  } }, Vr = [], hn = (e) => Vr.push(e);
  function pn(e) {
    var r = (f(), h)[e + 52 >> 2], t = (f(), h)[e + 56 >> 2], n = r - t;
    u(r != 0), u(n != 0), u(r > n, "stackHigh must be higher then stackLow"), qt(r, n), rr(r), Tr();
  }
  var ir = [], Gr = (e) => {
    var r = ir[e];
    return r || (ir[e] = r = Yt.get(e), Y.isAsyncExport(r) && (ir[e] = r = Y.makeAsyncFunction(r))), r;
  }, qr = async (e, r) => {
    pe = 0, ar = 0;
  ...
  qr.isAsync = !0;
  var ar = !0, gn = (e) => S.tlsInitFunctions.push(e), ne = (e) => {
    ...
    for (var a = ""; r < i; ) {
      ...
      var d = e[r++] & 63;
      if ((s & 240) == 224 ? s = (s & 15) << 12 | l << 6 | d : ((s & 248) != 240 && ne("Invalid UTF-8 leading byte " + ce(s) + " encountered when deserializing a UTF-8 string in wasm memory to a JS string!"), s = (s & 7) << 18 | l << 12 | d << 6 | e[r++] & 63), s < 65536)
        a += String.fromCharCode(s);
      else {
        var _ = s - 65536;
    ...
    return a;
  }, Z = (e, r, t) => (u(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? ge((f(), j), e, r, t) : ""), yn = (e, r, t, n) => C(`Assertion failed: ${Z(e)}, at: ` + [r ? Z(r) : "unknown filename", t, n ? Z(n) : "unknown function"]);
  class En {
    constructor(r) {
  ...
  var bn = () => !!globalThis.SharedArrayBuffer, Jr = (e, r, t, n) => {
  ...
  }, ye = Ue, F = { isAbs: (e) => e.charAt(0) === "/", splitPath: (e) => {
    var r = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/;
  ...
  }, basename: (e) => e && e.match(/([^\/]+|\/)\/*$/)[1], join: (...e) => F.normalize(e.join("/")), join2: (e, r) => F.normalize(e + "/" + r) }, Sn = () => (e) => e.set(crypto.getRandomValues(new Uint8Array(e.byteLength))), sr = (e) => {
    (sr = Sn())(e);
  }, Ee = { resolve: (...e) => {
    ...
    for (var i = t, a = t + n - 1, s = 0; s < e.length; ++s) {
      ...
      if (l <= 127) {
        ...
        if (t + 3 >= a) break;
        l > 1114111 && ne("Invalid Unicode code point " + ce(l) + " encountered when serializing a JS string to a UTF-8 string in wasm memory! (Valid unicode code points should be in range 0-0x10FFFF)."), r[t++] = 240 | l >> 18, r[t++] = 128 | l >> 12 & 63, r[t++] = 128 | l >> 6 & 63, r[t++] = 128 | l & 63, s++;
      }
    }
    return r[t] = 0, t - i;
  }, dr = (e, r, t) => {
    var n = oe(e) + 1, i = new Array(n), a = Zr(e, i, 0, i.length);
    return i.length = a, i;
  }, kn = () => {
    if (!lr.length) {
      var e = null;
...
`)), !e)
    ...
    ie.ttys[e] = { input: [], output: [], ops: r }, o.registerDevice(e, ie.stream_ops);
  }, stream_ops: { open(e) {
    var r = ie.ttys[e.node.rdev];
    if (!r)
    ...
    r === null || r === 10 ? (w(ge(e.output)), e.output = []) : r != 0 && e.output.push(r);
  }, fsync(e) {
    e.output?.length > 0 && (w(ge(e.output)), e.output = []);
  } } }, Tn = (e, r) => (f(), j).fill(0, e, e + r), Qr = (e, r) => (u(r, "alignment argument is required"), Math.ceil(e / r) * r), et = (e) => {
    e = Qr(e, 65536);
    var r = Bt(65536, e);
    return r && Tn(r, e), r;
    ...
    if (u(!(r instanceof ArrayBuffer)), r.buffer === (f(), W).buffer && (a = !1), !n) return 0;
    var s = e.node;
    ...
    if (!(i & 2) && l && l.buffer === (f(), W).buffer)
      s = !1, a = l.byteOffset;
    else {
      if (s = !0, a = et(r), !a)
        throw new o.ErrnoError(48);
      l && ((t > 0 || t + r < l.length) && (l.subarray ? l = l.subarray(t, t + r) : l = Array.prototype.slice.call(l, t, t + r)), (f(), W).set(l, a));
    }
    ...
    var d = r ? Ee.resolve(F.join2(e, r)) : e, _ = In(`cp ${d}`);
    Br(_);
    try {
      var v = t;
      typeof t == "string" && (v = await Pn(t)), v = await Mn(v, d), l?.(), a || Cn(e, r, v, n, i, s);
    } finally {
      $r(_);
    }
  }, Rn = (e, r, t, n, i, a, s, l, d, _) => {
    ...
    typeof e == "function" && (r = e, e = !1), o.syncFSRequests++, o.syncFSRequests > 1 && w(`warning: ${o.syncFSRequests} FS.syncfs operations in flight at once, probably just doing extra work`);
    ...
    var n = o.lookupPath(e, { parent: !0 }), i = n.node, a = F.basename(e);
    if (!a)
      throw new o.ErrnoError(28);
    if (a === "." || a === "..")
    ...
    var r = o.lookupPath(e, { parent: !0 }), t = r.node, n = F.basename(e), i = o.lookupNode(t, n), a = o.mayDelete(t, n, !0);
    if (a)
      throw new o.ErrnoError(a);
    if (!t.node_ops.rmdir)
      throw new o.ErrnoError(63);
    ...
    typeof r == "string" && (r = new Uint8Array(dr(r))), ArrayBuffer.isView(r) ? o.write(n, r, 0, r.byteLength, void 0, t.canOwn) : C("Unsupported data type"), o.close(n);
    ...
    o.mkdir("/dev"), o.registerDevice(o.makedev(1, 3), { read: () => 0, write: (n, i, a, s, l) => s, llseek: () => 0 }), o.mkdev("/dev/null", o.makedev(1, 3)), ie.register(o.makedev(5, 0), ie.default_tty_ops), ie.register(o.makedev(6, 0), ie.default_tty1_ops), o.mkdev("/dev/tty", o.makedev(5, 0)), o.mkdev("/dev/tty1", o.makedev(6, 0));
    ...
    try {
      ...
      n.parentExists = !0, n.parentPath = t.path, n.parentObject = t.node, n.name = F.basename(e), t = o.lookupPath(e, { follow: !r }), n.exists = !0, n.path = t.path, n.object = t.node, n.name = t.node.name, n.isRoot = t.path === "/";
    } catch (i) {
      n.error = i.errno;
    }
    return n;
    ...
    var a = F.join2(typeof e == "string" ? e : o.getPath(e), r), s = cr(n, i);
    return o.create(a, s);
    ...
    var i = F.join2(typeof e == "string" ? e : o.getPath(e), r), a = cr(!!t, !!n);
    ...
    class a {
      ...
      cacheLength() {
        ...
        m.open("HEAD", t, !1), m.send(null), m.status >= 200 && m.status < 300 || m.status === 304 || C("Couldn't load " + t + ". Status: " + m.status);
        var p = Number(m.getResponseHeader("Content-length")), k, b = (k = m.getResponseHeader("Accept-Ranges")) && k === "bytes", D = (k = m.getResponseHeader("Content-Encoding")) && k === "gzip", B = 1024 * 1024;
        b || (B = p);
        var H = (J, Te) => {
          J > Te && C("invalid range (" + J + ", " + Te + ") or no bytes requested!"), Te > p - 1 && C("only " + p + " bytes available! programmer error!");
          var x = new XMLHttpRequest();
          return x.open("GET", t, !1), p !== B && x.setRequestHeader("Range", "bytes=" + J + "-" + Te), x.responseType = "arraybuffer", x.overrideMimeType && x.overrideMimeType("text/plain; charset=x-user-defined"), x.send(null), x.status >= 200 && x.status < 300 || x.status === 304 || C("Couldn't load " + t + ". Status: " + x.status), x.response !== void 0 ? new Uint8Array(x.response || []) : dr(x.responseText || "");
        }, Ne = this;
        Ne.setDataGetter((J) => {
          var Te = J * B, x = (J + 1) * B - 1;
          return x = Math.min(x, p - 1), typeof Ne.chunks[J] > "u" && (Ne.chunks[J] = H(Te, x)), typeof Ne.chunks[J] > "u" && C("doXHR failed!"), Ne.chunks[J];
    ...
    function v(g, m, p, k, b) {
      var D = g.node.contents;
      if (b >= D.length) return 0;
      var B = Math.min(D.length - b, k);
      if (u(B >= 0), D.slice)
        for (var H = 0; H < B; H++)
          m[p + H] = D[b + H];
      else
    ...
    return _.read = (g, m, p, k, b) => (o.forceLoadFile(d), v(g, m, p, k, b)), _.mmap = (g, m, p, k, b) => {
      o.forceLoadFile(d);
      var D = et(m);
      if (!D)
        throw new o.ErrnoError(48);
      return v(g, (f(), W), D, m, p), { ptr: D, allocated: !0 };
    }, d.stream_ops = _, d;
  }, absolutePath() {
  ...
  } }, I = { DEFAULT_POLLMASK: 5, calculateAt(e, r, t) {
    if (F.isAbs(r))
      return r;
    var n;
    if (e === -100)
  ...
  var Dn = () => C("native code called abort()"), V = (e) => {
    for (var r = ""; ; ) {
      var t = (f(), j)[e++];
      if (!t) return r;
      r += String.fromCharCode(t);
    }
  }, we = {}, be = {}, $e = {}, Nn = class extends Error {
    constructor(r) {
  ...
  function On(e, r, t = {}) {
    ...
    if (be[e] = r, delete $e[e], we.hasOwnProperty(e)) {
      var i = we[e];
  ...
  var ut = (e, r, t) => {
    switch (r) {
      case 1:
        return t ? (n) => (f(), W)[n] : (n) => (f(), j)[n];
      case 2:
        return t ? (n) => (f(), se)[n >> 1] : (n) => (f(), Ce)[n >> 1];
      case 4:
    ...
    K(e, { name: r, fromWireType: s, toWireType: (l, d) => {
      if (typeof d == "number")
        ...
        throw new TypeError(`Cannot convert "${Be(d)}" to ${this.name}`);
      return ft(r, d, n, i), d;
  ...
  }, _t = [], Q = [0, 1, , 1, null, 1, !0, 1, !1, 1], xn = (e) => {
    e > 9 && --Q[e + 1] === 0 && (u(Q[e] !== void 0, "Decref for unallocated handle."), Q[e] = void 0, _t.push(e));
  }, mt = { toValue: (e) => (e || G(`Cannot use deleted val. handle = ${e}`), u(e === 2 || Q[e] !== void 0 && e % 2 === 0, `invalid handle: ${e}`), Q[e]), toHandle: (e) => {
    switch (e) {
      case void 0:
        return 2;
      case null:
  ...
  var Un = { name: "emscripten::val", fromWireType: (e) => {
    var r = mt.toValue(e);
    return xn(e), r;
  }, toWireType: (e, r) => mt.toHandle(r), readValueFromPointer: ur, destructorFunction: null }, $n = (e) => K(e, Un), Bn = (e, r) => {
    switch (r) {
      case 4:
        return function(t) {
    ...
    r = V(r), K(e, { name: r, fromWireType: (n) => n, toWireType: (n, i) => {
      if (typeof i != "number" && typeof i != "boolean")
        throw new TypeError(`Cannot convert ${Be(i)} to ${this.name}`);
      return i;
...
${_}`, new Function(g, _);
  ...
  function qn(e, r, t, n, i, a) {
    ...
    for (var l = r[1] !== null && t !== null, d = ht(r), _ = !r[0].isVoid, v = s - 2, g = Gn(r), m = r[0], p = r[1], k = [e, G, n, i, Hn, m.fromWireType.bind(m), p?.toWireType.bind(p)], b = 2; b < s; ++b) {
      var D = r[b];
      k.push(D.toWireType.bind(D));
    }
    if (!d)
      for (var b = 2; b < r.length; ++b)
        r[b].destructorFunction !== null && k.push(r[b].destructorFunction);
    k.push(jn, g, v);
    var H = Vn(r, l, _, a)(...k);
    return vt(e, H);
  }
  var Kn = (e, r, t) => {
    ...
    c.hasOwnProperty(e) ? ((t === void 0 || c[e].overloadTable !== void 0 && c[e].overloadTable[t] !== void 0) && G(`Cannot register public name '${e}' twice`), Kn(c, e, e), c[e].overloadTable.hasOwnProperty(t) && G(`Cannot register multiple overloads of a function with the same number of arguments (${t})!`), c[e].overloadTable[t] = r) : (c[e] = r, c[e].argCount = t);
  }, Yn = (e, r) => {
    for (var t = [], n = 0; n < e; n++)
      t.push((f(), h)[r + n * 4 >> 2]);
    return t;
  ...
  var ro = (e) => {
    ...
    throw r.forEach(i), new eo(`${e}: ` + t.map(ro).join([", "]));
  }, no = (e, r, t) => {
    e.forEach((l) => $e[l] = r);
    function n(l) {
      var d = t(l);
    ...
    var d = Yn(r, t);
    e = V(e), e = oo(e), i = Qn(n, i, s), Xn(e, function() {
      to(`Cannot call ${e} due to unbound types`, d);
    }, r - 1), no([], d, (_) => {
      var v = [_[0], null].concat(_.slice(1));
      return Zn(e, qn(e, v, null, i, a, s), r - 1), [];
    });
  }, ao = (e, r, t, n, i) => {
    r = V(r);
    const a = n === 0;
    ...
    function a(s) {
      ...
      return new i((f(), W).buffer, d, l);
    }
    t = V(t), K(e, { name: t, fromWireType: a, readValueFromPointer: a }, { ignoreDuplicateRegistrations: !0 });
  }, X = (e, r, t) => (u(typeof t == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), Zr(e, (f(), j), r, t)), lo = (e, r) => {
    r = V(r), K(e, { name: r, fromWireType(t) {
      var n = (f(), h)[t >> 2], i = t + 4, a;
      return a = Z(i, n, !0), ee(t), a;
    }, toWireType(t, n) {
      ...
      var s = De(4 + i + 1), l = s + 4;
      return (f(), h)[s >> 2] = i, a ? X(n, l, i + 1) : (f(), j).set(n, l), t !== null && t.push(ee, s), s;
    }, readValueFromPointer: ur, destructorFunction(t) {
      ee(t);
    } });
  }, gt = globalThis.TextDecoder ? new TextDecoder("utf-16le") : void 0, co = (e, r, t) => {
    ...
    return (f(), se)[r >> 1] = 0, r - n;
  }, fo = (e) => e.length * 2, _o = (e, r, t) => {
    ...
    t = V(t);
    var n, i, a;
    r === 2 ? (n = co, i = uo, a = fo) : (u(r === 4, "only 2-byte and 4-byte strings are currently supported"), n = _o, i = mo, a = vo), K(e, { name: t, fromWireType: (s) => {
      var l = (f(), h)[s >> 2], d = n(s + 4, l * r, !0);
      return ee(s), d;
    }, toWireType: (s, l) => {
      typeof l != "string" && G(`Cannot pass non-string to C++ string type ${t}`);
      var d = a(l), _ = De(4 + d + r);
    ...
    pr(e, !$, 1, !U, 65536, !1), S.threadInitTLS();
  }, yt = (e) => {
    if (e instanceof Nr || e == "unwind")
      return me;
    Pe(), e instanceof WebAssembly.RuntimeError && Er() <= 0 && w("Stack overflow detected.  You can try increasing -sSTACK_SIZE (currently set to 65536)"), Sr(1, e);
  }, yo = () => {
    if (!xe())
      try {
        if (y) {
    ...
    for (var a = i >> 3, s = 0; s < n; s++)
      (f(), N)[a + 2 * s] ? He[s] = (f(), N)[a + 2 * s + 1] : He[s] = (f(), Ie)[a + 2 * s + 1];
    var l = r ? vr[r] : ei[e];
    u(!(e && r)), u(l.length == n, "Call args mismatch in _emscripten_receive_on_main_thread_js"), S.currentProxiedOperationCallerThread = t;
    var d = l(...He);
    return S.currentProxiedOperationCallerThread = 0, u(typeof d != "bigint"), d;
  }, bo = (e) => {
    y ? postMessage({ cmd: "cleanupThread", thread: e }) : Lr(e);
  }, So = (e) => {
  }, ko = 9007199254740992, To = -9007199254740992, _r = (e) => e < To || e > ko ? NaN : Number(e);
  function wt(e, r, t, n, i, a, s) {
    if (y) return L(10, 0, 1, e, r, t, n, i, a, s);
    i = _r(i);
    try {
      u(!isNaN(i));
      var l = I.getStreamFromFD(n), d = o.mmap(l, e, i, r, t), _ = d.ptr;
  ...
  function bt(e, r, t, n, i, a) {
    if (y) return L(11, 0, 1, e, r, t, n, i, a);
    a = _r(a);
    try {
  ...
  var Fo = (e, r, t, n) => {
    ...
    var v = (p) => {
      var k = p >= 0 ? "-" : "+", b = Math.abs(p), D = String(Math.floor(b / 60)).padStart(2, "0"), B = String(b % 60).padStart(2, "0");
      return `UTC${k}${D}${B}`;
    }, g = v(l), m = v(d);
    u(g), u(m), u(oe(g) <= 16, `timezone name truncated to fit in TZNAME_MAX (${g})`), u(oe(m) <= 16, `timezone name truncated to fit in TZNAME_MAX (${m})`), d < l ? (X(g, t, 17), X(m, n, 17)) : (X(g, n, 17), X(m, t, 17));
  }, St = () => performance.timeOrigin + performance.now(), Ao = () => Date.now(), Po = (e) => e >= 0 && e <= 3;
  function Co(e, r, t) {
    if (!Po(e))
      return 28;
    var n;
  ...
  var je = [], Io = (e, r) => {
    u(Array.isArray(je)), u(r % 16 == 0), je.length = 0;
    for (var t; t = (f(), j)[e++]; ) {
      ...
      var a = t != 105;
      a &= t != 112, r += a && r % 8 ? 4 : 0, je.push(t == 112 ? (f(), h)[r >> 2] : t == 106 ? (f(), N)[r >> 3] : t == 105 ? (f(), R)[r >> 2] : (f(), Ie)[r >> 3]), r += a ? 8 : 4;
    }
    return je;
  }, Mo = (e, r, t) => {
    var n = Io(r, t);
    ...
    throw kt(), "unwind";
  }, Tt = () => 2147483648, Lo = () => Tt(), Wo = () => navigator.hardwareConcurrency, ue = {}, Ft = (e) => {
    var r = oe(e) + 1, t = De(r);
    return t && X(e, t, r), t;
  }, Ve = (e) => {
    var r;
    ...
    var e = Pt().split(`
`);
    return e[0] == "Error" && e.shift(), At(e), ue.last_addr = Ve(e[3]), ue.last_stack = e, ue.last_addr;
  }, Ge = (e) => {
    var r = ue[e];
    if (!r) return 0;
    var t, n;
    if (n = /^\s+at .*\.wasm\.(.*) \(.*\)$/.exec(r))
      ...
      return 0;
    return ee(Ge.ret ?? 0), Ge.ret = Ft(t), Ge.ret;
  }, Uo = (e) => {
    ...
    for (var n = 1; n <= 4; n *= 2) {
      ...
      var a = Math.min(t, Qr(Math.max(e, i), 65536)), s = Uo(a);
      if (s)
        return !0;
    }
    return w(`Failed to grow the heap from ${r} bytes to ${a} bytes, not enough memory!`), !1;
  }, Bo = (e, r, t) => {
    var n;
    ue.last_addr == e ? n = ue.last_stack : (n = Pt().split(`
`), n[0] == "Error" && n.shift(), At(n));
    for (var i = 3; n[i] && Ve(n[i]) != e; )
      ++i;
    for (var a = 0; a < t && n[a + i]; ++a)
      (f(), R)[r + a * 4 >> 2] = Ve(n[a + i]);
    return a;
  }, mr = {}, zo = () => br || "./this.program", Re = () => {
    if (!Re.strings) {
      var e = (typeof navigator == "object" && navigator.language || "C").replace("-", "_") + ".UTF-8", r = { USER: "web_user", LOGNAME: "web_user", PATH: "/", PWD: "/", HOME: "/home/web_user", LANG: e, _: zo() };
      for (var t in mr)
  ...
  function Rt(e, r, t, n) {
    ...
    try {
      var i = I.getStreamFromFD(e), a = Ho(i, r, t);
      return (f(), h)[n >> 2] = a, 0;
    } catch (s) {
      if (typeof o > "u" || s.name !== "ErrnoError") throw s;
      return s.errno;
  ...
  function Nt(e, r, t, n) {
    ...
    try {
      var i = I.getStreamFromFD(e), a = jo(i, r, t);
      return (f(), h)[n >> 2] = a, 0;
    } catch (s) {
      if (typeof o > "u" || s.name !== "ErrnoError") throw s;
      return s.errno;
  ...
  var Go = () => {
    ...
    Y.asyncExports = /* @__PURE__ */ new Set();
    var t = {};
    for (let [i, a] of Object.entries(e))
      if (typeof a == "function") {
        r.test(i) && (Y.asyncExports.add(a), a = Y.makeAsyncFunction(a));
        var n = Y.instrumentFunction(a);
        t[i] = n;
      } else
        t[i] = a;
    return t;
  }, asyncExports: null, isAsyncExport(e) {
    return Y.asyncExports?.has(e);
  }, handleAsync: async (e) => {
    kt();
    try {
      return await e();
  ...
  }, handleSleep: (e) => Y.handleAsync(() => new Promise(e)), makeAsyncFunction(e) {
    ...
    var a = { string: (b) => {
      var D = 0;
      return b != null && b !== 0 && (D = Xo(b)), D;
    }, array: (b) => {
      var D = tr(b.length);
      return Ko(b, D), D;
    } };
    function s(b) {
      return r === "string" ? Z(b) : r === "boolean" ? !!b : b;
    }
    var l = qo(e), d = [], _ = 0;
  ...
  Wt.sig = "i";
  var xt = A("___getTypeName"), Ut = A("__embind_initialize_bindings");
  ...
  var De = c._malloc = A("_malloc");
  c._free_buffer = A("_free_buffer");
  var ee = c._free = A("_free");
  c._interrupt_solve = A("_interrupt_solve"), c._validate_model = A("_validate_model");
  var Se = A("_pthread_self"), hr = A("_fflush"), $t = A("_strerror"), Bt = A("_emscripten_builtin_memalign"), pr = A("__emscripten_thread_init"), zt = A("__emscripten_thread_crashed"), gr = A("_emscripten_stack_get_end"), Ht = A("__emscripten_run_js_on_main_thread"), jt = A("__emscripten_thread_free_data"), yr = A("__emscripten_thread_exit"), Vt = A("__emscripten_check_mailbox"), Gt = A("_emscripten_stack_init"), qt = A("_emscripten_stack_set_limits"), Kt = A("__emscripten_stack_restore"), Xt = A("__emscripten_stack_alloc"), Er = A("_emscripten_stack_get_current"), Yt = A("wasmTable");
  function ti(e) {
    u(typeof e.__getTypeName < "u", "missing Wasm export: __getTypeName"), u(typeof e._embind_initialize_bindings < "u", "missing Wasm export: _embind_initialize_bindings"), u(typeof e.get_cp_model_schema < "u", "missing Wasm export: get_cp_model_schema"), u(typeof e.get_sat_parameters_schema < "u", "missing Wasm export: get_sat_parameters_schema"), u(typeof e.solve_model < "u", "missing Wasm export: solve_model"), u(typeof e.malloc < "u", "missing Wasm export: malloc"), u(typeof e.free_buffer < "u", "missing Wasm export: free_buffer"), u(typeof e.free < "u", "missing Wasm export: free"), u(typeof e.interrupt_solve < "u", "missing Wasm export: interrupt_solve"), u(typeof e.validate_model < "u", "missing Wasm export: validate_model"), u(typeof e.pthread_self < "u", "missing Wasm export: pthread_self"), u(typeof e.fflush < "u", "missing Wasm export: fflush"), u(typeof e.strerror < "u", "missing Wasm export: strerror"), u(typeof e._emscripten_tls_init < "u", "missing Wasm export: _emscripten_tls_init"), u(typeof e.emscripten_builtin_memalign < "u", "missing Wasm export: emscripten_builtin_memalign"), u(typeof e._emscripten_thread_init < "u", "missing Wasm export: _emscripten_thread_init"), u(typeof e._emscripten_thread_crashed < "u", "missing Wasm export: _emscripten_thread_crashed"), u(typeof e.emscripten_stack_get_end < "u", "missing Wasm export: emscripten_stack_get_end"), u(typeof e.emscripten_stack_get_base < "u", "missing Wasm export: emscripten_stack_get_base"), u(typeof e._emscripten_run_js_on_main_thread < "u", "missing Wasm export: _emscripten_run_js_on_main_thread"), u(typeof e._emscripten_thread_free_data < "u", "missing Wasm export: _emscripten_thread_free_data"), u(typeof e._emscripten_thread_exit < "u", "missing Wasm export: _emscripten_thread_exit"), u(typeof e._emscripten_check_mailbox < "u", "missing Wasm export: _emscripten_check_mailbox"), u(typeof e.emscripten_stack_init < "u", "missing Wasm export: emscripten_stack_init"), u(typeof e.emscripten_stack_set_limits < "u", "missing Wasm export: emscripten_stack_set_limits"), u(typeof e.emscripten_stack_get_free < "u", "missing Wasm export: emscripten_stack_get_free"), u(typeof e._emscripten_stack_restore < "u", "missing Wasm export: _emscripten_stack_restore"), u(typeof e._emscripten_stack_alloc < "u", "missing Wasm export: _emscripten_stack_alloc"), u(typeof e.emscripten_stack_get_current < "u", "missing Wasm export: emscripten_stack_get_current"), u(typeof e.__indirect_function_table < "u", "missing Wasm export: __indirect_function_table"), xt = O("__getTypeName", 1), Ut = O("_embind_initialize_bindings", 0), c._get_cp_model_schema = O("get_cp_model_schema", 0), c._get_sat_parameters_schema = O("get_sat_parameters_schema", 0), c._solve_model = O("solve_model", 5), De = c._malloc = O("malloc", 1), c._free_buffer = O("free_buffer", 1), ee = c._free = O("free", 1), c._interrupt_solve = O("interrupt_solve", 0), c._validate_model = O("validate_model", 3), Se = O("pthread_self", 0), hr = O("fflush", 1), $t = O("strerror", 1), Bt = O("emscripten_builtin_memalign", 2), pr = O("_emscripten_thread_init", 6), zt = O("_emscripten_thread_crashed", 0), gr = e.emscripten_stack_get_end, e.emscripten_stack_get_base, Ht = O("_emscripten_run_js_on_main_thread", 5), jt = O("_emscripten_thread_free_data", 1), yr = O("_emscripten_thread_exit", 1), Vt = O("_emscripten_check_mailbox", 0), Gt = e.emscripten_stack_init, qt = e.emscripten_stack_set_limits, e.emscripten_stack_get_free, Kt = e._emscripten_stack_restore, Xt = e._emscripten_stack_alloc, Er = e.emscripten_stack_get_current, Yt = e.__indirect_function_table;
  }
  var ke;
  function ni() {
    ke = { GetHostCString: Lt, HaveOffsetConverter: Wt, __assert_fail: yn, __cxa_throw: wn, __pthread_create_js: Jr, __syscall_fcntl64: ot, __syscall_fstat64: it, __syscall_ioctl: at, __syscall_lstat64: st, __syscall_newfstatat: lt, __syscall_openat: dt, __syscall_stat64: ct, _abort_js: Dn, _embind_register_bigint: Ln, _embind_register_bool: Wn, _embind_register_emval: $n, _embind_register_float: zn, _embind_register_function: io, _embind_register_integer: ao, _embind_register_memory_view: so, _embind_register_std_string: lo, _embind_register_std_wstring: ho, _embind_register_void: po, _emscripten_init_main_thread_js: go, _emscripten_notify_mailbox_postmessage: Eo, _emscripten_receive_on_main_thread_js: wo, _emscripten_thread_cleanup: bo, _emscripten_thread_mailbox_await: fr, _emscripten_thread_set_strongref: So, _mmap_js: wt, _munmap_js: bt, _tzset_js: Fo, clock_time_get: Co, emscripten_asm_const_int: Ro, emscripten_check_blocking_allowed: Do, emscripten_errn: No, emscripten_exit_with_live_runtime: Oo, emscripten_get_heap_max: Lo, emscripten_get_now: St, emscripten_num_logical_cores: Wo, emscripten_pc_get_function: Ge, emscripten_resize_heap: $o, emscripten_stack_snapshot: xo, emscripten_stack_unwind_buffer: Bo, environ_get: Ct, environ_sizes_get: It, exit: or, fd_close: Mt, fd_read: Rt, fd_seek: Dt, fd_write: Nt, memory: q, proc_exit: nr, random_get: Vo };
  }
  var Jt;
  function oi() {
    u(!y), Gt(), Tr();
  ...
  function qe() {
    ...
    async function e() {
      u(!Jt), Jt = !0, c.calledRun = !0, !_e && (Mr(), Je?.(c), c.onRuntimeInitialized?.(), Le("onRuntimeInitialized"), u(!c._main, 'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]'), dn());
    }
  ...
  function ii() {
    ...
    try {
      ...
      for (var n of ["stdout", "stderr"]) {
        ...
        if (!i) return;
        var a = i.object, s = a.rdev, l = ie.ttys[s];
        l?.output?.length && (t = !0);
      }
    } catch {
    }
    te = e, w = r, t && ne("stdio streams had content in them that was not flushed. you should set EXIT_RUNTIME to 1 (see the Emscripten FAQ), or make sure to emit a newline when you printf etc.");
  }
  var re;
  y || (re = await Dr(), qe()), ve ? T = c : T = new Promise((e, r) => {
    Je = e, Ze = r;
  });
  for (const e of Object.keys(c))
    e in M || Object.defineProperty(M, e, { configurable: !0, get() {
...
var ai = globalThis.self?.name?.startsWith("em-pthread");
ai && Zt();
async function si() {
  return await Zt({});
}
const Fe = self;
let P = null;
const li = si().then((M) => (P = M, Fe.postMessage({ type: "ready" }), M)).catch((M) => {
  throw console.error("[cpsat_worker] cpSatModule init failed:", M), Fe.postMessage({
    type: "error",
    id: 0,
    error: String(M)
  }), M;
}), Qt = (M, T) => new DataView(M, T, 4).getUint32(0, !0), wr = (M) => {
  if (!P || !M?.length)
    return 0;
  const T = P._malloc(M.length);
  return P.HEAPU8.set(M, T), T;
};
async function di(M, T) {
  if (!P)
    throw new Error("Module not initialized.");
  const c = P._malloc(4), U = wr(M), $ = wr(T ?? null);
  let z = 0;
  try {
    z = await P.ccall(
      "solve_model",
  ...
  const fe = Qt(P.HEAPU8.buffer, c);
  if (P._free(c), !z || fe === 0)
    return z && P._free_buffer(z), new Uint8Array();
  const y = P.HEAPU8.slice(z, z + fe);
  return P._free_buffer(z), y;
}
async function ci(M) {
  if (!P)
    throw new Error("Module not initialized.");
  const T = P._malloc(4), c = wr(M);
  let U = 0;
  try {
    U = P.ccall(
      "validate_model",
  ...
  const $ = Qt(P.HEAPU8.buffer, T);
  if (P._free(T), !U || $ === 0)
    return U && P._free_buffer(U), { ok: !0, message: "" };
  const z = P.HEAPU8.slice(U, U + $);
  return P._free_buffer(U), { ok: !1, message: new TextDecoder().decode(z) };
}
Fe.onmessage = async (M) => {
  const T = M.data;
  try {
    if (await li, !P)
      throw new Error("Module not initialized.");
    if (T.type === "validate") {
      const c = await ci(T.modelBytes);
      Fe.postMessage({
        type: "validateResult",
        id: T.id,
        ok: c.ok,
      ...
      return;
    } else if (T.type === "solve") {
      const c = await di(T.modelBytes, T.paramsBytes);
      Fe.postMessage({
        type: "solveResult",
        id: T.id,
        bytes: c
      ...
      return;
    } else if (T.type === "getSchemas") {
      const c = {
        cp_model: P.ccall("get_cp_model_schema", "string", [], []),
        sat_parameters: P.ccall("get_sat_parameters_schema", "string", [], [])
      };
      self.postMessage({ type: "schemaResult", id: T.id, schemas: c });
      return;
    } else if (T.type === "cancel_solve") {
      P.ccall("interrupt_solve", "void", [], []), self.postMessage({ type: "solved_cancelled", id: T.id });
      return;
    }
  } catch (c) {
    console.error("[cpsat_worker] request failed", T?.type, c), Fe.postMessage({
      type: "error",
      id: T?.id ?? 0,
      error: String(c)
    });
...
//# sourceMappingURL=cpsat_worker-CtxqFpcR.js.map
