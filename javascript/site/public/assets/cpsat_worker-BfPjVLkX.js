async function Zt(I = {}) {
    ...
    async function e(r) {
      try {
        ...
        if (n === "load") {
          ...
          q = t.wasmMemory, xe(), ae = t.wasmModule, Dr(), qe();
        } else if (n === "run") {
  ...
  var x, j, se, Ce, R, h, Cr, Ie, N, Ir, ve = !1;
  function xe() {
    var e = q.buffer;
    x = new Int8Array(e), se = new Int16Array(e), c.HEAPU8 = j = new Uint8Array(e), Ce = new Uint16Array(e), R = new Int32Array(e), h = new Uint32Array(e), Cr = new Float32Array(e), Ie = new Float64Array(e), N = new BigInt64Array(e), Ir = new BigUint64Array(e);
  }
  function sn() {
    if (!y) {
      if (c.wasmMemory)
  ...
  }, pe = 0, Le = () => ar || pe > 0, Hr = () => Er(), rr = (e) => Kt(e), tr = (e) => Xt(e), W = (e, r, t, ...n) => {
  ...
  var vn = (e, r) => {
    ...
    e.onmessage = (a) => {
      ...
      l === "checkMailbox" ? ze() : l === "spawnThread" ? zr(s) : l === "cleanupThread" ? Et(() => Wr(s.thread)) : l === "loaded" ? (e.loaded = !0, r(e)) : s.target === "setimmediate" ? e.postMessage(s) : l === "callHandler" ? c[s.handler](...s.args) : l && b(`worker sent an unknown command ${l}`);
    }, e.onerror = (a) => {
    ...
    if (c.mainScriptUrlOrBlob) {
      ...
      /* @vite-ignore */
      "/assets/cp_sat_runtime-B5ndVAuh.js",
      import.meta.url
...
`)), !e)
    ...
    return m.read = (g, _, p, k, S) => (o.forceLoadFile(d), v(g, _, p, k, S)), m.mmap = (g, _, p, k, S) => {
      ...
      if (!D)
        throw new o.ErrnoError(48);
      return v(g, (f(), x), D, _, p), { ptr: D, allocated: !0 };
    }, d.stream_ops = m, d;
  }, absolutePath() {
...
${m}`, new Function(g, m);
  ...
  var je = [], Io = (e, r) => {
    ...
    throw kt(), "unwind";
  }, Tt = () => 2147483648, Wo = () => Tt(), xo = () => navigator.hardwareConcurrency, ue = {}, Ft = (e) => {
    var r = oe(e) + 1, t = De(r);
    return t && X(e, t, r), t;
  }, Ve = (e) => {
    var r;
...
`), n[0] == "Error" && n.shift(), At(n));
  ...
  var ke;
  function ni() {
    ke = { GetHostCString: Wt, HaveOffsetConverter: xt, __assert_fail: yn, __cxa_throw: wn, __pthread_create_js: Jr, __syscall_fcntl64: ot, __syscall_fstat64: it, __syscall_ioctl: at, __syscall_lstat64: st, __syscall_newfstatat: lt, __syscall_openat: dt, __syscall_stat64: ct, _abort_js: Dn, _embind_register_bigint: Wn, _embind_register_bool: xn, _embind_register_emval: $n, _embind_register_float: zn, _embind_register_function: io, _embind_register_integer: ao, _embind_register_memory_view: so, _embind_register_std_string: lo, _embind_register_std_wstring: ho, _embind_register_void: po, _emscripten_init_main_thread_js: go, _emscripten_notify_mailbox_postmessage: Eo, _emscripten_receive_on_main_thread_js: wo, _emscripten_thread_cleanup: bo, _emscripten_thread_mailbox_await: fr, _emscripten_thread_set_strongref: So, _mmap_js: wt, _munmap_js: bt, _tzset_js: Fo, clock_time_get: Co, emscripten_asm_const_int: Ro, emscripten_check_blocking_allowed: Do, emscripten_errn: No, emscripten_exit_with_live_runtime: Oo, emscripten_get_heap_max: Wo, emscripten_get_now: St, emscripten_num_logical_cores: xo, emscripten_pc_get_function: Ge, emscripten_resize_heap: $o, emscripten_stack_snapshot: Lo, emscripten_stack_unwind_buffer: Bo, environ_get: Ct, environ_sizes_get: It, exit: or, fd_close: Mt, fd_read: Rt, fd_seek: Dt, fd_write: Nt, memory: q, proc_exit: nr, random_get: Vo };
  }
  var Jt;
  function oi() {
    u(!y), Gt(), Tr();
  ...
  function qe() {
    ...
    async function e() {
      u(!Jt), Jt = !0, c.calledRun = !0, !me && (Mr(), Je?.(c), c.onRuntimeInitialized?.(), We("onRuntimeInitialized"), u(!c._main, 'compiled without a main, but one is present. if you added it from JS, use Module["onRuntimeInitialized"]'), dn());
    }
...
//# sourceMappingURL=cpsat_worker-BfPjVLkX.js.map
