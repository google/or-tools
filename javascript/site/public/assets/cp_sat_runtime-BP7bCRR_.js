async function Qi(ze = {}) {
      ...
      try {
        ...
        if (n === "load") {
          ...
          for (const o of t.handlers)
            ...
            }, o == "print" && (J = f[o]), o == "printErr" && (w = f[o]));
          B = t.wasmMemory, Ie(), ee = t.wasmModule, Ir(), Be();
        } else if (n === "run") {
          c(t.pthread_ptr), un(t.pthread_ptr), mr(t.pthread_ptr, 0, 0, 1, 0, 0), S.threadInitTLS(), dr(t.pthread_ptr), Ye || (Ot(), Ye = !0);
          try {
        ...
        } else t.target === "setimmediate" || (n === "checkMailbox" ? Ye && Oe() : n && (w(`worker: received unknown command ${n}`), w(t)));
      } catch (a) {
        throw w(`worker: onmessage() captured an uncaught exception: ${a}`), a?.stack && w(a.stack), Wt(), a;
      }
    }
    self.onmessage = e;
  }
  var N, W, re, be, C, h, Fr, Se, M, Ar, de = !1;
  function Ie() {
    var e = B.buffer;
    N = new Int8Array(e), re = new Int16Array(e), f.HEAPU8 = W = new Uint8Array(e), be = new Uint16Array(e), C = new Int32Array(e), h = new Uint32Array(e), Fr = new Float32Array(e), Se = new Float64Array(e), M = new BigInt64Array(e), Ar = new BigUint64Array(e);
  }
  function en() {
    if (!y) {
      if (f.wasmMemory)
  ...
  var Je;
  function nn() {
    return f.locateFile ? Xt("cp_sat_runtime.wasm") : new URL("/assets/cp_sat_runtime-CVEr9_T1.wasm", import.meta.url).href;
  }
  function an(e) {
    if (e == Je && Ee)
  ...
  async function sn(e, r) {
    try {
      var t = await on(e), n = await WebAssembly.instantiate(t, r);
      return n;
    } catch (a) {
      w(`failed to asynchronously prepare wasm: ${a}`), wr(e) && w(`warning: Loading from a file URI (${e}) is not supported in most browsers. See https://emscripten.org/docs/getting_started/FAQ.html#how-do-i-run-a-local-webserver-for-testing-why-does-my-program-stall-in-downloading-or-preparing`), A(a);
    }
  }
  ...
  async function Ir() {
    ...
    if (y) {
      ...
      var a = new WebAssembly.Instance(ee, Cr());
      return e(a, ee);
    }
    Je ??= nn();
    var o = await ln(Ee, Je, n), s = t(o);
    return s;
  }
  class Mr {
    name = "ExitStatus";
  ...
  var Rr = (e) => {
    ...
    for (; e.length > 0; )
      e.shift()(f);
  }, Or = [], xr = (e) => Or.push(e), te = 0, ke = null, ce = {}, ne = null, Lr = (e) => {
  ...
  function er(e) {
    ...
    le = e, Me() || (S.terminateAllThreads(), f.onExit?.(e), se = !0), Er(e, new Mr(e));
  }
  function Br(e) {
  ...
  var dn = (e, r) => {
    ...
    er(e);
  }, rr = dn, ie = (e) => (c(typeof e == "number", `ptrToString expects a number, got ${typeof e}`), e >>>= 0, "0x" + e.toString(16).padStart(8, "0")), S = { unusedWorkers: [], runningWorkers: [], tlsInitFunctions: [], pthreads: {}, nextWorkerID: 1, init() {
    y || S.initMainThread();
  }, initMainThread() {
    ...
    xr(async () => {
      ...
      Wr("loading-workers"), await r, Lr("loading-workers");
    });
  }, terminateAllThreads: () => {
    ...
    var r = e.pthread_ptr;
    delete S.pthreads[r], S.unusedWorkers.push(e), S.runningWorkers.splice(S.runningWorkers.indexOf(e), 1), e.pthread_ptr = 0, $t(r);
  }, threadInitTLS() {
    ...
    e.onmessage = (o) => {
      ...
      l === "checkMailbox" ? Oe() : l === "spawnThread" ? Ur(s) : l === "cleanupThread" ? pt(() => Dr(s.thread)) : l === "loaded" ? (e.loaded = !0, r(e)) : s.target === "setimmediate" ? e.postMessage(s) : l === "callHandler" ? f[s.handler](...s.args) : l && w(`worker sent an unknown command ${l}`);
    }, e.onerror = (o) => {
      var s = "worker sent an error!";
      throw e.pthread_ptr && (s = `Pthread ${ie(e.pthread_ptr)} sent an error!`), w(`${s} ${o.filename}:${o.lineno}: ${o.message}`), o;
    ...
    if (f.mainScriptUrlOrBlob) {
      ...
      /* @vite-ignore */
      "/assets/cp_sat_runtime-Crr9ZZSI.js",
      import.meta.url
    ), { type: "module", name: "em-pthread-" + S.nextWorkerID });
  ...
  Hr.isAsync = !0;
  var nr = !0, fn = (e) => S.tlsInitFunctions.push(e), Z = (e) => {
    ...
    return o;
  }, V = (e, r, t) => (c(typeof e == "number", `UTF8ToString expects a number (got ${typeof e})`), e ? fe((u(), W), e, r, t) : ""), _n = (e, r, t, n) => A(`Assertion failed: ${V(e)}, at: ` + [r ? V(r) : "unknown filename", t, n ? V(n) : "unknown function"]);
  class mn {
    constructor(r) {
  ...
  var hn = () => !!globalThis.SharedArrayBuffer, Kr = (e, r, t, n) => {
    ...
    return r = T.normalizeArray(r.split("/").filter((o) => !!o), !t).join("/"), (t ? "/" : "") + r || ".";
  }, relative: (e, r) => {
    ...
    var n = ae(e) + 1, a = new Array(n), o = Xr(e, a, 0, a.length);
    return a.length = o, a;
  }, gn = () => {
    if (!ar.length) {
      var e = null;
...
`)), !e)
  ...
  } } }, yn = (e, r) => (u(), W).fill(0, e, e + r), Yr = (e, r) => (c(r, "alignment argument is required"), Math.ceil(e / r) * r), Jr = (e) => {
    e = Yr(e, 65536);
    var r = Lt(65536, e);
    return r && yn(r, e), r;
    ...
    if (c(!(r instanceof ArrayBuffer)), r.buffer === (u(), N).buffer && (o = !1), !n) return 0;
    var s = e.node;
    ...
    if (!(a & 2) && l && l.buffer === (u(), N).buffer)
      s = !1, o = l.byteOffset;
    else {
      if (s = !0, o = Jr(r), !o)
        throw new i.ErrnoError(48);
      l && ((t > 0 || t + r < l.length) && (l.subarray ? l = l.subarray(t, t + r) : l = Array.prototype.slice.call(l, t, t + r)), (u(), N).set(l, o));
    }
    ...
    try {
      var v = t;
      typeof t == "string" && (v = await bn(t)), v = await Tn(v, d), l?.(), o || Sn(e, r, v, n, a, s);
    } finally {
      Lr(_);
    }
  }, Fn = (e, r, t, n, a, o, s, l, d, _) => {
    et(e, r, t, n, a, l, d, _).then(o).catch(s);
      ...
      for (var n = e.split("/").filter((_) => !!_), a = i.root, o = "/", s = 0; s < n.length; s++) {
        ...
        if (n[s] !== ".") {
          ...
          if (i.isMountpoint(a) && (!l || r.follow_mount) && (a = a.mounted.root), i.isLink(a.mode) && (!l || r.follow)) {
            ...
            T.isAbs(d) || (d = T.dirname(o) + "/" + d), e = d + "/" + n.slice(s + 1).join("/");
            continue e;
          }
        }
      }
    ...
    var n = i.lookupPath(e, { parent: !0 }), a = n.node, o = T.basename(e);
    if (!o)
      throw new i.ErrnoError(28);
    if (o === "." || o === "..")
    ...
    if (!n)
      throw new i.ErrnoError(44);
    var a = T.basename(r), o = i.mayCreate(n, a);
    if (o)
    ...
    var t = T.dirname(e), n = T.dirname(r), a = T.basename(e), o = T.basename(r), s, l, d;
    ...
    var _ = i.lookupNode(l, a), v = me.relative(e, n);
    if (v.charAt(0) !== ".")
      throw new i.ErrnoError(28);
    ...
    if (_ !== g) {
      var m = i.isDir(_.mode), p = i.mayDelete(l, a, m);
      if (p)
        throw new i.ErrnoError(p);
      if (p = g ? i.mayDelete(d, o, m) : i.mayCreate(d, o), p)
        throw new i.ErrnoError(p);
      ...
      i.hashRemoveNode(_);
      try {
        l.node_ops.rename(_, d, o), _.parent = d;
      } catch (k) {
        throw k;
      } finally {
        i.hashAddNode(_);
    ...
    var r = i.lookupPath(e, { parent: !0 }), t = r.node, n = T.basename(e), a = i.lookupNode(t, n), o = i.mayDelete(t, n, !0);
    if (o)
      throw new i.ErrnoError(o);
    if (!t.node_ops.rmdir)
      throw new i.ErrnoError(63);
    ...
    if (!t)
      throw new i.ErrnoError(44);
    var n = T.basename(e), a = i.lookupNode(t, n), o = i.mayDelete(t, n, !1);
    if (o)
      throw new i.ErrnoError(o);
    ...
    return i.read(t, o, 0, a, 0), r.encoding === "utf8" && (o = fe(o)), i.close(t), o;
  }, writeFile(e, r, t = {}) {
    t.flags = t.flags || 577;
    var n = i.open(e, t.flags, t.mode);
    typeof r == "string" && (r = new Uint8Array(or(r))), ArrayBuffer.isView(r) ? i.write(n, r, 0, r.byteLength, void 0, t.canOwn) : A("Unsupported data type"), i.close(n);
    ...
    i.mkdir("/dev"), i.registerDevice(i.makedev(1, 3), { read: () => 0, write: (n, a, o, s, l) => s, llseek: () => 0 }), i.mkdev("/dev/null", i.makedev(1, 3)), Q.register(i.makedev(5, 0), Q.default_tty_ops), Q.register(i.makedev(6, 0), Q.default_tty1_ops), i.mkdev("/dev/tty", i.makedev(5, 0)), i.mkdev("/dev/tty1", i.makedev(6, 0));
    ...
    var o = T.join2(typeof e == "string" ? e : i.getPath(e), r), s = sr(n, a);
    return i.create(o, s);
    ...
    if (t) {
      ...
      i.chmod(d, l | 146);
      var m = i.open(d, 577);
      i.write(m, t, 0, t.length, 0, o), i.close(m), i.chmod(d, l);
    }
  }, createDevice(e, r, t, n) {
    var a = T.join2(typeof e == "string" ? e : i.getPath(e), r), o = sr(!!t, !!n);
    ...
    class o {
      ...
      cacheLength() {
        ...
        var p = Number(m.getResponseHeader("Content-length")), k, b = (k = m.getResponseHeader("Accept-Ranges")) && k === "bytes", I = (k = m.getResponseHeader("Content-Encoding")) && k === "gzip", x = 1024 * 1024;
        b || (x = p);
        var L = (H, ye) => {
          H > ye && A("invalid range (" + H + ", " + ye + ") or no bytes requested!"), ye > p - 1 && A("only " + p + " bytes available! programmer error!");
          var O = new XMLHttpRequest();
          return O.open("GET", t, !1), p !== x && O.setRequestHeader("Range", "bytes=" + H + "-" + ye), O.responseType = "arraybuffer", O.overrideMimeType && O.overrideMimeType("text/plain; charset=x-user-defined"), O.send(null), O.status >= 200 && O.status < 300 || O.status === 304 || A("Couldn't load " + t + ". Status: " + O.status), O.response !== void 0 ? new Uint8Array(O.response || []) : or(O.responseText || "");
        }, Fe = this;
        Fe.setDataGetter((H) => {
          var ye = H * x, O = (H + 1) * x - 1;
          return O = Math.min(O, p - 1), typeof Fe.chunks[H] > "u" && (Fe.chunks[H] = L(ye, O)), typeof Fe.chunks[H] > "u" && A("doXHR failed!"), Fe.chunks[H];
        }), (I || !p) && (x = p = 1, p = this.getter(0).length, x = p, J("LazyFiles on gzip forces download of the whole file when length is accessed")), this._length = p, this._chunkSize = x, this.lengthKnown = !0;
      }
      get length() {
    ...
    return (u(), M)[e + 40 >> 3] = BigInt(Math.floor(t / 1e3)), (u(), h)[e + 48 >> 2] = t % 1e3 * 1e3 * 1e3, (u(), M)[e + 56 >> 3] = BigInt(Math.floor(n / 1e3)), (u(), h)[e + 64 >> 2] = n % 1e3 * 1e3 * 1e3, (u(), M)[e + 72 >> 3] = BigInt(Math.floor(a / 1e3)), (u(), h)[e + 80 >> 2] = a % 1e3 * 1e3 * 1e3, (u(), M)[e + 88 >> 3] = BigInt(r.ino), 0;
  }, writeStatFs(e, r) {
      ...
      switch (r) {
        ...
        case 21505: {
          ...
          if (n.tty.ops.ioctl_tcgets) {
            var a = n.tty.ops.ioctl_tcgets(n), o = _e();
            (u(), C)[o >> 2] = a.c_iflag || 0, (u(), C)[o + 4 >> 2] = a.c_oflag || 0, (u(), C)[o + 8 >> 2] = a.c_cflag || 0, (u(), C)[o + 12 >> 2] = a.c_lflag || 0;
            for (var s = 0; s < 32; s++)
              (u(), N)[o + s + 17] = a.c_cc[s] || 0;
            return 0;
          }
          return 0;
        }
        ...
        case 21508: {
          ...
          if (n.tty.ops.ioctl_tcsets) {
            for (var o = _e(), l = (u(), C)[o >> 2], d = (u(), C)[o + 4 >> 2], _ = (u(), C)[o + 8 >> 2], v = (u(), C)[o + 12 >> 2], g = [], s = 0; s < 32; s++)
              g.push((u(), N)[o + s + 17]);
        ...
        case 21523: {
          ...
          if (n.tty.ops.ioctl_tiocgwinsz) {
            var m = n.tty.ops.ioctl_tiocgwinsz(n.tty), o = _e();
            (u(), re)[o >> 1] = m[0], (u(), re)[o + 2 >> 1] = m[1];
          }
          return 0;
        }
        case 21524:
  ...
  function at(e, r, t, n) {
    ...
    try {
      ...
      return n = n & -6401, c(!n, `unknown flags in __syscall_newfstatat: ${n}`), r = P.calculateAt(e, r, o), P.writeStat(t, a ? i.lstat(r) : i.stat(r));
    } catch (s) {
  ...
  var lt = (e, r, t) => {
    ...
    r = U(r), z(e, { name: r, fromWireType: function(a) {
      return !!a;
    }, toWireType: function(a, o) {
      return o ? t : n;
    }, readValueFromPointer: function(a) {
      return this.fromWireType((u(), W)[a]);
  ...
  var Dn = { name: "emscripten::val", fromWireType: (e) => {
    ...
    r = U(r), z(e, { name: r, fromWireType: (n) => n, toWireType: (n, a) => {
      if (typeof a != "number" && typeof a != "boolean")
        throw new TypeError(`Cannot convert ${Ne(a)} to ${this.name}`);
      return a;
  ...
  function Un(e, r, t, n) {
    for (var a = _t(e), o = e.length - 2, s = [], l = ["fn"], d = 0; d < o; ++d)
...
${_}`, new Function(g, _);
  ...
  function Bn(e, r, t, n, a, o) {
    var s = r.length;
    s < 2 && $("argTypes array size mismatch! Must at least get return value and 'this' types!");
    for (var l = r[1] !== null && t !== null, d = _t(r), _ = !r[0].isVoid, v = s - 2, g = $n(r), m = r[0], p = r[1], k = [e, $, n, a, Ln, m.fromWireType.bind(m), p?.toWireType.bind(p)], b = 2; b < s; ++b) {
      var I = r[b];
  ...
  var zn = (e, r, t) => {
    if (e[r].overloadTable === void 0) {
      var n = e[r];
      e[r] = function(...a) {
        return e[r].overloadTable.hasOwnProperty(a.length) || $(`Function '${t}' called with an invalid number of arguments (${a.length}) - expects one of (${e[r].overloadTable})!`), e[r].overloadTable[a.length].apply(this, a);
    ...
    var a = n();
    return typeof a != "function" && $(`unknown function pointer with signature ${e}: ${r}`), a;
  };
  ...
  var Xn = (e) => {
    ...
    throw r.forEach(a), new Kn(`${e}: ` + t.map(Xn).join([", "]));
  }, Jn = (e, r, t) => {
    e.forEach((l) => De[l] = r);
    function n(l) {
      var d = t(l);
    ...
    for (let [l, d] of r.entries())
      he.hasOwnProperty(d) ? a[l] = he[d] : (o.push(d), ve.hasOwnProperty(d) || (ve[d] = []), ve[d].push(() => {
        a[l] = he[d], ++s, s === o.length && n(a);
      }));
    o.length === 0 && n(a);
  }, Zn = (e) => {
    e = e.trim();
    ...
    var d = Hn(r, t);
    e = U(e), e = Zn(e), a = qn(n, a, s), jn(e, function() {
      Yn(`Cannot call ${e} due to unbound types`, d);
    }, r - 1), Jn([], d, (_) => {
      var v = [_[0], null].concat(_.slice(1));
      return Gn(e, Bn(e, v, null, a, o, s), r - 1), [];
    });
  }, ei = (e, r, t, n, a) => {
    r = U(r);
    const o = n === 0;
    ...
    function o(s) {
      ...
      return new a((u(), N).buffer, d, l);
    }
    t = U(t), z(e, { name: t, fromWireType: o, readValueFromPointer: o }, { ignoreDuplicateRegistrations: !0 });
  }, q = (e, r, t) => (c(typeof t == "number", "stringToUTF8(str, outPtr, maxBytesToWrite) is missing the third parameter that specifies the length of the output buffer!"), Xr(e, (u(), W), r, t)), ti = (e, r) => {
    r = U(r), z(e, { name: r, fromWireType(t) {
      var n = (u(), h)[t >> 2], a = t + 4, o;
      return o = V(a, n, !0), K(t), o;
    }, toWireType(t, n) {
      n instanceof ArrayBuffer && (n = new Uint8Array(n));
      var a, o = typeof n == "string";
      o || ArrayBuffer.isView(n) && n.BYTES_PER_ELEMENT == 1 || $("Cannot pass non-string to std::string"), o ? a = ae(n) : a = n.length;
      var s = $e(4 + a + 1), l = s + 4;
      return (u(), h)[s >> 2] = a, o ? q(n, l, a + 1) : (u(), W).set(n, l), t !== null && t.push(K, s), s;
    ...
    var n = e >> 1, a = Gr((u(), be), n, r / 2, t);
    if (a - n > 16 && vt) return vt.decode((u(), be).slice(n, a));
    for (var o = "", s = n; s < a; ++s) {
      var l = (u(), be)[s];
    ...
    for (var n = r, a = n + t - 4, o = 0; o < e.length; ++o) {
      ...
      if (s > 65535 && o++, (u(), C)[r >> 2] = s, r += 4, r + 4 > a) break;
    }
    ...
    t = U(t);
    var n, a, o;
    r === 2 ? (n = ni, a = ii, o = ai) : (c(r === 4, "only 2-byte and 4-byte strings are currently supported"), n = oi, a = si, o = li), z(e, { name: t, fromWireType: (s) => {
      var l = (u(), h)[s >> 2], d = n(s + 4, l * r, !0);
      return K(s), d;
    }, toWireType: (s, l) => {
      typeof l != "string" && $(`Cannot pass non-string to C++ string type ${t}`);
      var d = o(l), _ = $e(4 + d + r);
      return (u(), h)[_ >> 2] = d / r, a(l, _ + 4, d + r), s !== null && s.push(K, _), _;
    ...
    mr(e, !Y, 1, !Ae, 65536, !1), S.threadInitTLS();
  }, ht = (e) => {
    ...
    for (var o = a >> 3, s = 0; s < n; s++)
      (u(), M)[o + 2 * s] ? xe[s] = (u(), M)[o + 2 * s + 1] : xe[s] = (u(), Se)[o + 2 * s + 1];
    var l = r ? fr[r] : qi[e];
  ...
  function gt(e, r, t, n, a, o, s) {
    if (y) return D(10, 0, 1, e, r, t, n, a, o, s);
    a = cr(a);
    try {
      c(!isNaN(a));
      var l = P.getStreamFromFD(n), d = i.mmap(l, e, a, r, t), _ = d.ptr;
      return (u(), C)[o >> 2] = d.allocated, (u(), h)[s >> 2] = _, 0;
    } catch (v) {
  ...
  function yt(e, r, t, n, a, o) {
    if (y) return D(11, 0, 1, e, r, t, n, a, o);
    o = cr(o);
    try {
      var s = P.getStreamFromFD(a);
      t & 2 && P.doMsync(e, s, r, n, o);
    } catch (l) {
      if (typeof i > "u" || l.name !== "ErrnoError") throw l;
      return -l.errno;
    }
  ...
  var yi = (e, r, t, n) => {
    var a = (/* @__PURE__ */ new Date()).getFullYear(), o = new Date(a, 0, 1), s = new Date(a, 6, 1), l = o.getTimezoneOffset(), d = s.getTimezoneOffset(), _ = Math.max(l, d);
    (u(), h)[e >> 2] = _ * 60, (u(), C)[r >> 2] = +(l != d);
    var v = (p) => {
      var k = p >= 0 ? "-" : "+", b = Math.abs(p), I = String(Math.floor(b / 60)).padStart(2, "0"), x = String(b % 60).padStart(2, "0");
      return `UTC${k}${I}${x}`;
    }, g = v(l), m = v(d);
    c(g), c(m), c(ae(g) <= 16, `timezone name truncated to fit in TZNAME_MAX (${g})`), c(ae(m) <= 16, `timezone name truncated to fit in TZNAME_MAX (${m})`), d < l ? (q(g, t, 17), q(m, n, 17)) : (q(g, n, 17), q(m, t, 17));
  ...
  var Le = [], Si = (e, r) => {
    ...
    for (var t; t = (u(), W)[e++]; ) {
      ...
      var o = t != 105;
      o &= t != 112, r += o && r % 8 ? 4 : 0, Le.push(t == 112 ? (u(), h)[r >> 2] : t == 106 ? (u(), M)[r >> 3] : t == 105 ? (u(), C)[r >> 2] : (u(), Se)[r >> 3]), r += o ? 8 : 4;
    }
    return Le;
  }, ki = (e, r, t) => {
    var n = Si(r, t);
    ...
    throw wt(), "unwind";
  }, bt = () => 2147483648, Ci = () => bt(), Ii = () => navigator.hardwareConcurrency, oe = {}, St = (e) => {
    var r = ae(e) + 1, t = $e(r);
    return t && q(e, t, r), t;
  }, We = (e) => {
    var r;
    ...
    var e = Tt().split(`
`);
    return e[0] == "Error" && e.shift(), kt(e), oe.last_addr = We(e[3]), oe.last_stack = e, oe.last_addr;
  }, Ue = (e) => {
    var r = oe[e];
    if (!r) return 0;
    var t, n;
    ...
    for (var n = 1; n <= 4; n *= 2) {
      ...
      var o = Math.min(t, Yr(Math.max(e, a), 65536)), s = Ri(o);
      if (s)
        return !0;
    }
    ...
    var n;
    oe.last_addr == e ? n = oe.last_stack : (n = Tt().split(`
`), n[0] == "Error" && n.shift(), kt(n));
    for (var a = 3; n[a] && We(n[a]) != e; )
      ++a;
    for (var o = 0; o < t && n[o + a]; ++o)
      (u(), C)[r + o * 4 >> 2] = We(n[o + a]);
    return o;
  ...
  function Ct(e, r, t, n) {
    ...
    try {
      var a = P.getStreamFromFD(e), o = xi(a, r, t);
      return (u(), h)[n >> 2] = o, 0;
    } catch (s) {
      if (typeof i > "u" || s.name !== "ErrnoError") throw s;
      return s.errno;
  ...
  function It(e, r, t, n) {
    ...
    try {
      ...
      var a = P.getStreamFromFD(e);
      return i.llseek(a, r, t), (u(), M)[n >> 3] = BigInt(a.position), a.getdents && r === 0 && t === 0 && (a.getdents = null), 0;
    } catch (o) {
      if (typeof i > "u" || o.name !== "ErrnoError") throw o;
      return o.errno;
    }
  ...
  function Mt(e, r, t, n) {
    ...
    try {
      var a = P.getStreamFromFD(e), o = Li(a, r, t);
      return (u(), h)[n >> 2] = o, 0;
    } catch (s) {
      if (typeof i > "u" || s.name !== "ErrnoError") throw s;
      return s.errno;
  ...
  function Wi(e, r) {
    try {
      return ir((u(), W).subarray(e, e + r)), 0;
    } catch (t) {
      if (typeof i > "u" || t.name !== "ErrnoError") throw t;
      return t.errno;
    }
  ...
  var Ui = () => {
    ...
    for (let [a, o] of Object.entries(e))
      if (typeof o == "function") {
        r.test(a) && (j.asyncExports.add(o), o = j.makeAsyncFunction(o));
        var n = j.instrumentFunction(o);
        t[a] = n;
      } else
        t[a] = o;
    return t;
    ...
    var o = { string: (b) => {
      var I = 0;
      return b != null && b !== 0 && (I = zi(b)), I;
    }, array: (b) => {
      var I = Qe(b.length);
      return Bi(b, I), I;
    } };
    function s(b) {
      return r === "string" ? V(b) : r === "boolean" ? !!b : b;
    }
    var l = $i(e), d = [], _ = 0;
  ...
  }, ji = (e, r, t, n) => (...a) => Rt(e, r, t, a, n), Hi = (...e) => St(...e);
  S.init(), i.createPreloadedFile = Fn, i.preloadFile = et, i.staticInit(), c(G.length === 10);
  {
  ...
  Gi.forEach(Sr);
  var qi = [er, Br, qr, rt, tt, nt, it, at, ot, st, gt, yt, Ft, At, Pt, Ct, It, Mt];
  function Ki() {
    Yt("fetchSettings");
  }
  var fr = { 540932: () => typeof wasmOffsetConverter < "u" };
  function Dt() {
  ...
  function Zi() {
    ...
    try {
      ...
      for (var n of ["stdout", "stderr"]) {
        ...
        if (!a) return;
        var o = a.object, s = o.rdev, l = Q.ttys[s];
        l?.output?.length && (t = !0);
      }
    } catch {
    }
...
var ea = globalThis.self?.name?.startsWith("em-pthread");
ea && Qi();
export {
  Qi as default
};
//# sourceMappingURL=cp_sat_runtime-BP7bCRR_.js.map
