async function eo(ze = {}) {
    ...
    async function e(r) {
      try {
        ...
        if (n === "load") {
          ...
          c(t.pthread_ptr), fn(t.pthread_ptr), mr(t.pthread_ptr, 0, 0, 1, 0, 0), w.threadInitTLS(), dr(t.pthread_ptr), Ye || (Wt(), Ye = !0);
          try {
        ...
        } else t.target === "setimmediate" || (n === "checkMailbox" ? Ye && We() : n && (b(`worker: received unknown command ${n}`), b(t)));
      } catch (o) {
        throw b(`worker: onmessage() captured an uncaught exception: ${o}`), o?.stack && b(o.stack), Ut(), o;
      }
    }
    self.onmessage = e;
  }
  ...
  var Je;
  function on() {
    return f.locateFile ? Yt("cp_sat_runtime.wasm") : new URL("/assets/cp_sat_runtime-BHpFAoJD.wasm", import.meta.url).href;
  }
  function an(e) {
    if (e == Je && Ee)
  ...
  }, ue = 0, Re = () => nr || ue > 0, $r = () => pr(), Ze = (e) => Vt(e), Qe = (e) => Gt(e), D = (e, r, t, ...n) => {
  ...
  function er(e) {
    ...
    le = e, Re() || (w.terminateAllThreads(), f.onExit?.(e), se = !0), Er(e, new Mr(e));
  }
  function Br(e) {
  ...
  var cn = (e, r) => {
    ...
    er(e);
  }, rr = cn, oe = (e) => (c(typeof e == "number", `ptrToString expects a number, got ${typeof e}`), e >>>= 0, "0x" + e.toString(16).padStart(8, "0")), w = { unusedWorkers: [], runningWorkers: [], tlsInitFunctions: [], pthreads: {}, nextWorkerID: 1, init() {
    y || w.initMainThread();
  }, initMainThread() {
    ...
    var r = e.pthread_ptr;
    delete w.pthreads[r], w.unusedWorkers.push(e), w.runningWorkers.splice(w.runningWorkers.indexOf(e), 1), e.pthread_ptr = 0, Bt(r);
  }, threadInitTLS() {
    ...
    e.onmessage = (a) => {
      ...
      l === "checkMailbox" ? We() : l === "spawnThread" ? Ur(s) : l === "cleanupThread" ? pt(() => Dr(s.thread)) : l === "loaded" ? (e.loaded = !0, r(e)) : s.target === "setimmediate" ? e.postMessage(s) : l === "callHandler" ? f[s.handler](...s.args) : l && b(`worker sent an unknown command ${l}`);
    }, e.onerror = (a) => {
      var s = "worker sent an error!";
      throw e.pthread_ptr && (s = `Pthread ${oe(e.pthread_ptr)} sent an error!`), b(`${s} ${a.filename}:${a.lineno}: ${a.message}`), a;
  ...
  Hr.isAsync = !0;
  var nr = !0, _n = (e) => w.tlsInitFunctions.push(e), Z = (e) => {
...
${_}`, new Function(g, _);
  ...
  function zn(e, r, t, n, o, a) {
    ...
    for (var l = r[1] !== null && t !== null, d = _t(r), _ = !r[0].isVoid, v = s - 2, g = Bn(r), m = r[0], p = r[1], k = [e, $, n, o, Ln, m.fromWireType.bind(m), p?.toWireType.bind(p)], S = 2; S < s; ++S) {
      var I = r[S];
  ...
  var Yn = (e) => {
    ...
    mr(e, !Y, 1, !Pe, 65536, !1), w.threadInitTLS();
  }, ht = (e) => {
  ...
  }, Tt = () => new Error().stack.toString(), Ri = () => {
    var e = Tt().split(`
`);
...
`), n[0] == "Error" && n.shift(), kt(n));
  ...
  var $i = () => {
    ...
    var a = { string: (S) => {
      var I = 0;
      return S != null && S !== 0 && (I = ji(S)), I;
    }, array: (S) => {
      var I = Qe(S.length);
      return zi(S, I), I;
    } };
    function s(S) {
      return r === "string" ? G(S) : r === "boolean" ? !!S : S;
    }
    var l = Bi(e), d = [], _ = 0;
  ...
  }, Hi = (e, r, t, n) => (...o) => Rt(e, r, t, o, n), Vi = (...e) => St(...e);
  w.init(), i.createPreloadedFile = An, i.preloadFile = et, i.staticInit(), c(q.length === 10);
  {
  ...
  f.ccall = Rt, f.cwrap = Hi, f.UTF8ToString = G, f.stringToUTF8 = j, f.allocateUTF8 = Vi;
...
ro && eo();
//# sourceMappingURL=cp_sat_runtime-_NcTm2B3.js.map
