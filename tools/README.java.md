...
Here are some ways to compile and run `examples/BasicExample/BasicExample.java`.
...
*   To build the same example with Maven, open the folder in the command prompt
