...
output_file = output_file.replace(
    "examples/python", "examples/notebook/examples"
)
# For example/contrib/foo.py -> example/notebook/contrib/foo.ipynb
output_file = output_file.replace(
    "examples/contrib", "examples/notebook/contrib"
)
...
COLAB_PATH = (
    "https://colab.research.google.com/github/google/or-tools/blob/main/"
    + output_file
)
