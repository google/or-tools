...
//
//
//  A simple program to solve exactly the job-shop problem.
//
//  We use the disjunctive model and specialized IntervalVars and SequenceVars.
//  This is also the first real example where we Compose() two DecisionBuilders.
...
"This program solves exactly the job-shop problem"
"in JSSP or Taillard's format.\n";
