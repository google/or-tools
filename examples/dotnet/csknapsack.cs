  ...
  static void Main() {
    KnapsackSolver solver =
        new KnapsackSolver(KnapsackSolver.SolverType
                           ...
                           "test");
    long[] profits = {360, 83,  59,  130, 431, 67,  230, 52,  93,  125,
    ...
    long[, ] weights = {{7,  0,  30, 22, 80, 94, 11, 81, 70, 64, 59, 18, 0,
    ...
    Console.WriteLine("Optimal Profit = " + computedProfit +
                      ", expected = " + optimalProfit);
  }
}
