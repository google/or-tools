...
fz_archive: fz
	...
	cd temp && ..$Stools$Szip.exe -r ..$SGoogle.OrTools.flatzinc.$(INSTALL_PORT)-$(OR_TOOLS_VERSION).zip $(INSTALL_DIR)
	-$(DELREC) temp
else
fz_archive: $(LIB_DIR)$S$(LIB_PREFIX)ortools.$(LIB_SUFFIX)
	...
	cd temp && tar cvzf ..$SGoogle.OrTools.flatzinc.$(INSTALL_PORT)-$(OR_TOOLS_VERSION).tar.gz $(INSTALL_DIR)
	-$(DELREC) temp
endif
