...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/RabbitsPheasants.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/RabbitsPheasants.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SRabbitsPheasants.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/GolombRuler.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/GolombRuler.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SGolombRuler.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/Partition.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/Partition.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)$Scom$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SPartition.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/SendMoreMoney.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/SendMoreMoney.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SSendMoreMoney.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/SendMoreMoney2.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/SendMoreMoney2.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SSendMoreMoney2.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/LeastDiff.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/LeastDiff.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SLeastDiff.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/MagicSquare.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/MagicSquare.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SMagicSquare.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/NQueens.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/NQueens.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SNQueens.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/NQueens2.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/NQueens2.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SNQueens2.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/AllDifferentExcept0.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/AllDifferentExcept0.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SAllDifferentExcept0.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/Diet.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/Diet.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SDiet.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/Map.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/Map.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SMap.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/Map2.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/Map2.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SMap2.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/Minesweeper.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/Minesweeper.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SMinesweeper.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/QuasigroupCompletion.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/QuasigroupCompletion.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SQuasigroupCompletion.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/SendMostMoney.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/SendMostMoney.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SSendMostMoney.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/Seseman.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/Seseman.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SSeseman.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/Sudoku.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/Sudoku.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SSudoku.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/Xkcd.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/Xkcd.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SXkcd.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/SurvoPuzzle.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/SurvoPuzzle.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SSurvoPuzzle.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/Circuit.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/Circuit.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SCircuit.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/CoinsGrid.class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/CoinsGrid.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$SCoinsGrid.java
...
$(OBJ_DIR)/com/google/ortools/knapsacksolver/samples/Knapsack.class: javaalgorithms $(SRC_DIR)com/google/ortools/knapsacksolver/samples/Knapsack.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.knapsacksolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sknapsacksolver$Ssamples$SKnapsack.java
...
$(OBJ_DIR)/com/google/ortools/graph/samples/FlowExample.class: javagraph $(SRC_DIR)com/google/ortools/graph/samples/FlowExample.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.graph.jar $(SRC_DIR)com$Sgoogle$Sortools$Sgraph$Ssamples$SFlowExample.java
...
$(OBJ_DIR)/com/google/ortools/graph/samples/LinearAssignmentAPI.class: javagraph $(SRC_DIR)com/google/ortools/graph/samples/LinearAssignmentAPI.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.graph.jar $(SRC_DIR)com$Sgoogle$Sortools$Sgraph$Ssamples$SLinearAssignmentAPI.java
...
$(OBJ_DIR)/com/google/ortools/linearsolver/samples/LinearProgramming.class: javalp $(SRC_DIR)com/google/ortools/linearsolver/samples/LinearProgramming.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.linearsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Slinearsolver$Ssamples$SLinearProgramming.java
...
$(OBJ_DIR)/com/google/ortools/linearsolver/samples/IntegerProgramming.class: javalp $(SRC_DIR)com/google/ortools/linearsolver/samples/IntegerProgramming.java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.linearsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Slinearsolver$Ssamples$SIntegerProgramming.java
...
$(OBJ_DIR)/com/google/ortools/constraintsolver/samples/$(EX).class: javacp $(SRC_DIR)com/google/ortools/constraintsolver/samples/$(EX).java
	$(JAVAC_BIN) -d $(OBJ_DIR) -cp $(LIB_DIR)$Scom.google.ortools.constraintsolver.jar $(SRC_DIR)com$Sgoogle$Sortools$Sconstraintsolver$Ssamples$S$(EX).java
