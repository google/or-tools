...
Makefile.local: makefiles/Makefile.third_party.$(SYSTEM).mk
	...
	@echo "#     make GMP=false READLINE=false TPI=none ZIMPL=false install INSTALLDIR=<path>/scipoptsuite-6.0.2" >> Makefile.local
	@echo "#   On Linux, compile scip with: " >> Makefile.local
	@echo "#      make GMP=false READLINE=false ZIMPL=false TPI=none USRCFLAGS=-fPIC USRCXXFLAGS=-fPIC USRCPPFLAGS=-fPIC install INSTALLDIR=<path>/scipoptsuite-6.0.2" >> Makefile.local
	@echo >> Makefile.local
