...
$(GEN_DIR)/ortools/util/optional_boolean.pb.cc: \
	...
	$(PROTOBUF_DIR)/bin/protoc --proto_path=$(INC_DIR) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/util/optional_boolean.proto
...
$(GEN_DIR)/ortools/data/rcpsp.pb.cc: \
	...
	$(PROTOBUF_DIR)/bin/protoc --proto_path=$(INC_DIR) --cpp_out=$(GEN_DIR) $(SRC_DIR)/ortools/data/rcpsp.proto
