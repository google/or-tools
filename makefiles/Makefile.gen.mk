BASE_DEPS= \
    ...
    $(SRC_DIR)/base/swig/python-swig.cc \
...
$(OBJ_DIR)/lp_data/mps_to_png.$O: \
	...
	$(CCC) $(CFLAGS) -c $(SRC_DIR)/lp_data/mps_to_png.cc $(OBJ_OUT)$(OBJ_DIR)$Slp_data$Smps_to_png.$O
...
$(OBJ_DIR)/lp_data/png_dump.$O: \
	...
	$(CCC) $(CFLAGS) -c $(SRC_DIR)/lp_data/png_dump.cc $(OBJ_OUT)$(OBJ_DIR)$Slp_data$Spng_dump.$O
...
$(OBJ_DIR)/glop/proto_driver.$O: \
    $(SRC_DIR)/glop/lp_solver.h \
    $(SRC_DIR)/util/gzip/gzipstring.h \
    $(SRC_DIR)/util/fp_utils.h \
    $(SRC_DIR)/util/stats.h \
    $(SRC_DIR)/base/commandlineflags.h \
    $(SRC_DIR)/base/commandlineflags.h \
	...
	$(CCC) $(CFLAGS) -c $(SRC_DIR)/glop/proto_driver.cc $(OBJ_OUT)$(OBJ_DIR)$Sglop$Sproto_driver.$O
