...
static const yytype_int16 yyrline[] = {
    ...
    139, 140, 147, 148, 151, 170, 185, 196, 211, 222, 248, 291, 368, 369, 372,
    373, 374, 377, 381, 387, 388, 389, 392, 397, 412, 433, 434, 435, 436, 443,
    444, 445, 446, 453, 454, 459, 460, 461, 464, 465, 468, 469, 470, 475, 476,
    479, 480, 481, 486, 487, 488, 493, 494, 497, 498, 504, 508, 514, 515, 518,
    530, 531, 534, 535, 536, 537, 538, 543, 569, 586, 634, 643, 647, 650, 651,
    654, 655, 656, 657, 671, 680, 686, 715, 724, 732, 743};
#endif
...
#line 1764 "parser.tab.cc"
    ...
    case 26: /* variable_or_constant_declaration: ARRAY '[' IVALUE DOTDOT IVALUE
                ...
                optional_var_or_value_array  */
#line 292 "ortools/flatzinc/parser.yy"
    {
...
#line 372 "ortools/flatzinc/parser.yy"
    {
...
#line 373 "ortools/flatzinc/parser.yy"
    {
...
#line 377 "ortools/flatzinc/parser.yy"
    {
...
#line 381 "ortools/flatzinc/parser.yy"
    {
...
#line 397 "ortools/flatzinc/parser.yy"
    {
...
#line 435 "ortools/flatzinc/parser.yy"
    {
      (yyval.domain) =
...
#line 436 "ortools/flatzinc/parser.yy"
    {
      CHECK((yyvsp[-1].integers) != nullptr);
...
#line 446 "ortools/flatzinc/parser.yy"
    {
      CHECK((yyvsp[-1].integers) != nullptr);
      (yyval.domain) =
...
#line 464 "ortools/flatzinc/parser.yy"
    {
...
#line 531 "ortools/flatzinc/parser.yy"
    {
...
#line 534 "ortools/flatzinc/parser.yy"
    {
...
#line 536 "ortools/flatzinc/parser.yy"
    {
...
#line 537 "ortools/flatzinc/parser.yy"
    {
...
#line 538 "ortools/flatzinc/parser.yy"
    {
      CHECK((yyvsp[-1].integers) != nullptr);
...
#line 543 "ortools/flatzinc/parser.yy"
    {
      const std::string& id = (yyvsp[0].string_value);
      if (context->integer_map.contains(id)) {
...
#line 569 "ortools/flatzinc/parser.yy"
    {
      const std::string& id = (yyvsp[-3].string_value);
...
#line 643 "ortools/flatzinc/parser.yy"
    {
...
#line 647 "ortools/flatzinc/parser.yy"
    {
...
#line 654 "ortools/flatzinc/parser.yy"
    {
...
#line 656 "ortools/flatzinc/parser.yy"
    {
...
#line 2481 "parser.tab.cc"
    ...
    case 97: /* annotation: '[' ']'  */
#line 715 "ortools/flatzinc/parser.yy"
    {
      (yyval.annotation) = Annotation::Empty();
    }
...
#line 724 "ortools/flatzinc/parser.yy"
    {
...
#line 732 "ortools/flatzinc/parser.yy"
    {
...
#line 743 "ortools/flatzinc/parser.yy"
    {
      Variable* obj_var = (yyvsp[0].arg).type == Argument::VAR_REF
                              ? (yyvsp[0].arg).Var()
                              : model->AddConstant((yyvsp[0].arg).Value());
...
#line 755 "ortools/flatzinc/parser.yy"
