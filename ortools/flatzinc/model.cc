...
int NumRequiredArguments(absl::string_view type) {
  static const auto* const kMinArgs =
      ...
      {"array_bool_xor", 1},
      {"array_int_element", 3},
      {"array_int_element_nonshifted", 3},
      {"array_int_maximum", 2},
      {"array_int_minimum", 2},
      {"array_set_element", 3},
      {"array_var_bool_element", 3},
      {"array_var_int_element", 3},
      {"array_var_set_element", 3},
      {"at_most_int", 3},
      {"bool2int", 2},
      {"bool_and", 3},
      {"bool_clause", 2},
      ...
      {"fzn_all_different_set", 1},
      {"fzn_all_disjoint", 1},
      {"fzn_cumulative", 4},
      {"fzn_diffn", 4},
      {"fzn_diffn_nonstrict", 4},
      {"fzn_disjoint", 2},
      {"fzn_disjunctive", 2},
      {"fzn_disjunctive_strict", 2},
      {"fzn_partition_set", 2},
      {"fzn_value_precede_int", 3},
      {"int_abs", 2},
      {"int_div", 3},
      {"int_eq", 2},
      {"int_eq_imp", 3},
      ...
      {"minimum_arg_int", 2},
      {"minimum_int", 2},
      {"ortools_arg_max_bool", 4},
      {"ortools_arg_max_int", 4},
      {"ortools_array_bool_element", 4},
      {"ortools_array_int_element", 4},
      {"ortools_array_var_bool_element", 4},
      {"ortools_array_var_int_element", 4},
      {"ortools_bin_packing", 3},
      {"ortools_bin_packing_capa", 4},
      {"ortools_bin_packing_load", 4},
      {"ortools_circuit", 2},
      {"ortools_count_eq", 3},
      {"ortools_count_eq_cst", 3},
      {"ortools_cumulative_opt", 5},
      {"ortools_disjunctive_strict_opt", 3},
      {"ortools_global_cardinality", 4},
      {"ortools_global_cardinality_low_up", 5},
      {"ortools_inverse", 4},
      {"ortools_lex_less_bool", 2},
      {"ortools_lex_less_int", 2},
      {"ortools_lex_lesseq_bool", 2},
      {"ortools_lex_lesseq_int", 2},
      {"ortools_network_flow", 6},
      {"ortools_network_flow_cost", 6},
      {"ortools_nvalue", 2},
      {"ortools_precede_chain_int", 2},
      {"ortools_regular", 6},
      {"ortools_subcircuit", 2},
      {"ortools_table_bool", 2},
      {"ortools_table_int", 2},
      {"set_card", 2},
      {"set_diff", 3},
      {"set_eq", 2},
      ...
      {"var_cumulative", 4},
      {"variable_cumulative", 4},
      });
  const auto it = kMinArgs->find(type);
  return it == kMinArgs->end() ? 0 : it->second;
}
