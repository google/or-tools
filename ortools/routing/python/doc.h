...
static const char*
    __doc_operations_research_DisjunctivePropagator_DetectablePrecedencesWithChain =  // NOLINT
...
static const char*
    __doc_operations_research_DisjunctivePropagator_nonchain_tasks_by_start_max =  // NOLINT
    R"doc()doc";
...
static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_FillPartialPathOfVehicle =  // NOLINT
...
static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_GlobalVehicleBreaksConstraint =  // NOLINT
    R"doc()doc";
...
static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_TaskTranslator_SetDurationMin =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_TaskTranslator_SetEndMax =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_TaskTranslator_SetEndMin =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_TaskTranslator_SetStartMax =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_TaskTranslator_SetStartMin =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_TaskTranslator_TaskTranslator =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_TaskTranslator_TaskTranslator_2 =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_TaskTranslator_TaskTranslator_3 =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_TaskTranslator_after_start =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_TaskTranslator_before_start =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_TaskTranslator_interval =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_TaskTranslator_start =  // NOLINT
    R"doc()doc";
...
static const char*
    __doc_operations_research_GlobalVehicleBreaksConstraint_disjunctive_propagator =  // NOLINT
...
static const char* __doc_operations_research_Dimension =
    R"doc(for a given vehicle, it is passed as an external vector, it would be
better to have this information here.)doc";

static const char* __doc_operations_research_Dimension_2 =
    R"doc(for a given vehicle, it is passed as an external vector, it would be
better to have this information here.)doc";

static const char* __doc_operations_research_Dimension_AddNodePrecedence =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_AddNodePrecedence_2 =
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_AllTransitEvaluatorSignsAreUnknown =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_AreVehicleTransitsPositive =
        R"doc(Returns true iff the transit evaluator of 'vehicle' is positive 
for all arcs.)doc";

static const char* __doc_operations_research_Dimension_CloseModel =
    R"doc(Finalize the model of the dimension.)doc";

static const char* __doc_operations_research_Dimension_CumulVar =
    R"doc(Get the cumul, transit and slack variables for the given node (given
as int64_t var index).)doc";

static const char* __doc_operations_research_Dimension_FixedTransitVar =
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_GetAllowedIntervalsInRange =
        R"doc(Returns allowed intervals for a given node in a given 
interval.)doc";

static const char*
    __doc_operations_research_Dimension_GetBinaryTransitEvaluator = R"doc()doc";

static const char*
    __doc_operations_research_Dimension_GetBreakDistanceDurationOfVehicle =  // NOLINT
    R"doc(Returns the pairs (distance, duration) specified by break distance
constraints.)doc";

static const char*
    __doc_operations_research_Dimension_GetBreakIntervalsOfVehicle =
        R"doc(Returns the break intervals set by 
SetBreakIntervalsOfVehicle().)doc";

static const char* __doc_operations_research_Dimension_GetCumulVarMax =
    R"doc(Gets the current maximum of the cumul variable associated to 
index.)doc";

static const char* __doc_operations_research_Dimension_GetCumulVarMin =
    R"doc(Gets the current minimum of the cumul variable associated to 
index.)doc";

static const char*
    __doc_operations_research_Dimension_GetCumulVarPiecewiseLinearCost =
...
static const char*
    __doc_operations_research_Dimension_GetCumulVarSoftLowerBound =
...
static const char*
    __doc_operations_research_Dimension_GetCumulVarSoftLowerBoundCoefficient =  // NOLINT
...
static const char*
    __doc_operations_research_Dimension_GetCumulVarSoftUpperBound =  // NOLINT
...
static const char*
    __doc_operations_research_Dimension_GetCumulVarSoftUpperBoundCoefficient =  // NOLINT
...
static const char*
    __doc_operations_research_Dimension_GetFirstPossibleGreaterOrEqualValueForNode =  // NOLINT
...
static const char*
    __doc_operations_research_Dimension_GetGlobalOptimizerOffset = R"doc()doc";

static const char*
    __doc_operations_research_Dimension_GetLastPossibleLessOrEqualValueForNode =  // NOLINT
...
static const char*
    __doc_operations_research_Dimension_GetLocalOptimizerOffsetForVehicle =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Dimension_GetNodePrecedences =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_GetPathPrecedenceGraph =
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_GetPickupToDeliveryLimitForPair =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_GetPostTravelEvaluatorOfVehicle =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_GetPreTravelEvaluatorOfVehicle =
        R"doc(!defined(SWIGPYTHON))doc";

static const char*
    __doc_operations_research_Dimension_GetQuadraticCostSoftSpanUpperBoundForVehicle =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_GetSlackCostCoefficientForVehicle =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_GetSlackCostCoefficientForVehicleClass =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_GetSoftSpanUpperBoundForVehicle =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_GetSpanCostCoefficientForVehicle =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_GetSpanCostCoefficientForVehicleClass =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_GetSpanUpperBoundForVehicle =
        R"doc()doc";

static const char* __doc_operations_research_Dimension_GetTransitEvaluatorSign =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_GetTransitValue =
...
static const char*
    __doc_operations_research_Dimension_GetTransitValueFromClass =
...
static const char*
    __doc_operations_research_Dimension_GetUnaryTransitEvaluator =
...
static const char*
    __doc_operations_research_Dimension_HasBreakConstraints =  // NOLINT
    R"doc(Returns true if any break interval or break distance was 
defined.)doc";

static const char*
    __doc_operations_research_Dimension_HasCumulVarPiecewiseLinearCost =
        R"doc(Returns true if a piecewise linear cost has been set for a given
variable index.)doc";

static const char*
    __doc_operations_research_Dimension_HasCumulVarSoftLowerBound =
        R"doc(Returns true if a soft lower bound has been set for a given 
variable index.)doc";

static const char*
    __doc_operations_research_Dimension_HasCumulVarSoftUpperBound =
        R"doc(Returns true if a soft upper bound has been set for a given 
variable index.)doc";

static const char*
    __doc_operations_research_Dimension_HasPickupToDeliveryLimits = R"doc()doc";

static const char*
    __doc_operations_research_Dimension_HasQuadraticCostSoftSpanUpperBounds =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Dimension_HasSoftSpanUpperBounds =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_Initialize = R"doc()doc";

static const char* __doc_operations_research_Dimension_InitializeBreaks =
...
static const char* __doc_operations_research_Dimension_InitializeCumuls =
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_InitializeTransitVariables =
        R"doc()doc";

static const char* __doc_operations_research_Dimension_InitializeTransits =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_IsUnary =
    R"doc(Returns true iff all transit evaluators for this dimension are 
unary.)doc";

static const char* __doc_operations_research_Dimension_NodePrecedence =
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_NodePrecedence_first_node = R"doc()doc";

static const char* __doc_operations_research_Dimension_NodePrecedence_offset =
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_NodePrecedence_second_node =
        R"doc()doc";

static const char* __doc_operations_research_Dimension_PiecewiseLinearCost =
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_PiecewiseLinearCost_PiecewiseLinearCost =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_PiecewiseLinearCost_cost = R"doc()doc";

static const char* __doc_operations_research_Dimension_PiecewiseLinearCost_var =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_Dimension = R"doc()doc";

static const char* __doc_operations_research_Dimension_Dimension_2 =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_Dimension_3 =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_SelfBased = R"doc()doc";

static const char*
    __doc_operations_research_Dimension_SetBreakDistanceDurationOfVehicle =  // NOLINT
...
static const char*
    __doc_operations_research_Dimension_SetBreakIntervalsOfVehicle =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_SetBreakIntervalsOfVehicle_2 =
        R"doc(Deprecated, sets pre_travel(i, j) = node_visit_transit[i].)doc";

static const char*
    __doc_operations_research_Dimension_SetBreakIntervalsOfVehicle_3 =
        R"doc(Deprecated, sets pre_travel(i, j) = node_visit_transit[i] and
post_travel(i, j) = delays(i, j).)doc";

static const char*
    __doc_operations_research_Dimension_SetCumulVarPiecewiseLinearCost =
...
static const char* __doc_operations_research_Dimension_SetCumulVarRange =
    R"doc(Restricts the range of the cumul variable associated to index.)doc";

static const char*
    __doc_operations_research_Dimension_SetCumulVarSoftLowerBound =
...
static const char*
    __doc_operations_research_Dimension_SetCumulVarSoftUpperBound =
...
static const char*
    __doc_operations_research_Dimension_SetGlobalSpanCostCoefficient =
...
static const char*
    __doc_operations_research_Dimension_SetOffsetForGlobalOptimizer =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_SetPickupToDeliveryLimitFunctionForPair =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_SetQuadraticCostSoftSpanUpperBoundForVehicle =  // NOLINT
    R"doc(If the span of vehicle on this dimension is larger than bound, the
cost will be increased by cost * (span - bound)^2.)doc";

static const char*
    __doc_operations_research_Dimension_SetSlackCostCoefficientForAllVehicles =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_SetSlackCostCoefficientForVehicle =  // NOLINT
...
static const char*
    __doc_operations_research_Dimension_SetSoftSpanUpperBoundForVehicle =  // NOLINT
    R"doc(If the span of vehicle on this dimension is larger than bound, the
cost will be increased by cost * (span - bound).)doc";

static const char*
    __doc_operations_research_Dimension_SetSpanCostCoefficientForAllVehicles =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_SetSpanCostCoefficientForVehicle =  // NOLINT
...
static const char*
    __doc_operations_research_Dimension_SetSpanUpperBoundForVehicle =
...
static const char*
    __doc_operations_research_Dimension_SetVehicleOffsetsForLocalOptimizer =  // NOLINT
    R"doc(Moves elements of "offsets" into 
vehicle_offsets_for_local_optimizer_.)doc";

static const char*
    __doc_operations_research_Dimension_SetupCumulVarPiecewiseLinearCosts =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_SetupCumulVarSoftLowerBoundCosts =
        R"doc(Sets up the cost variables related to cumul soft lower 
bounds.)doc";

static const char*
    __doc_operations_research_Dimension_SetupCumulVarSoftUpperBoundCosts =  // NOLINT
    R"doc(Sets up the cost variables related to cumul soft upper bounds.)doc";

static const char* __doc_operations_research_Dimension_SetupGlobalSpanCost =
...
static const char*
    __doc_operations_research_Dimension_SetupSlackAndDependentTransitCosts =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Dimension_ShortestTransitionSlack =
...
static const char* __doc_operations_research_Dimension_SlackVar = R"doc()doc";

static const char* __doc_operations_research_Dimension_SoftBound = R"doc()doc";

static const char* __doc_operations_research_Dimension_SoftBound_bound =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_SoftBound_coefficient =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_SoftBound_var =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_TransitVar = R"doc()doc";

static const char* __doc_operations_research_Dimension_base_dimension =
    R"doc(Returns the parent in the dependency tree if any or nullptr 
otherwise.)doc";

static const char* __doc_operations_research_Dimension_base_dimension_2 =
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_break_constraints_are_initialized =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Dimension_capacity_vars =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_class_evaluators =
    R"doc(Values in class_evaluators_ correspond to the evaluators in
Model::transit_evaluators_ for each vehicle class.)doc";

static const char* __doc_operations_research_Dimension_class_transit_evaluator =
    R"doc(Returns the callback evaluating the transit value between two node
indices for a given vehicle class.)doc";

static const char*
    __doc_operations_research_Dimension_cumul_var_piecewise_linear_cost =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_cumul_var_soft_lower_bound =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_cumul_var_soft_upper_bound =
        R"doc()doc";

static const char* __doc_operations_research_Dimension_cumuls =
    R"doc(Like CumulVar(), TransitVar(), SlackVar() but return the whole
variable vectors instead (indexed by int64_t var index).)doc";

static const char* __doc_operations_research_Dimension_cumuls_2 = R"doc()doc";

static const char* __doc_operations_research_Dimension_dependent_transits =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_fixed_transits =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_fixed_transits_2 =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_forbidden_intervals =
    R"doc(Returns forbidden intervals for each node.)doc";

static const char* __doc_operations_research_Dimension_forbidden_intervals_2 =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_global_optimizer_offset =
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_global_span_cost_coefficient =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_global_span_cost_coefficient_2 =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_local_optimizer_offset_for_vehicle =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Dimension_model =
    R"doc(Returns the model on which the dimension was created.)doc";

static const char* __doc_operations_research_Dimension_model_2 = R"doc()doc";

static const char* __doc_operations_research_Dimension_name =
    R"doc(Returns the name of the dimension.)doc";

static const char* __doc_operations_research_Dimension_name_2 = R"doc()doc";

static const char* __doc_operations_research_Dimension_node_precedences =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_operator_assign =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_path_precedence_graph =
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_pickup_to_delivery_limits_per_pair_index =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Dimension_slacks = R"doc()doc";

static const char* __doc_operations_research_Dimension_slacks_2 = R"doc()doc";

static const char*
    __doc_operations_research_Dimension_state_dependent_class_evaluators =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_state_dependent_vehicle_to_class =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Dimension_transit_evaluator =
    R"doc(Returns the callback evaluating the transit value between two node
indices for a given vehicle.)doc";

static const char* __doc_operations_research_Dimension_transits = R"doc()doc";

static const char* __doc_operations_research_Dimension_transits_2 = R"doc()doc";

static const char*
    __doc_operations_research_Dimension_vehicle_break_distance_duration =
        R"doc()doc";

static const char* __doc_operations_research_Dimension_vehicle_break_intervals =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_vehicle_capacities =
    R"doc(Returns the capacities for all vehicles.)doc";

static const char* __doc_operations_research_Dimension_vehicle_capacities_2 =
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_vehicle_post_travel_evaluators =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_vehicle_pre_travel_evaluators =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_vehicle_quadratic_cost_soft_span_upper_bound =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_vehicle_slack_cost_coefficients =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_vehicle_slack_cost_coefficients_2 =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_vehicle_soft_span_upper_bound =
        R"doc(nullptr if not defined.)doc";

static const char*
    __doc_operations_research_Dimension_vehicle_span_cost_coefficients =
        R"doc()doc";

static const char*
    __doc_operations_research_Dimension_vehicle_span_cost_coefficients_2 =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Dimension_vehicle_span_upper_bounds = R"doc()doc";

static const char*
    __doc_operations_research_Dimension_vehicle_span_upper_bounds_2 =
        R"doc()doc";

static const char* __doc_operations_research_Dimension_vehicle_to_class =
    R"doc()doc";

static const char* __doc_operations_research_Dimension_vehicle_to_class_2 =
    R"doc()doc";

static const char* __doc_operations_research_Model = R"doc()doc";

static const char* __doc_operations_research_ModelVisitor =
    R"doc(Routing model visitor.)doc";

static const char* __doc_operations_research_Model_ActiveVar =
    R"doc(Returns the active variable of the node corresponding to index.)doc";

static const char* __doc_operations_research_Model_ActiveVehicleVar =
...
static const char* __doc_operations_research_Model_AddAtSolutionCallback =
...
static const char* __doc_operations_research_Model_AddConstantDimension =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_AddConstantDimensionWithSlack =
...
static const char* __doc_operations_research_Model_AddDimension =
...
static const char*
    __doc_operations_research_Model_AddDimensionDependentDimensionWithVehicleCapacity =  // NOLINT
...
static const char*
    __doc_operations_research_Model_AddDimensionDependentDimensionWithVehicleCapacity_2 =  // NOLINT
    R"doc(As above, but pure_transits are taken to be zero evaluators.)doc";

static const char*
    __doc_operations_research_Model_AddDimensionDependentDimensionWithVehicleCapacity_3 =  // NOLINT
    R"doc(Homogeneous versions of the functions above.)doc";

static const char*
    __doc_operations_research_Model_AddDimensionDependentDimensionWithVehicleCapacity_4 =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_AddDimensionDependentDimensionWithVehicleCapacityInternal =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_AddDimensionWithCapacityInternal =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_AddDimensionWithVehicleCapacity =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_AddDimensionWithVehicleTransitAndCapacity =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_AddDimensionWithVehicleTransits =
        R"doc()doc";

static const char* __doc_operations_research_Model_AddDisjunction =
...
static const char* __doc_operations_research_Model_AddHardTypeIncompatibility =
...
static const char* __doc_operations_research_Model_AddIntervalToAssignment =
    R"doc()doc";

static const char* __doc_operations_research_Model_AddLocalSearchFilter =
...
static const char* __doc_operations_research_Model_AddLocalSearchOperator =
    R"doc(Adds a local search operator to the set of operators used to solve the
vehicle routing problem.)doc";

static const char* __doc_operations_research_Model_AddMatrixDimension =
    R"doc(Creates a dimension where the transit variable is constrained to be
...
static const char*
    __doc_operations_research_Model_AddNoCycleConstraintInternal = R"doc()doc";

static const char* __doc_operations_research_Model_AddPickupAndDelivery =
...
static const char* __doc_operations_research_Model_AddPickupAndDeliverySets =
...
static const char*
    __doc_operations_research_Model_AddPickupAndDeliverySetsInternal =
        R"doc(Sets up pickup and delivery sets.)doc";

static const char*
    __doc_operations_research_Model_AddRequiredTypeAlternativesWhenAddingType =
...
static const char*
    __doc_operations_research_Model_AddRequiredTypeAlternativesWhenRemovingType =  // NOLINT
...
static const char* __doc_operations_research_Model_AddResourceGroup =
    R"doc(Adds a resource group to the routing model and returns a pointer to
it.)doc";

static const char*
    __doc_operations_research_Model_AddSameVehicleRequiredTypeAlternatives =
...
static const char* __doc_operations_research_Model_AddSearchMonitor =
    R"doc(Adds a search monitor to the search used to solve the routing model.)doc";

static const char*
    __doc_operations_research_Model_AddSoftSameVehicleConstraint =  // NOLINT
...
static const char*
    __doc_operations_research_Model_AddTemporalTypeIncompatibility =
        R"doc()doc";

static const char* __doc_operations_research_Model_AddToAssignment =
    R"doc(Adds an extra variable to the vehicle routing assignment.)doc";

static const char*
    __doc_operations_research_Model_AddVariableMaximizedByFinalizer =
        R"doc(Adds a variable to maximize in the solution finalizer (see above 
for information on the solution finalizer).)doc";

static const char*
    __doc_operations_research_Model_AddVariableMinimizedByFinalizer =
...
static const char*
    __doc_operations_research_Model_AddVariableTargetToFinalizer =  // NOLINT
    R"doc(Add a variable to set the closest possible to the target value in the
solution finalizer.)doc";

static const char* __doc_operations_research_Model_AddVectorDimension =
    R"doc(Creates a dimension where the transit variable is constrained to be
...
static const char*
    __doc_operations_research_Model_AddWeightedVariableMaximizedByFinalizer =
...
static const char*
    __doc_operations_research_Model_AddWeightedVariableMinimizedByFinalizer =
        R"doc(Adds a variable to minimize in the solution finalizer, with a 
weighted priority: the higher the more priority it has.)doc";

static const char*
    __doc_operations_research_Model_AddWeightedVariableTargetToFinalizer =
...
static const char* __doc_operations_research_Model_AppendArcCosts = R"doc()doc";

static const char* __doc_operations_research_Model_AppendAssignmentIfFeasible =
    R"doc(Append an assignment to a vector of assignments if it is 
feasible.)doc";

static const char* __doc_operations_research_Model_AppendHomogeneousArcCosts =
    R"doc()doc";

static const char* __doc_operations_research_Model_ApplyLocks =
...
static const char* __doc_operations_research_Model_ApplyLocksToAllVehicles =
...
static const char* __doc_operations_research_Model_ArcIsMoreConstrainedThanArc =
...
static const char* __doc_operations_research_Model_AreRoutesInterdependent =
    R"doc(Returns true if routes are interdependent. This means that any
modification to a route might impact another.)doc";

static const char* __doc_operations_research_Model_AssignmentToRoutes =
...
static const char* __doc_operations_research_Model_CancelSearch =
    R"doc(Cancels the current search.)doc";

static const char* __doc_operations_research_Model_CheckIfAssignmentIsFeasible =
    R"doc(Checks if an assignment is feasible.)doc";

static const char* __doc_operations_research_Model_CheckLimit =
    R"doc(Returns true if the search limit has been crossed with the given time
offset.)doc";

static const char* __doc_operations_research_Model_CloseModel =
...
static const char* __doc_operations_research_Model_CloseModelWithParameters =
    R"doc(Same as above taking search parameters (as of 10/2015 some the
parameters have to be set when closing the model).)doc";

static const char* __doc_operations_research_Model_CompactAndCheckAssignment =
...
static const char* __doc_operations_research_Model_CompactAssignment =
...
static const char* __doc_operations_research_Model_CompactAssignmentInternal =
    R"doc(See CompactAssignment. Checks the final solution if
check_compact_assignment is true.)doc";

static const char* __doc_operations_research_Model_ComputeCostClasses =
    R"doc()doc";

static const char* __doc_operations_research_Model_ComputeLowerBound =
...
static const char* __doc_operations_research_Model_ComputeResourceClasses =
    R"doc(Computes resource classes for all resource groups in the model.)doc";

static const char* __doc_operations_research_Model_ComputeVehicleClasses =
    R"doc()doc";

static const char* __doc_operations_research_Model_ComputeVehicleTypes =
...
static const char* __doc_operations_research_Model_ConcatenateOperators =
    R"doc()doc";

static const char* __doc_operations_research_Model_CostCacheElement =
...
static const char* __doc_operations_research_Model_CostCacheElement_cost =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_CostCacheElement_cost_class_index =
        R"doc()doc";

static const char* __doc_operations_research_Model_CostCacheElement_index =
...
static const char* __doc_operations_research_Model_CostClass = R"doc()doc";

static const char* __doc_operations_research_Model_CostClass_CostClass =
    R"doc()doc";

static const char* __doc_operations_research_Model_CostClass_DimensionCost =
...
static const char*
    __doc_operations_research_Model_CostClass_DimensionCost_dimension =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_CostClass_DimensionCost_operator_lt =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_CostClass_DimensionCost_slack_cost_coefficient =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_CostClass_DimensionCost_span_cost_coefficient =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_CostClass_DimensionCost_transit_evaluator_class =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_CostClass_dimension_transit_evaluator_class_and_cost_coefficient =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Model_CostClass_evaluator_index =
    R"doc(Index of the arc cost evaluator, registered in the Model class.)doc";

static const char* __doc_operations_research_Model_CostVar =
    R"doc(Returns the global cost variable which is being minimized.)doc";

static const char*
    __doc_operations_research_Model_CostsAreHomogeneousAcrossVehicles =
        R"doc(Whether costs are homogeneous across all vehicles.)doc";

static const char* __doc_operations_research_Model_CreateCPOperator =
    R"doc()doc";

static const char* __doc_operations_research_Model_CreateCPOperator_2 =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_CreateCPOperatorWithNeighbors = R"doc()doc";

static const char*
    __doc_operations_research_Model_CreateCPOperatorWithNeighbors_2 =
        R"doc()doc";

static const char* __doc_operations_research_Model_CreateDisjunction =
    R"doc(Returns nullptr if no penalty cost, otherwise returns penalty
variable.)doc";

static const char*
    __doc_operations_research_Model_CreateFirstSolutionDecisionBuilders =
        R"doc()doc";

static const char* __doc_operations_research_Model_CreateInsertionOperator =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_CreateIntVarFilteredDecisionBuilder =
        R"doc()doc";

static const char* __doc_operations_research_Model_CreateLocalSearchFilters =
    R"doc()doc";

static const char* __doc_operations_research_Model_CreateLocalSearchParameters =
    R"doc()doc";

static const char* __doc_operations_research_Model_CreateMakeInactiveOperator =
    R"doc()doc";

static const char* __doc_operations_research_Model_CreateNeighborhoodOperators =
    R"doc()doc";

static const char* __doc_operations_research_Model_CreateOperator = R"doc()doc";

static const char* __doc_operations_research_Model_CreateOperator_2 =
    R"doc()doc";

static const char* __doc_operations_research_Model_CreateOperatorWithNeighbors =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_CreateOperatorWithNeighborsRatio =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_CreateOperatorWithNeighborsRatio_2 =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_CreateOperatorWithNeighborsRatio_3 =
        R"doc()doc";

static const char* __doc_operations_research_Model_CreatePairOperator =
    R"doc()doc";

static const char* __doc_operations_research_Model_CreatePairOperator_2 =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_CreatePrimaryLocalSearchDecisionBuilder =
        R"doc()doc";

static const char* __doc_operations_research_Model_CreateSameVehicleCost =
    R"doc(Returns the cost variable related to the soft same vehicle constraint
of index 'vehicle_index'.)doc";

static const char* __doc_operations_research_Model_CreateSolutionFinalizer =
    R"doc()doc";

static const char* __doc_operations_research_Model_DebugOutputAssignment =
...
static const char*
    __doc_operations_research_Model_DetectImplicitPickupAndDeliveries =
        R"doc()doc";

static const char* __doc_operations_research_Model_DimensionCumulOptimizers =
    R"doc(Internal struct used to store the lp/mp versions of the local and
global cumul optimizers for a given dimension.)doc";

static const char*
    __doc_operations_research_Model_DimensionCumulOptimizers_lp_optimizer =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_DimensionCumulOptimizers_mp_optimizer =
        R"doc()doc";

static const char* __doc_operations_research_Model_DisjunctionValues =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_DisjunctionValues_max_cardinality =
        R"doc()doc";

static const char* __doc_operations_research_Model_DisjunctionValues_penalty =
    R"doc()doc";

static const char* __doc_operations_research_Model_DoRestoreAssignment =
    R"doc()doc";

static const char* __doc_operations_research_Model_End =
    R"doc(Returns the variable index of the ending node of a vehicle 
route.)doc";

static const char*
    __doc_operations_research_Model_FastSolveFromAssignmentWithParameters =
...
static const char* __doc_operations_research_Model_FilterOptions = R"doc()doc";

static const char*
    __doc_operations_research_Model_FilterOptions_filter_objective =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_FilterOptions_filter_with_cp_solver =
        R"doc()doc";

static const char* __doc_operations_research_Model_FilterOptions_operator_eq =
    R"doc()doc";

static const char* __doc_operations_research_Model_FinalizeAllowedVehicles =
...
static const char* __doc_operations_research_Model_FinalizeVisitTypes =
...
static const char*
    __doc_operations_research_Model_FindErrorInSearchParametersForModel =
        R"doc(Checks that the current search parameters are valid for the current
model's specific settings.)doc";

static const char* __doc_operations_research_Model_FindNextActive =
    R"doc(Returns the first active variable index in 'indices' starting from
index + 1.)doc";

static const char*
    __doc_operations_research_Model_ForEachNodeInDisjunctionWithMaxCardinalityFromIndex =  // NOLINT
...
static const char* __doc_operations_research_Model_GetAllDimensionNames =
    R"doc(Outputs the names of all dimensions added to the routing engine.)doc";

static const char*
    __doc_operations_research_Model_GetAmortizedLinearCostFactorOfVehicles =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_GetAmortizedQuadraticCostFactorOfVehicles =
        R"doc()doc";

static const char* __doc_operations_research_Model_GetArcCostForClass =
...
static const char* __doc_operations_research_Model_GetArcCostForClassInternal =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetArcCostForFirstSolution =
...
static const char* __doc_operations_research_Model_GetArcCostForVehicle =
...
static const char*
    __doc_operations_research_Model_GetAutomaticFirstSolutionStrategy =
        R"doc(Returns the automatic first solution strategy selected.)doc";

static const char* __doc_operations_research_Model_GetBinCapacities =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetCostClassIndexOfVehicle =
    R"doc(Get the cost class index of the given vehicle.)doc";

static const char* __doc_operations_research_Model_GetCostClassesCount =
    R"doc(Returns the number of different cost classes in the model.)doc";

static const char* __doc_operations_research_Model_GetCumulBounds = R"doc()doc";

static const char* __doc_operations_research_Model_GetDeliveryPositions =
    R"doc(Returns the pickup and delivery positions where the node is a
delivery.)doc";

static const char* __doc_operations_research_Model_GetDepot =
...
static const char* __doc_operations_research_Model_GetDimensionIndex =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetDimensionOrDie =
    R"doc(Returns a dimension from its name. Dies if the dimension does not
exist.)doc";

static const char*
    __doc_operations_research_Model_GetDimensionResourceGroupIndex =
...
static const char*
    __doc_operations_research_Model_GetDimensionResourceGroupIndices =
...
static const char* __doc_operations_research_Model_GetDimensionTransitCostSum =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetDimensions =
    R"doc(Returns all dimensions of the model.)doc";

static const char*
    __doc_operations_research_Model_GetDimensionsWithGlobalCumulOptimizers =
        R"doc(Returns the dimensions which have
[global|local]_dimension_optimizers_.)doc";

static const char*
    __doc_operations_research_Model_GetDimensionsWithLocalCumulOptimizers =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_GetDimensionsWithSoftOrSpanCosts =
        R"doc(Returns dimensions with soft or vehicle span costs.)doc";

static const char* __doc_operations_research_Model_GetDisjunctionIndices =
    R"doc(Returns the indices of the disjunctions to which an index 
belongs.)doc";

static const char*
    __doc_operations_research_Model_GetDisjunctionMaxCardinality =
        R"doc(Returns the maximum number of possible active nodes of the node
disjunction of index 'index'.)doc";

static const char* __doc_operations_research_Model_GetDisjunctionNodeIndices =
    R"doc(Returns the variable indices of the nodes in the disjunction of index
'index'.)doc";

static const char* __doc_operations_research_Model_GetDisjunctionPenalty =
    R"doc(Returns the penalty of the node disjunction of index 'index'.)doc";

static const char*
    __doc_operations_research_Model_GetFilteredFirstSolutionDecisionBuilderOrNull =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_GetFirstSolutionDecisionBuilder =
        R"doc()doc";

static const char* __doc_operations_research_Model_GetFixedCostOfVehicle =
...
static const char*
    __doc_operations_research_Model_GetGlobalCumulOptimizerIndex =
        R"doc(Returns the internal global/local optimizer index for the given
dimension if any, and -1 otherwise.)doc";

static const char*
    __doc_operations_research_Model_GetHardTypeIncompatibilitiesOfType =
        R"doc(Returns visit types incompatible with a given type.)doc";

static const char* __doc_operations_research_Model_GetHomogeneousCost =
...
static const char*
    __doc_operations_research_Model_GetImplicitUniquePickupAndDeliveryPairs =
...
static const char* __doc_operations_research_Model_GetLocalCumulOptimizerIndex =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_GetMaximumNumberOfActiveVehicles =
        R"doc(Returns the maximum number of active vehicles.)doc";

static const char* __doc_operations_research_Model_GetMutableCPInterrupt =
    R"doc(Returns the atomic<bool> to stop the CP solver.)doc";

static const char* __doc_operations_research_Model_GetMutableCPSatInterrupt =
    R"doc(Returns the atomic<bool> to stop the CP-SAT solver.)doc";

static const char* __doc_operations_research_Model_GetMutableDimension =
    R"doc(Returns a dimension from its name. Returns nullptr if the dimension
does not exist.)doc";

static const char*
    __doc_operations_research_Model_GetMutableGlobalCumulLPOptimizer =
        R"doc(Returns the global/local dimension cumul optimizer for a given
dimension, or nullptr if there is none.)doc";

static const char*
    __doc_operations_research_Model_GetMutableGlobalCumulMPOptimizer =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_GetMutableLocalCumulLPOptimizer =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_GetMutableLocalCumulMPOptimizer =
        R"doc()doc";

static const char* __doc_operations_research_Model_GetNeighborhoodOperators =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetNextVarMax =
    R"doc(Get the current maximum of the next variable associated to 
index.)doc";

static const char* __doc_operations_research_Model_GetNextVarMin =
    R"doc(Get the current minimum of the next variable associated to 
index.)doc";

static const char* __doc_operations_research_Model_GetNonZeroCostClassesCount =
    R"doc(Ditto, minus the 'always zero', built-in cost class.)doc";

static const char* __doc_operations_research_Model_GetNumOfSingletonNodes =
    R"doc(Returns the number of non-start/end nodes which do not appear in a
pickup/delivery pair.)doc";

static const char*
    __doc_operations_research_Model_GetNumberOfDecisionsInFirstSolution =
...
static const char* __doc_operations_research_Model_GetNumberOfDisjunctions =
    R"doc(Returns the number of node disjunctions in the model.)doc";

static const char*
    __doc_operations_research_Model_GetNumberOfRejectsInFirstSolution =
        R"doc()doc";

static const char* __doc_operations_research_Model_GetNumberOfVisitTypes =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetOrCreateAssignment =
    R"doc(Set of auxiliary methods used to setup the search.)doc";

static const char* __doc_operations_research_Model_GetOrCreateCumulativeLimit =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_GetOrCreateFirstSolutionLargeNeighborhoodSearchLimit =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_GetOrCreateLargeNeighborhoodSearchLimit =
        R"doc()doc";

static const char* __doc_operations_research_Model_GetOrCreateLimit =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_GetOrCreateLocalSearchFilterManager =
        R"doc()doc";

static const char* __doc_operations_research_Model_GetOrCreateLocalSearchLimit =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_GetOrCreateNodeNeighborsByCostClass =
...
static const char*
    __doc_operations_research_Model_GetOrCreateNodeNeighborsByCostClass_2 =
...
static const char* __doc_operations_research_Model_GetOrCreateTmpAssignment =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetPairIndicesOfType =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetPathsMetadata =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_GetPerfectBinaryDisjunctions =
...
static const char*
    __doc_operations_research_Model_GetPickupAndDeliveryDisjunctions =
        R"doc()doc";

static const char* __doc_operations_research_Model_GetPickupAndDeliveryPairs =
    R"doc(Returns pickup and delivery pairs currently in the model.)doc";

static const char*
    __doc_operations_research_Model_GetPickupAndDeliveryPolicyOfVehicle =
        R"doc()doc";

static const char* __doc_operations_research_Model_GetPickupPositions =
    R"doc(Returns the pickup and delivery positions where the node is a 
pickup.)doc";

static const char*
    __doc_operations_research_Model_GetPrimaryConstrainedDimension =
        R"doc(Get the primary constrained dimension, or an empty string if it is
unset.)doc";

static const char* __doc_operations_research_Model_GetResourceGroup =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetResourceGroups =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetRoutesFromAssignment =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_GetSameVehicleIndicesOfIndex =  // NOLINT
    R"doc(Returns variable indices of nodes constrained to be on the same 
route.)doc";

static const char* __doc_operations_research_Model_GetSearchMonitors =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetSingleNodesOfType =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_GetTemporalTypeIncompatibilitiesOfType =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_GetTopologicallySortedVisitTypes =
        R"doc()doc";

static const char* __doc_operations_research_Model_GetUnaryDimensions =
    R"doc(Returns dimensions for which all transit evaluators are unary.)doc";

static const char*
    __doc_operations_research_Model_GetVehicleClassIndexOfVehicle = R"doc()doc";

static const char* __doc_operations_research_Model_GetVehicleClassesCount =
    R"doc(Returns the number of different vehicle classes in the model.)doc";

static const char* __doc_operations_research_Model_GetVehicleOfClass =
    R"doc(Returns a vehicle of the given vehicle class, and -1 if there are no
vehicles for this class.)doc";

static const char* __doc_operations_research_Model_GetVehicleStartClass =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetVehicleTypeContainer =
    R"doc()doc";

static const char* __doc_operations_research_Model_GetVisitType = R"doc()doc";

static const char* __doc_operations_research_Model_GetVisitTypePolicy =
    R"doc()doc";

static const char* __doc_operations_research_Model_HasDimension =
    R"doc(Returns true if a dimension exists for a given dimension name.)doc";

static const char* __doc_operations_research_Model_HasGlobalCumulOptimizer =
    R"doc(Returns whether the given dimension has global/local cumul 
optimizers.)doc";

static const char*
    __doc_operations_research_Model_HasHardTypeIncompatibilities =  // NOLINT
    R"doc(Returns true iff any hard (resp. temporal) type incompatibilities have
been added to the model.)doc";

static const char* __doc_operations_research_Model_HasLocalCumulOptimizer =
    R"doc()doc";

static const char* __doc_operations_research_Model_HasMandatoryDisjunctions =
    R"doc(Returns true if the model contains mandatory disjunctions (ones with
kNoPenalty as penalty).)doc";

static const char*
    __doc_operations_research_Model_HasMaxCardinalityConstrainedDisjunctions =
        R"doc(Returns true if the model contains at least one disjunction which 
is constrained by its max_cardinality.)doc";

static const char*
    __doc_operations_research_Model_HasSameVehicleTypeRequirements =
        R"doc(Returns true iff any same-route (resp. temporal) type requirements
have been added to the model.)doc";

static const char*
    __doc_operations_research_Model_HasTemporalTypeIncompatibilities =
        R"doc()doc";

static const char* __doc_operations_research_Model_HasTemporalTypeRequirements =
    R"doc()doc";

static const char* __doc_operations_research_Model_HasTypeRegulations =
    R"doc(Returns true iff the model has any incompatibilities or requirements
set on node types.)doc";

static const char*
    __doc_operations_research_Model_HasVehicleWithCostClassIndex =
        R"doc(Returns true iff the model contains a vehicle with the given
cost_class_index.)doc";

static const char*
    __doc_operations_research_Model_IgnoreDisjunctionsAlreadyForcedToZero =
...
static const char* __doc_operations_research_Model_InitSameVehicleGroups =
    R"doc()doc";

static const char* __doc_operations_research_Model_Initialize =
    R"doc(Internal methods.)doc";

static const char* __doc_operations_research_Model_InitializeDimensionInternal =
    R"doc()doc";

static const char* __doc_operations_research_Model_IsDelivery = R"doc()doc";

static const char* __doc_operations_research_Model_IsEnd =
    R"doc(Returns true if 'index' represents the last node of a route.)doc";

static const char* __doc_operations_research_Model_IsMatchingModel =
    R"doc(Returns true if a vehicle/node matching problem is detected.)doc";

static const char* __doc_operations_research_Model_IsPickup =
    R"doc(Returns whether the node is a pickup (resp. delivery).)doc";

static const char* __doc_operations_research_Model_IsStart =
    R"doc(Returns true if 'index' represents the first node of a route.)doc";

static const char* __doc_operations_research_Model_IsVehicleAllowedForIndex =
    R"doc(Returns true if a vehicle is allowed to visit a given node.)doc";

static const char* __doc_operations_research_Model_IsVehicleUsed =
    R"doc(Returns true if the route of 'vehicle' is non empty in 
'assignment'.)doc";

static const char* __doc_operations_research_Model_IsVehicleUsedWhenEmpty =
    R"doc()doc";

static const char* __doc_operations_research_Model_LogSolution =
    R"doc(Log a solution.)doc";

static const char* __doc_operations_research_Model_MakeGreedyDescentLSOperator =
...
static const char* __doc_operations_research_Model_MakeGuidedSlackFinalizer =
...
static const char*
    __doc_operations_research_Model_MakeSelfDependentDimensionFinalizer =
...
static const char* __doc_operations_research_Model_MakeStateDependentTransit =
    R"doc(Creates a cached StateDependentTransit from an std::function.)doc";

static const char* __doc_operations_research_Model_MutablePreAssignment =
    R"doc()doc";

static const char* __doc_operations_research_Model_Next =
...
static const char* __doc_operations_research_Model_NextVar =
...
static const char* __doc_operations_research_Model_Nexts =
    R"doc(Returns all next variables of the model, such that Nexts(i) is the
next variable of the node corresponding to i.)doc";

static const char* __doc_operations_research_Model_NodeNeighborsByCostClass =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_NodeNeighborsByCostClass_ComputeNeighbors =
        R"doc(Computes num_neighbors neighbors of all nodes for every cost class
 in routing_model.)doc";

static const char*
    __doc_operations_research_Model_NodeNeighborsByCostClass_GetNeighborsOfNodeForCostClass =  // NOLINT
    R"doc(Returns the neighbors of the given node for the given 
cost_class.)doc";

static const char*
    __doc_operations_research_Model_NodeNeighborsByCostClass_NodeNeighborsByCostClass =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_NodeNeighborsByCostClass_all_nodes =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_NodeNeighborsByCostClass_node_index_to_neighbors_by_cost_class =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Model_NodeNeighborsParameters =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_NodeNeighborsParameters_add_vehicle_starts_to_neighbors =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_NodeNeighborsParameters_num_neighbors =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_NodeNeighborsParameters_operator_eq =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_OptimizeCumulsOfDimensionFromAssignmentWithCumulDependentTransits =  // NOLINT
...
static const char*
    __doc_operations_research_Model_PackCumulsOfOptimizerDimensionsFromAssignment =  // NOLINT
...
static const char* __doc_operations_research_Model_PickupAndDeliveryPolicy =
    R"doc(Types of precedence policy applied to pickup and delivery pairs.)doc";

static const char*
    __doc_operations_research_Model_PickupAndDeliveryPolicy_PICKUP_AND_DELIVERY_FIFO =  // NOLINT
    R"doc(Deliveries must be performed in the same order as pickups.)doc";

static const char*
    __doc_operations_research_Model_PickupAndDeliveryPolicy_PICKUP_AND_DELIVERY_LIFO =  // NOLINT
    R"doc(Deliveries must be performed in reverse order of pickups.)doc";

static const char*
    __doc_operations_research_Model_PickupAndDeliveryPolicy_PICKUP_AND_DELIVERY_NO_ORDER =  // NOLINT
    R"doc(Any precedence is accepted.)doc";

static const char* __doc_operations_research_Model_PickupDeliveryPosition =
    R"doc(The position of a node in the set of pickup and delivery pairs.)doc";

static const char*
    __doc_operations_research_Model_PickupDeliveryPosition_alternative_index =
        R"doc(The index of the node in the vector of pickup (resp. delivery)
alternatives of the pair.)doc";

static const char*
    __doc_operations_research_Model_PickupDeliveryPosition_pd_pair_index =
        R"doc(The index of the pickup and delivery pair within which the node
appears.)doc";

static const char* __doc_operations_research_Model_PreAssignment =
...
static const char* __doc_operations_research_Model_QuietCloseModel =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_QuietCloseModelWithParameters = R"doc()doc";

static const char* __doc_operations_research_Model_ReadAssignment =
...
static const char* __doc_operations_research_Model_ReadAssignmentFromRoutes =
...
static const char*
    __doc_operations_research_Model_RegisterStateDependentTransitCallback =
        R"doc()doc";

static const char* __doc_operations_research_Model_RegisterTransitCallback =
    R"doc()doc";

static const char* __doc_operations_research_Model_RegisterTransitMatrix =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RegisterUnaryTransitCallback = R"doc()doc";

static const char* __doc_operations_research_Model_RegisterUnaryTransitVector =
...
static const char* __doc_operations_research_Model_RemainingTime =
    R"doc(Returns the time left in the search limit.)doc";

static const char* __doc_operations_research_Model_ReplaceUnusedVehicle =
...
static const char* __doc_operations_research_Model_ResourceGroup =
...
static const char* __doc_operations_research_Model_ResourceGroup_AddResource =
...
static const char* __doc_operations_research_Model_ResourceGroup_Attributes =
    R"doc(Attributes for a dimension.)doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_Attributes_Attributes =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_Attributes_Attributes_2 =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_Attributes_end_domain =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_Attributes_end_domain_2 =
        R"doc(end_domain_.Min() <= cumul[End(v)] <= end_domain_.Max())doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_Attributes_start_domain =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_Attributes_start_domain_2 =
...
static const char*
    __doc_operations_research_Model_ResourceGroup_ClearAllowedResourcesForVehicle =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_ComputeResourceClasses =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_GetAffectedDimensionIndices =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_GetDimensionAttributesForClass =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Model_ResourceGroup_GetResource =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_GetResourceClassIndex =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_GetResourceClassesCount =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_GetResourceIndicesInClass =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_GetResourceIndicesPerClass =
        R"doc()doc";

static const char* __doc_operations_research_Model_ResourceGroup_GetResources =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_GetResourcesMarkedAllowedForVehicle =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_GetVehiclesRequiringAResource =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Model_ResourceGroup_Index =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_IsResourceAllowedForVehicle =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_NotifyVehicleRequiresAResource =  // NOLINT
...
static const char* __doc_operations_research_Model_ResourceGroup_Resource =
    R"doc(A Resource sets attributes (costs/constraints) for a set of
dimensions.)doc";

static const char* __doc_operations_research_Model_ResourceGroup_ResourceGroup =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_Resource_GetDefaultAttributes =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_Resource_GetDimensionAttributes =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_Resource_Resource =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_Resource_SetDimensionAttributes =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_Resource_dimension_attributes =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_Resource_model = R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_SetAllowedResourcesForVehicle =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Model_ResourceGroup_Size =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_VehicleRequiresAResource =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_affected_dimension_indices =
        R"doc(All indices of dimensions affected by this resource group.)doc";

static const char* __doc_operations_research_Model_ResourceGroup_index =
    R"doc()doc";

static const char* __doc_operations_research_Model_ResourceGroup_model =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_resource_class_indices =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_resource_indices_per_class =
        R"doc()doc";

static const char* __doc_operations_research_Model_ResourceGroup_resources =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_vehicle_requires_resource =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_ResourceGroup_vehicles_requiring_resource =
        R"doc()doc";

static const char* __doc_operations_research_Model_ResourceVar =
...
static const char* __doc_operations_research_Model_ResourceVars =
...
static const char* __doc_operations_research_Model_RestoreAssignment =
...
static const char* __doc_operations_research_Model_RouteCanBeUsedByVehicle =
...
static const char* __doc_operations_research_Model_RouteDimensionTravelInfo =
...
static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_DebugString =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_TransitionInfo =
        R"doc(Contains the information for a single transition on the 
route.)doc";

static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_TransitionInfo_DebugString =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_TransitionInfo_PiecewiseLinearFormulation =  // NOLINT
...
static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_TransitionInfo_PiecewiseLinearFormulation_DebugString =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_TransitionInfo_PiecewiseLinearFormulation_x_anchors =  // NOLINT
    R"doc(The set of *increasing* anchor cumul values for the 
interpolation.)doc";

static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_TransitionInfo_PiecewiseLinearFormulation_y_anchors =  // NOLINT
...
static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_TransitionInfo_compressed_travel_value_lower_bound =  // NOLINT
    R"doc(The hard lower bound of the compressed travel value that will be
enforced by the scheduling module.)doc";

static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_TransitionInfo_post_travel_transit_value =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_TransitionInfo_pre_travel_transit_value =  // NOLINT
...
static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_TransitionInfo_travel_compression_cost =  // NOLINT
...
static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_TransitionInfo_travel_start_dependent_travel =  // NOLINT
    R"doc(Models the (real) travel value Tᵣ, for this transition based on the
departure value of the travel.)doc";

static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_TransitionInfo_travel_value_upper_bound =  // NOLINT
...
static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_transition_info =
...
static const char*
    __doc_operations_research_Model_RouteDimensionTravelInfo_travel_cost_coefficient =  // NOLINT
    R"doc(The cost per unit of travel for this vehicle.)doc";

static const char* __doc_operations_research_Model_RoutesToAssignment =
...
static const char* __doc_operations_research_Model_RoutingLocalSearchOperator =
    R"doc(Local search move operator usable in routing.)doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_CROSS =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_CROSS_EXCHANGE =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_EXCHANGE =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_EXCHANGE_PAIR =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_EXCHANGE_RELOCATE_PAIR =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_EXCHANGE_SUBTRIP =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_EXTENDED_SWAP_ACTIVE =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_FULL_PATH_LNS =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_GLOBAL_CHEAPEST_INSERTION_CLOSE_NODES_LNS =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_GLOBAL_CHEAPEST_INSERTION_EXPENSIVE_CHAIN_LNS =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_GLOBAL_CHEAPEST_INSERTION_PATH_LNS =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_INACTIVE_LNS =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_LIGHT_RELOCATE_PAIR =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_LIN_KERNIGHAN =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_LOCAL_CHEAPEST_INSERTION_CLOSE_NODES_LNS =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_LOCAL_CHEAPEST_INSERTION_EXPENSIVE_CHAIN_LNS =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_LOCAL_CHEAPEST_INSERTION_PATH_LNS =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_LOCAL_SEARCH_OPERATOR_COUNTER =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_MAKE_ACTIVE =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_MAKE_ACTIVE_AND_RELOCATE =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_MAKE_CHAIN_INACTIVE =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_MAKE_INACTIVE =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_NODE_PAIR_SWAP =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_OR_OPT =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_PATH_LNS =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_RELOCATE =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_RELOCATE_AND_MAKE_ACTIVE =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_RELOCATE_EXPENSIVE_CHAIN =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_RELOCATE_NEIGHBORS =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_RELOCATE_PAIR =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_RELOCATE_PATH_GLOBAL_CHEAPEST_INSERTION_INSERT_UNPERFORMED =  // NOLINT
    R"doc()doc";  // NOLINT

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_RELOCATE_SUBTRIP =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_SHORTEST_PATH_SWAP_ACTIVE =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_SWAP_ACTIVE =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_TSP_LNS =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_TSP_OPT =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_RoutingLocalSearchOperator_TWO_OPT =
        R"doc()doc";

static const char* __doc_operations_research_Model_RoutingModel =
...
static const char* __doc_operations_research_Model_Model_2 = R"doc()doc";

static const char* __doc_operations_research_Model_Model_3 = R"doc()doc";

static const char*
    __doc_operations_research_Model_SafeGetCostClassInt64OfVehicle =
        R"doc()doc";

static const char* __doc_operations_research_Model_SecondaryOptimizer =
    R"doc(Class used to solve a secondary model within a first solution
strategy.)doc";

static const char*
    __doc_operations_research_Model_SecondaryOptimizer_SecondaryOptimizer =
        R"doc()doc";

static const char* __doc_operations_research_Model_SecondaryOptimizer_Solve =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_SecondaryOptimizer_call_count = R"doc()doc";

static const char* __doc_operations_research_Model_SecondaryOptimizer_model =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_SecondaryOptimizer_search_parameters =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_SecondaryOptimizer_solve_period =
        R"doc()doc";

static const char* __doc_operations_research_Model_SecondaryOptimizer_state =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_SecondaryOptimizer_var_to_index =
        R"doc()doc";

static const char* __doc_operations_research_Model_SetAllowedVehiclesForIndex =
...
static const char*
    __doc_operations_research_Model_SetAmortizedCostFactorsOfAllVehicles =
...
static const char*
    __doc_operations_research_Model_SetAmortizedCostFactorsOfVehicle =
        R"doc(Sets the linear and quadratic cost factor of the given 
vehicle.)doc";

static const char*
    __doc_operations_research_Model_SetArcCostEvaluatorOfAllVehicles =
...
static const char*
    __doc_operations_research_Model_SetArcCostEvaluatorOfVehicle =
        R"doc(Sets the cost function for a given vehicle route.)doc";

static const char*
    __doc_operations_research_Model_SetAssignmentFromOtherModelAssignment =
...
static const char* __doc_operations_research_Model_SetFirstSolutionEvaluator =
    R"doc(Takes ownership of evaluator.)doc";

static const char* __doc_operations_research_Model_SetFixedCostOfAllVehicles =
...
static const char* __doc_operations_research_Model_SetFixedCostOfVehicle =
    R"doc(Sets the fixed cost of one vehicle route.)doc";

static const char* __doc_operations_research_Model_SetIndexNeighborFinder =
    R"doc(Sets the sweep arranger to be used by routing heuristics; ownership of
the arranger is taken.)doc";

static const char*
    __doc_operations_research_Model_SetMaximumNumberOfActiveVehicles =
...
static const char* __doc_operations_research_Model_SetNextVarRange =
...
static const char*
    __doc_operations_research_Model_SetOptimizedWithCumulDependentTransits =
        R"doc(Notifies that the given dimension's cumuls can be optimized with
cumul-dependent transits.)doc";

static const char* __doc_operations_research_Model_SetPathEnergyCostOfVehicle =
    R"doc()doc";

static const char* __doc_operations_research_Model_SetPathEnergyCostsOfVehicle =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_SetPickupAndDeliveryPolicyOfAllVehicles =
...
static const char*
    __doc_operations_research_Model_SetPickupAndDeliveryPolicyOfVehicle =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_SetPrimaryConstrainedDimension =
...
static const char* __doc_operations_research_Model_SetSameVehicleGroup =
    R"doc()doc";

static const char* __doc_operations_research_Model_SetSecondaryModel =
...
static const char* __doc_operations_research_Model_SetSweepArranger =
    R"doc()doc";

static const char* __doc_operations_research_Model_SetTabuVarsCallback =
    R"doc()doc";

static const char* __doc_operations_research_Model_SetVehicleUsedWhenEmpty =
    R"doc()doc";

static const char* __doc_operations_research_Model_SetVisitType = R"doc()doc";

static const char* __doc_operations_research_Model_SetupAssignmentCollector =
    R"doc()doc";

static const char* __doc_operations_research_Model_SetupDecisionBuilders =
    R"doc()doc";

static const char* __doc_operations_research_Model_SetupImprovementLimit =
    R"doc()doc";

static const char* __doc_operations_research_Model_SetupMetaheuristics =
    R"doc()doc";

static const char* __doc_operations_research_Model_SetupSearch =
    R"doc(Sets up search objects, such as decision builders and monitors.)doc";

static const char* __doc_operations_research_Model_SetupSearchMonitors =
    R"doc()doc";

static const char* __doc_operations_research_Model_SetupTrace = R"doc()doc";

static const char* __doc_operations_research_Model_Size =
    R"doc(Returns the number of next variables in the model.)doc";

static const char* __doc_operations_research_Model_Solve =
...
static const char* __doc_operations_research_Model_Start =
    R"doc(Model inspection. Returns the variable index of the starting node of a
vehicle route.)doc";

static const char* __doc_operations_research_Model_StateDependentTransit =
...
static const char*
    __doc_operations_research_Model_StateDependentTransitCallback = R"doc()doc";

static const char*
    __doc_operations_research_Model_StateDependentTransit_transit = R"doc()doc";

static const char*
    __doc_operations_research_Model_StateDependentTransit_transit_plus_identity =  // NOLINT
    R"doc(f(x))doc";

static const char*
    __doc_operations_research_Model_StoreDimensionCumulOptimizers =  // NOLINT
...
static const char* __doc_operations_research_Model_TimeBuffer =
    R"doc(Returns the time buffer to safely return a solution.)doc";

static const char* __doc_operations_research_Model_TopologicallySortVisitTypes =
    R"doc()doc";

static const char* __doc_operations_research_Model_TransitCallback =
    R"doc()doc";

static const char* __doc_operations_research_Model_TransitEvaluatorSign =
    R"doc(Represents the sign of values returned by a transit evaluator.)doc";

static const char*
    __doc_operations_research_Model_TransitEvaluatorSign_kTransitEvaluatorSignNegativeOrZero =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_TransitEvaluatorSign_kTransitEvaluatorSignPositiveOrZero =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_TransitEvaluatorSign_kTransitEvaluatorSignUnknown =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Model_UnaryTransitCallbackOrNull =
    R"doc()doc";

static const char* __doc_operations_research_Model_UnperformedPenalty =
...
static const char* __doc_operations_research_Model_UnperformedPenaltyOrValue =
...
static const char*
    __doc_operations_research_Model_UpdateSearchFromParametersIfNeeded =
        R"doc(Updates search objects if parameters have changed.)doc";

static const char* __doc_operations_research_Model_UpdateTimeLimit =
    R"doc(Updates the time limit of the search limit.)doc";

static const char* __doc_operations_research_Model_UsesLightPropagation =
    R"doc()doc";

static const char* __doc_operations_research_Model_ValuedNodes =
...
static const char* __doc_operations_research_Model_ValuedNodes_indices =
    R"doc()doc";

static const char* __doc_operations_research_Model_ValuedNodes_value =
    R"doc()doc";

static const char* __doc_operations_research_Model_VariableValuePair =
    R"doc(Struct used to store a variable value.)doc";

static const char* __doc_operations_research_Model_VariableValuePair_value =
    R"doc()doc";

static const char* __doc_operations_research_Model_VariableValuePair_var_index =
    R"doc()doc";

static const char* __doc_operations_research_Model_VehicleIndex =
    R"doc(Returns the vehicle of the given start/end index, and -1 if the given
index is not a vehicle start/end.)doc";

static const char* __doc_operations_research_Model_VehicleRouteConsideredVar =
...
static const char* __doc_operations_research_Model_VehicleTypeContainer =
...
static const char*
    __doc_operations_research_Model_VehicleTypeContainer_NumTypes = R"doc()doc";

static const char* __doc_operations_research_Model_VehicleTypeContainer_Type =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_VehicleTypeContainer_VehicleClassEntry =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_VehicleTypeContainer_VehicleClassEntry_fixed_cost =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_VehicleTypeContainer_VehicleClassEntry_operator_lt =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_VehicleTypeContainer_VehicleClassEntry_vehicle_class =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_VehicleTypeContainer_sorted_vehicle_classes_per_type =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_Model_VehicleTypeContainer_type_index_of_vehicle =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_VehicleTypeContainer_vehicles_per_vehicle_class =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Model_VehicleVar =
...
static const char* __doc_operations_research_Model_VehicleVars =
...
static const char* __doc_operations_research_Model_VisitTypePolicy =
...
static const char*
    __doc_operations_research_Model_VisitTypePolicy_ADDED_TYPE_REMOVED_FROM_VEHICLE =  // NOLINT
...
static const char*
    __doc_operations_research_Model_VisitTypePolicy_TYPE_ADDED_TO_VEHICLE =
        R"doc(When visited, the number of types 'T' on the vehicle increases by one.)doc";

static const char*
    __doc_operations_research_Model_VisitTypePolicy_TYPE_ON_VEHICLE_UP_TO_VISIT =  // NOLINT
...
static const char*
    __doc_operations_research_Model_VisitTypePolicy_TYPE_SIMULTANEOUSLY_ADDED_AND_REMOVED =  // NOLINT
...
static const char* __doc_operations_research_Model_WriteAssignment =
...
static const char* __doc_operations_research_Model_active = R"doc()doc";

static const char* __doc_operations_research_Model_assignment = R"doc()doc";

static const char* __doc_operations_research_Model_at_solution_monitors =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_automatic_first_solution_strategy =
        R"doc()doc";

static const char* __doc_operations_research_Model_bin_capacities = R"doc()doc";

static const char* __doc_operations_research_Model_cache_callbacks =
    R"doc()doc";

static const char* __doc_operations_research_Model_closed = R"doc()doc";

static const char* __doc_operations_research_Model_collect_assignments =
    R"doc()doc";

static const char* __doc_operations_research_Model_collect_one_assignment =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_collect_secondary_ls_assignments =
        R"doc()doc";

static const char* __doc_operations_research_Model_cost = R"doc(Costs)doc";

static const char* __doc_operations_research_Model_cost_cache = R"doc()doc";

static const char* __doc_operations_research_Model_cost_class_index_of_vehicle =
    R"doc()doc";

static const char* __doc_operations_research_Model_cost_classes = R"doc()doc";

static const char*
    __doc_operations_research_Model_costs_are_homogeneous_across_vehicles =
        R"doc()doc";

static const char* __doc_operations_research_Model_cumulative_limit =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_dimension_cumuls_optimized_with_cumul_dependent_transits =  // NOLINT
...
static const char*
    __doc_operations_research_Model_dimension_local_optimizer_for_cumul_dependent_transits =  // NOLINT
...
static const char* __doc_operations_research_Model_dimension_name_to_index =
    R"doc(Dimensions)doc";

static const char*
    __doc_operations_research_Model_dimension_resource_group_indices =
        R"doc(Stores the set of resource groups related to each dimension.)doc";

static const char* __doc_operations_research_Model_dimensions = R"doc()doc";

static const char* __doc_operations_research_Model_disjunctions =
    R"doc(Disjunctions)doc";

static const char* __doc_operations_research_Model_enable_deep_serialization =
    R"doc(Returns the value of the internal enable_deep_serialization_
parameter.)doc";

static const char* __doc_operations_research_Model_enable_deep_serialization_2 =
    R"doc()doc";

static const char* __doc_operations_research_Model_extra_filters = R"doc()doc";

static const char* __doc_operations_research_Model_extra_intervals =
    R"doc()doc";

static const char* __doc_operations_research_Model_extra_operators =
    R"doc()doc";

static const char* __doc_operations_research_Model_extra_vars = R"doc()doc";

static const char* __doc_operations_research_Model_finalizer_variables =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_first_solution_decision_builders =
        R"doc()doc";

static const char* __doc_operations_research_Model_first_solution_evaluator =
    R"doc()doc";

static const char* __doc_operations_research_Model_first_solution_evaluator_2 =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_first_solution_filtered_decision_builders =
        R"doc()doc";

static const char* __doc_operations_research_Model_first_solution_lns_limit =
    R"doc()doc";

static const char* __doc_operations_research_Model_fixed_cost_of_vehicle =
    R"doc()doc";

static const char* __doc_operations_research_Model_global_dimension_optimizers =
...
static const char* __doc_operations_research_Model_global_optimizer_index =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_has_hard_type_incompatibilities =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_has_same_vehicle_type_requirements =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_has_temporal_type_incompatibilities =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_has_temporal_type_requirements =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_has_vehicle_with_zero_cost_class =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_implicit_pickup_delivery_pairs_without_alternatives =  // NOLINT
    R"doc()doc";

static const char* __doc_operations_research_Model_improve_db = R"doc()doc";

static const char* __doc_operations_research_Model_index_neighbor_finder =
    R"doc(Returns the index neighbor finder to be used by routing 
heuristics.)doc";

static const char* __doc_operations_research_Model_index_neighbor_finder_2 =
    R"doc()doc";

static const char* __doc_operations_research_Model_index_to_delivery_positions =
    R"doc()doc";

static const char* __doc_operations_research_Model_index_to_disjunctions =
    R"doc()doc";

static const char* __doc_operations_research_Model_index_to_equivalence_class =
    R"doc()doc";

static const char* __doc_operations_research_Model_index_to_pickup_positions =
    R"doc()doc";

static const char* __doc_operations_research_Model_index_to_type_policy =
    R"doc()doc";

static const char* __doc_operations_research_Model_index_to_visit_type =
    R"doc()doc";

static const char* __doc_operations_research_Model_interrupt_cp = R"doc()doc";

static const char* __doc_operations_research_Model_interrupt_cp_sat =
    R"doc()doc";

static const char* __doc_operations_research_Model_is_bound_to_end =
...
static const char* __doc_operations_research_Model_is_bound_to_end_ct_added =
    R"doc()doc";

static const char* __doc_operations_research_Model_limit = R"doc()doc";

static const char*
    __doc_operations_research_Model_linear_cost_factor_of_vehicle = R"doc()doc";

static const char* __doc_operations_research_Model_lns_limit = R"doc()doc";

static const char* __doc_operations_research_Model_local_dimension_optimizers =
    R"doc()doc";

static const char* __doc_operations_research_Model_local_optimizer_index =
    R"doc()doc";

static const char* __doc_operations_research_Model_local_optimum_reached =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_local_search_filter_managers = R"doc()doc";

static const char* __doc_operations_research_Model_local_search_operators =
    R"doc()doc";

static const char* __doc_operations_research_Model_ls_limit = R"doc()doc";

static const char* __doc_operations_research_Model_manager = R"doc()doc";

static const char* __doc_operations_research_Model_max_active_vehicles =
    R"doc()doc";

static const char* __doc_operations_research_Model_metaheuristic = R"doc()doc";

static const char* __doc_operations_research_Model_monitors = R"doc()doc";

static const char* __doc_operations_research_Model_monitors_after_setup =
    R"doc()doc";

static const char* __doc_operations_research_Model_monitors_before_setup =
    R"doc()doc";

static const char* __doc_operations_research_Model_nexts =
    R"doc(Decision variables: indexed by int64_t var index.)doc";

static const char* __doc_operations_research_Model_no_cycle_constraint =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_node_neighbors_by_cost_class_per_size =
        R"doc()doc";

static const char* __doc_operations_research_Model_nodes =
    R"doc(Sizes and indices Returns the number of nodes in the model.)doc";

static const char* __doc_operations_research_Model_nodes_2 = R"doc()doc";

static const char* __doc_operations_research_Model_num_vehicle_classes =
    R"doc()doc";

static const char* __doc_operations_research_Model_num_visit_types =
    R"doc()doc";

static const char* __doc_operations_research_Model_objective_lower_bound =
    R"doc(Returns the current lower bound found by internal solvers during the
search.)doc";

static const char* __doc_operations_research_Model_objective_lower_bound_2 =
    R"doc()doc";

static const char* __doc_operations_research_Model_operator_assign =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_optimized_dimensions_assignment_collector =
        R"doc()doc";

static const char* __doc_operations_research_Model_pair_indices_of_type =
    R"doc()doc";

static const char* __doc_operations_research_Model_paths_metadata = R"doc()doc";

static const char*
    __doc_operations_research_Model_pickup_delivery_disjunctions = R"doc()doc";

static const char* __doc_operations_research_Model_pickup_delivery_pairs =
    R"doc(Pickup and delivery)doc";

static const char* __doc_operations_research_Model_preassignment = R"doc()doc";

static const char*
    __doc_operations_research_Model_primary_constrained_dimension = R"doc()doc";

static const char* __doc_operations_research_Model_primary_ls_operator =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_quadratic_cost_factor_of_vehicle =
        R"doc()doc";

static const char* __doc_operations_research_Model_resource_groups =
...
static const char* __doc_operations_research_Model_resource_vars =
...
static const char* __doc_operations_research_Model_restore_assignment =
    R"doc()doc";

static const char* __doc_operations_research_Model_restore_tmp_assignment =
    R"doc()doc";

static const char* __doc_operations_research_Model_same_vehicle_costs =
    R"doc(Same vehicle costs)doc";

static const char* __doc_operations_research_Model_same_vehicle_group =
    R"doc()doc";

static const char* __doc_operations_research_Model_same_vehicle_groups =
    R"doc()doc";

static const char* __doc_operations_research_Model_search_log = R"doc()doc";

static const char* __doc_operations_research_Model_search_parameters =
    R"doc()doc";

static const char* __doc_operations_research_Model_secondary_ls_db =
    R"doc()doc";

static const char* __doc_operations_research_Model_secondary_ls_monitors =
    R"doc()doc";

static const char* __doc_operations_research_Model_secondary_ls_operator =
    R"doc()doc";

static const char* __doc_operations_research_Model_secondary_model =
    R"doc()doc";

static const char* __doc_operations_research_Model_secondary_optimizer =
    R"doc()doc";

static const char* __doc_operations_research_Model_secondary_parameters =
    R"doc()doc";

static const char* __doc_operations_research_Model_single_nodes_of_type =
    R"doc()doc";

static const char* __doc_operations_research_Model_solve_db = R"doc()doc";

static const char* __doc_operations_research_Model_solver =
    R"doc(Returns the underlying constraint solver. Can be used to add extra
constraints and/or modify search algorithms.)doc";

static const char* __doc_operations_research_Model_solver_2 = R"doc(Model)doc";

static const char* __doc_operations_research_Model_start_end_count =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_state_dependent_transit_evaluators =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_state_dependent_transit_evaluators_cache =
        R"doc()doc";

static const char* __doc_operations_research_Model_status =
    R"doc(Returns the current status of the routing model.)doc";

static const char* __doc_operations_research_Model_status_2 = R"doc()doc";

static const char* __doc_operations_research_Model_sweep_arranger =
    R"doc(Returns the sweep arranger to be used by routing heuristics.)doc";

static const char* __doc_operations_research_Model_sweep_arranger_2 =
    R"doc()doc";

static const char* __doc_operations_research_Model_tabu_var_callback =
    R"doc()doc";

static const char* __doc_operations_research_Model_time_buffer = R"doc()doc";

static const char* __doc_operations_research_Model_tmp_assignment = R"doc()doc";

static const char*
    __doc_operations_research_Model_topologically_sorted_visit_types =
        R"doc()doc";

static const char* __doc_operations_research_Model_transit_evaluator_sign =
    R"doc()doc";

static const char* __doc_operations_research_Model_transit_evaluators =
    R"doc()doc";

static const char* __doc_operations_research_Model_unary_transit_evaluators =
    R"doc()doc";

static const char* __doc_operations_research_Model_vehicle_active = R"doc()doc";

static const char*
    __doc_operations_research_Model_vehicle_amortized_cost_factors_set =
        R"doc()doc";

static const char*
    __doc_operations_research_Model_vehicle_class_index_of_vehicle =
        R"doc(Index by source index.)doc";

static const char*
    __doc_operations_research_Model_vehicle_pickup_delivery_policy =
        R"doc()doc";

static const char* __doc_operations_research_Model_vehicle_route_considered =
    R"doc()doc";

static const char*
    __doc_operations_research_Model_vehicle_start_class_callback = R"doc()doc";

static const char* __doc_operations_research_Model_vehicle_to_transit_cost =
    R"doc()doc";

static const char* __doc_operations_research_Model_vehicle_type_container =
    R"doc()doc";

static const char* __doc_operations_research_Model_vehicle_used_when_empty =
...
static const char* __doc_operations_research_Model_vehicle_vars = R"doc()doc";

static const char* __doc_operations_research_Model_vehicles =
    R"doc(Returns the number of vehicle routes in the model.)doc";

static const char* __doc_operations_research_Model_vehicles_2 = R"doc()doc";
...
static const char*
    __doc_operations_research_TypeIncompatibilityChecker_TypeIncompatibilityChecker =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_TypeIncompatibilityChecker_check_hard_incompatibilities =  // NOLINT
...
static const char*
    __doc_operations_research_TypeRegulationsChecker_TypePolicyOccurrence_num_type_added_to_vehicle =  // NOLINT
    R"doc(Number of TYPE_ADDED_TO_VEHICLE and
TYPE_SIMULTANEOUSLY_ADDED_AND_REMOVED node type policies seen on the
route.)doc";

static const char*
    __doc_operations_research_TypeRegulationsChecker_TypePolicyOccurrence_num_type_removed_from_vehicle =  // NOLINT
...
static const char*
    __doc_operations_research_TypeRegulationsChecker_TypePolicyOccurrence_position_of_last_type_on_vehicle_up_to_visit =  // NOLINT
...
static const char*
    __doc_operations_research_TypeRegulationsConstraint_CheckRegulationsOnVehicle =  // NOLINT
    R"doc()doc";
...
static const char*
    __doc_operations_research_TypeRegulationsConstraint_PropagateNodeRegulations =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_TypeRegulationsConstraint_TypeRegulationsConstraint =  // NOLINT
    R"doc()doc";

static const char*
    __doc_operations_research_TypeRegulationsConstraint_incompatibility_checker =  // NOLINT
    R"doc()doc";
...
static const char*
    __doc_operations_research_TypeRequirementChecker_CheckRequiredTypesCurrentlyOnRoute =  // NOLINT
...
static const char*
    __doc_operations_research_TypeRequirementChecker_types_with_same_vehicle_requirements_on_route =  // NOLINT
    R"doc()doc";
