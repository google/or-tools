...
class SmallBitSet : public DomainIntVar::BitSet {
 public:
  ...
  std::string DebugString() const override {
    return absl::StrFormat("SmallBitSet(%d..%d : %llx)",
                           omin_, omax_, bits_);
  }
...
class PlusCstVar : public IntVar {
 public:
  ...
  std::string DebugString() const override {
    if (HasName()) {
      return absl::StrFormat("%s(%s + %d)", name(),
...
std::string SubCstIntVar::DebugString() const {
  if (cst_ == 1 && var_->VarType() == BOOLEAN_VAR) {
    ...
    return absl::StrFormat("(%d - %s)", cst_,
                           var_->DebugString());
  }
}
...
class SubIntCstExpr : public BaseIntExpr {
 public:
  ...
  std::string DebugString() const override {
    return absl::StrFormat("(%d - %s)", value_,
                           expr_->DebugString());
  }
  void WhenRange(Demon* d) override { expr_->WhenRange(d); }
  IntVar* CastToVar() override;
...
class DivPosIntCstExpr : public BaseIntExpr {
 public:
  ...
  std::string name() const override {
    return absl::StrFormat("(%s div %d)", expr_->name(),
                           value_);
  }

  std::string DebugString() const override {
    return absl::StrFormat("(%s div %d)", expr_->DebugString(),
                           value_);
  }
...
class BasePower : public BaseIntExpr {
 public:
  ...
  std::string name() const override {
    return absl::StrFormat("IntPower(%s, %d)", expr_->name(),
                           pow_);
  }

  std::string DebugString() const override {
    return absl::StrFormat("IntPower(%s, %d)",
...
class MinCstIntExpr : public BaseIntExpr {
 public:
  ...
  std::string name() const override {
    return absl::StrFormat("MinCstIntExpr(%s, %d)",
                           expr_->name(), value_);
  }
...
class MaxCstIntExpr : public BaseIntExpr {
 public:
  ...
  std::string name() const override {
    return absl::StrFormat("MaxCstIntExpr(%s, %d)",
                           expr_->name(), value_);
  }
