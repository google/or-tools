...
To begin, skim
[cp_model.proto](/ortools/sat/cp_model.proto) to
understand how optimization problems can be modeled using the solver. You can
then solve a model with the functions in
[cp_model_solver.h](/ortools/sat/cp_model_solver.h).

## Parameters

*   [sat_parameters.proto](/ortools/sat/sat_parameters.proto):
...
*   [cp_model_utils.h](/ortools/sat/cp_model_utils.h):
    Utilities to manipulate and create a cp_model.proto.
*   [cp_model_checker.h](/ortools/sat/cp_model_checker.h):
    Tools to validate cp_model.proto and test a solution feasibility.
*   [cp_model_solver.h](/ortools/sat/cp_model_solver.h):
    The solver API.
*   [cp_model_presolve.h](/ortools/sat/cp_model_presolve.h):
...
*   [sat_base.h](/ortools/sat/sat_base.h): SAT
    core classes.
*   [clause.h](/ortools/sat/clause.h): SAT clause
    propagator with the two-watcher mechanism. Also contains propagators for
    binary clauses.
*   [sat_solver.h](/ortools/sat/sat_solver.h):
    The SatSolver code.
*   [simplification.h](/ortools/sat/simplification.h):
    SAT postsolver and presolver.
*   [symmetry.h](/ortools/sat/symmetry.h):
    Dynamic symmetry breaking constraint in SAT. Not used by default.

Extension:

*   [pb_constraint.h](/ortools/sat/pb_constraint.h):
...
*   [no_cycle.h](/ortools/sat/no_cycle.h):
...
*   [encoding.h](/ortools/sat/encoding.h): Basic
...
*   [drat_writer.h](/ortools/sat/drat_writer.h):
...
*   [opb_reader.h](/ortools/sat/opb_reader.h):
    Parser for the .opb format for Pseudo-Boolean optimization problems.
*   [sat_cnf_reader.h](/ortools/sat/sat_cnf_reader.h):
    Parser for the classic SAT .cnf format. Also parses max-SAT files.
*   [boolean_problem.proto](/ortools/sat/boolean_problem.proto):
...
*   [disjunctive.h](/ortools/sat/disjunctive.h):
    Propagation algorithms for the disjunctive scheduling constraint.
*   [cumulative.h](/ortools/sat/cumulative.h),
    [timetable.h](/ortools/sat/timetable.h),
    [timetable_edgefinding.h](/ortools/sat/timetable_edgefinding.h):
    Propagation algorithms for the cumulative scheduling constraint.
*   [cumulative_energy.h](/ortools/sat/cumulative_energy.h):
    Propagation algorithms for a more general cumulative constraint.

### Packing constraints

*   [diffn.h](/ortools/sat/diffn.h): 2D
...
*   [diffn_util.h](/ortools/sat/diffn_util.h):
    rectangle utilities.

### Linear relaxation

*   [linear_constraint.h](/ortools/sat/linear_constraint.h):
    Data structure to represent a linear constraint: lb <= sum (ai * xi) <= ub.
*   [linear_constraint_manager.h](/ortools/sat/linear_constraint_manager.h):
