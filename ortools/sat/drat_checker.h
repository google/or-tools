...
class DratChecker {
 ...
 private:
  ...
  ITIVector<ClauseIndex, Clause> clauses_;
  ...
  ITIVector<BooleanVariable, ClauseIndex> assignment_source_;
  ...
  ITIVector<LiteralIndex, std::vector<ClauseIndex>> watched_literals_;
