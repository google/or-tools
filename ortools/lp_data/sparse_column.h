...
#ifndef ORTOOLS_LP_DATA_SPARSE_COLUMN_H_
#define ORTOOLS_LP_DATA_SPARSE_COLUMN_H_
...
class SparseColumn : public SparseVector<RowIndex, SparseColumnIterator> {
 ...
 public:
  ...
  using SparseVector<RowIndex, SparseColumnIterator>::MutableCoefficient;
...
#endif  // ORTOOLS_LP_DATA_SPARSE_COLUMN_H_
