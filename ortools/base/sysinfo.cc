...
#include <mach/task.h>
#elif (defined(__FreeBSD__) || defined(__NetBSD__) || defined(__OpenBSD__))  // [Free,Net,Open]BSD
...
#elif defined(__GNUC__) && !defined(__FreeBSD__) && !defined(__NetBSD__) && !defined(__OpenBSD__) && \
