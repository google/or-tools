...
class BindingsTest(compare.Proto2Assertions, absltest.TestCase):
    ...
    def test_export_model(self):
        ...
        self.assertProto2Equal(e.export_model(), expected)

        expected.variables.names[:] = []
        self.assertProto2Equal(e.export_model(remove_names=True), expected)
...
ElementType: variable num_elements: 1 next_id: 1
  id: 0 name: "xyz\"""",
    ...
    def test_export_model_update_has_update(self):
        ...
        self.assertProto2Equal(update, expected)
        ...
        self.assertProto2Equal(update_no_names, expected)
