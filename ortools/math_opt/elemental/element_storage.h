...
#ifndef ORTOOLS_MATH_OPT_ELEMENTAL_ELEMENT_STORAGE_H_
#define ORTOOLS_MATH_OPT_ELEMENTAL_ELEMENT_STORAGE_H_
...
#endif  // ORTOOLS_MATH_OPT_ELEMENTAL_ELEMENT_STORAGE_H_
