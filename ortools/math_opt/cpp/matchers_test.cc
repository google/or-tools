...
TEST(PrintToTest, SolveResult) {
  ...
  PrintTo(result, &oss);
  //EXPECT_THAT(
  //    absl::StrReplaceAll(oss.str(), {{"\n", ""}}),
  //    IgnoringProtoDebugStringFormat(StrEq(
  //        "{termination: {reason: feasible, limit: time, detail: \"hit "
  //        "\\\"3\\\" seconds\", problem_status: {primal_status: feasible, "
  //        "dual_status: feasible, primal_or_dual_infeasible: false}, "
  //        "objective_bounds: {primal_bound: 20, dual_bound: 10}}, "
  //        "solve_stats: {solve_time: 0, simplex_iterations: 0, "
  //        "barrier_iterations: 0, first_order_iterations: 0, node_count: 2}, "
  //        "solutions: { {primal_solution: ({variable_values: {{x, 1}}, "
  //        "objective_value: 20, feasibility_status: feasible}), "
  //        "dual_solution: ({dual_values: {{c, 2}}, quadratic_dual_values: {}, "
  //        "reduced_costs: {{x, 1}}, "
  //        "objective_value: (10), feasibility_status: feasible}), basis: "
  //        "({variable_status: {{x, at_upper_bound}}, constraint_status: {{c, "
  //        "at_lower_bound}}, basic_dual_feasibility: (feasible)})} }, "
  //        "primal_rays: { {variable_values: {{x, 2}}} }, "
  //        "dual_rays: { {dual_values: {{c, 5}}, reduced_costs: {{x, 4}}} }}")));
}
