...
absl::StatusOr<ModelSubset> ModelSubset::FromProto(
  ...
  OR_RETURN_IF_ERROR(RepeatedIdsProtoToCpp(
  ...
  OR_RETURN_IF_ERROR(BoundsMapProtoToCpp(
...
absl::Status ModelSubset::CheckModelStorage(
  ...
  OR_RETURN_IF_ERROR(validate_map_keys(variable_bounds, "variable_bounds"));
  OR_RETURN_IF_ERROR(
  ...
  OR_RETURN_IF_ERROR(validate_set_elements(second_order_cone_constraints,
