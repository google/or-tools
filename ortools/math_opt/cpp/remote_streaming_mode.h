...
#ifndef ORTOOLS_MATH_OPT_CPP_REMOTE_STREAMING_MODE_H_
#define ORTOOLS_MATH_OPT_CPP_REMOTE_STREAMING_MODE_H_
...
#endif  // ORTOOLS_MATH_OPT_CPP_REMOTE_STREAMING_MODE_H_
