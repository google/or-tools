...
def parse_objective_bounds(
  ...
  return ObjectiveBounds(
      primal_bound=proto.primal_bound, dual_bound=proto.dual_bound
  )
...
class TerminationReason(enum.Enum):
  ...
  INFEASIBLE_OR_UNBOUNDED = (
      result_pb2.TERMINATION_REASON_INFEASIBLE_OR_UNBOUNDED
  )
...
class Termination:
  ...
  def to_proto(self) -> result_pb2.TerminationProto:
    ...
    return result_pb2.TerminationProto(
        ...
        limit=(
            result_pb2.LIMIT_UNSPECIFIED
            if self.limit is None
            else self.limit.value
        ),
        detail=self.detail,
...
def parse_termination(
  ...
  termination.problem_status = parse_problem_status(
      termination_proto.problem_status
  )
...
class SolveResult:
  ...
  primal_rays: List[solution.PrimalRay] = dataclasses.field(
  ...
  def bounded(self) -> bool:
    ...
    return (
        self.termination.problem_status.primal_status
  ...
  def has_dual_feasible_solution(self) -> bool:
    ...
    return (
        ...
        and sol.dual_solution.feasibility_status
        == solution.SolutionStatus.FEASIBLE
    )
