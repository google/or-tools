...
class Model:
  ...
  def maximize_quadratic_objective(
      self, obj: variables_mod.QuadraticTypes
  ) -> None:
  ...
  def minimize_quadratic_objective(
      self, obj: variables_mod.QuadraticTypes
  ) -> None:
  ...
  def delete_auxiliary_objective(
  ...
  def num_auxiliary_objectives(self) -> int:
    ...
    return self._elemental.get_num_elements(
        enums.ElementType.AUXILIARY_OBJECTIVE
    )
  ...
  def add_linear_constraint(
    ...
    result = linear_constraints_mod.LinearConstraint(
        self._elemental, lin_con_id
    )
  ...
  def get_next_linear_constraint_id(self) -> int:
    ...
    return self._elemental.get_next_element_id(
        enums.ElementType.LINEAR_CONSTRAINT
    )
  ...
  def linear_constraints(
    ...
    lin_con_ids = self._elemental.get_elements(
        enums.ElementType.LINEAR_CONSTRAINT
    )
    lin_con_ids.sort()
  ...
  def add_indicator_constraint(
    ...
    return indicator_constraints.IndicatorConstraint(
        self._elemental, ind_con_id
    )
