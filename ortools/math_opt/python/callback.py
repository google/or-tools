...
class CallbackData:
  ...
  presolve_stats: PresolveStats = dataclasses.field(
      default_factory=PresolveStats
  )
...
class CallbackRegistration:
  ...
  def to_proto(self) -> callback_pb2.CallbackRegistrationProto:
    ...
    result.request_registration[:] = sorted(
...
class GeneratedConstraint:
  ...
  terms: Mapping[variables.Variable, float] = dataclasses.field(
...
class CallbackResult:
  ...
  suggested_solutions: List[Mapping[variables.Variable, float]] = (
