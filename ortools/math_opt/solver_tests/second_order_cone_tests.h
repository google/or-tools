...
#ifndef OR_TOOLS_MATH_OPT_SOLVER_TESTS_SECOND_ORDER_CONE_TESTS_H_
#define OR_TOOLS_MATH_OPT_SOLVER_TESTS_SECOND_ORDER_CONE_TESTS_H_
...
#endif  // OR_TOOLS_MATH_OPT_SOLVER_TESTS_SECOND_ORDER_CONE_TESTS_H_
