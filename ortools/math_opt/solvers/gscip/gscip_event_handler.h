...
#ifndef ORTOOLS_MATH_OPT_SOLVERS_GSCIP_GSCIP_EVENT_HANDLER_H_
#define ORTOOLS_MATH_OPT_SOLVERS_GSCIP_GSCIP_EVENT_HANDLER_H_
...
#endif  // ORTOOLS_MATH_OPT_SOLVERS_GSCIP_GSCIP_EVENT_HANDLER_H_
