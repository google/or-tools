...
#ifndef ORTOOLS_MATH_OPT_SOLVERS_GUROBI_INIT_ARGUMENTS_H_
#define ORTOOLS_MATH_OPT_SOLVERS_GUROBI_INIT_ARGUMENTS_H_
...
#endif  // ORTOOLS_MATH_OPT_SOLVERS_GUROBI_INIT_ARGUMENTS_H_
