...
#ifndef ORTOOLS_MATH_OPT_VALIDATORS_IDS_VALIDATOR_H_
#define ORTOOLS_MATH_OPT_VALIDATORS_IDS_VALIDATOR_H_
...
#endif  // ORTOOLS_MATH_OPT_VALIDATORS_IDS_VALIDATOR_H_
