...
#ifndef ORTOOLS_MATH_OPT_CORE_SPARSE_COLLECTION_MATCHERS_H_
#define ORTOOLS_MATH_OPT_CORE_SPARSE_COLLECTION_MATCHERS_H_
...
#endif  // ORTOOLS_MATH_OPT_CORE_SPARSE_COLLECTION_MATCHERS_H_
