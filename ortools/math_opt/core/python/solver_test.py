...
def _solve_model(
    ...
    *,
    ...
    user_cb: Optional[
        Callable[
            [callback_pb2.CallbackDataProto], callback_pb2.CallbackResultProto
        ]
    ] = None,
...
class PybindSolverTest(parameterized.TestCase):
  ...
  def test_valid_solve(self, use_solver_class: bool) -> None:
    ...
    self.assertAlmostEqual(
        result.solutions[0].primal_solution.objective_value, 2.0
    )
  ...
  def test_solve_interrupter_interrupts_solve(
      self, use_solver_class: bool
  ) -> None:
    model = _build_simple_model()
  ...
  def test_solution_hint_is_used(self, use_solver_class: bool) -> None:
    ...
    self.assertTrue(result.solutions)
    self.assertAlmostEqual(
        result.solutions[0].primal_solution.objective_value, 1.0
    )
