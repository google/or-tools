...
// clang-format off
OR_DLL extern std::function<int(XPRSprob* p_prob)> XPRScreateprob;
OR_DLL extern std::function<int(XPRSprob prob)> XPRSdestroyprob;
OR_DLL extern std::function<int(const char* path)> XPRSinit;
OR_DLL extern std::function<int(void)> XPRSfree;
OR_DLL extern std::function<int(char* buffer, int maxbytes)> XPRSgetlicerrmsg;
OR_DLL extern std::function<int(int* p_i, char* p_c)> XPRSlicense;
OR_DLL extern std::function<int(char* banner)> XPRSgetbanner;
OR_DLL extern std::function<int(char* version)> XPRSgetversion;
OR_DLL extern std::function<int(int *p_major, int *p_minor, int *p_build)> XPRSgetversionnumbers;
OR_DLL extern std::function<int(XPRSprob prob, const char* probname)> XPRSsetprobname;
OR_DLL extern std::function<int(XPRSprob prob, int control)> XPRSsetdefaultcontrol;
OR_DLL extern std::function<int(XPRSprob prob, int reason)> XPRSinterrupt;
OR_DLL extern std::function<int(XPRSprob prob, int control, int value)> XPRSsetintcontrol;
OR_DLL extern std::function<int(XPRSprob prob, int control, XPRSint64 value)> XPRSsetintcontrol64;
OR_DLL extern std::function<int(XPRSprob prob, int control, double value)> XPRSsetdblcontrol;
OR_DLL extern std::function<int(XPRSprob prob, int control, const char* value)> XPRSsetstrcontrol;
OR_DLL extern std::function<int(XPRSprob prob, int objidx, int control, int value)> XPRSsetobjintcontrol;
OR_DLL extern std::function<int(XPRSprob prob, int objidx, int control, double value)> XPRSsetobjdblcontrol;
...
OR_DLL extern std::function<int(XPRSprob prob, int attrib, XPRSint64* p_value)> XPRSgetintattrib64;
...
OR_DLL extern std::function<int(XPRSprob prob, int objidx, int attrib, double* p_value)> XPRSgetobjdblattrib;
OR_DLL extern std::function<int(XPRSprob prob, int objidx, const double solution[], double* p_objval)> XPRScalcobjn;
OR_DLL extern std::function<int(XPRSprob prob, const char* name, int* p_id, int* p_type)> XPRSgetcontrolinfo;
...
OR_DLL extern std::function<int(XPRSprob prob, int* status, double x[], int first, int last)> XPRSgetsolution;
OR_DLL extern std::function<int(XPRSprob prob, int* status, double duals[], int first, int last)> XPRSgetduals;
OR_DLL extern std::function<int(XPRSprob prob, int* status, double djs[], int first, int last)> XPRSgetredcosts;
OR_DLL extern std::function<int(XPRSprob prob, int* status, double x[], int first, int last)> XPRSgetcallbacksolution;
OR_DLL extern std::function<int(XPRSprob prob, int nrows, int ncoefs, const char rowtype[], const double rhs[], const double rng[], const int start[], const int colind[], const double rowcoef[])> XPRSaddrows;
OR_DLL extern std::function<int(XPRSprob prob, int nrows, int ncoefs, const char rowtype[], const double rhs[], const double rng[], const XPRSint64 start[], const int colind[], const double rowcoef[])> XPRSaddrows64;
OR_DLL extern std::function<int(XPRSprob prob, int nrows, const int rowind[])> XPRSdelrows;
OR_DLL extern std::function<int(XPRSprob prob, int ncols, int ncoefs, const double objcoef[], const int start[], const int rowind[], const double rowcoef[], const double lb[], const double ub[])> XPRSaddcols;
OR_DLL extern std::function<int(XPRSprob prob, int ncols, const int colind[], const double objcoef[], int priority, double weight)> XPRSaddobj;
OR_DLL extern std::function<int(XPRSprob prob, int row, int ncoefs, const int rowqcol1[], int const rowqcol2[], const double rowqcoef[])> XPRSaddqmatrix64;
OR_DLL extern std::function<int(XPRSprob prob, int type, const char names[], int first, int last)> XPRSaddnames;
OR_DLL extern std::function<int(XPRSprob prob, int type, char names[], int first, int last)>  XPRSgetnames;
OR_DLL extern std::function<int(XPRSprob prob, int ncols, const int colind[])> XPRSdelcols;
OR_DLL extern std::function<int(XPRSprob prob, int nsets, XPRSint64 nelems, const char settype[], const XPRSint64 start[], const int colind[], const double refval[])> XPRSaddsets64;
OR_DLL extern std::function<int(XPRSprob prob, int globalvalid, int ncuts, const char rowtype[], const double rhs[], const XPRSint64 start[], const int colind[], const double cutcoef[])> XPRSaddmanagedcuts64;
OR_DLL extern std::function<int(XPRSprob prob, int ncuts, const int cuttype[], const char rowtype[], const double rhs[], const XPRSint64 start[], const int colind[], const double cutcoef[])> XPRSaddcuts64;
OR_DLL extern std::function<int(XPRSprob prob, int ncols, const int colind[], const char coltype[])> XPRSchgcoltype;
OR_DLL extern std::function<int(XPRSprob prob, const int rowstat[], const int colstat[])> XPRSloadbasis;
OR_DLL extern std::function<int(XPRSprob prob)> XPRSpostsolve;
OR_DLL extern std::function<int(XPRSprob prob, int objsense)> XPRSchgobjsense;
OR_DLL extern std::function<int(XPRSprob prob, char* errmsg)> XPRSgetlasterror;
OR_DLL extern std::function<int(XPRSprob prob, int rowstat[], int colstat[])> XPRSgetbasis;
OR_DLL extern std::function<int(XPRSprob prob, const char* filename, const char* flags)> XPRSwriteprob;
OR_DLL extern std::function<int(XPRSprob prob, const char* filename)> XPRSsaveas;
...
OR_DLL extern std::function<int(XPRSprob prob, int nbounds, const int colind[], const char bndtype[], const double bndval[])> XPRSchgbounds;
OR_DLL extern std::function<int(XPRSprob prob, int length, const double solval[], const int colind[], const char* name)> XPRSaddmipsol;
OR_DLL extern std::function<int(XPRSprob prob, int nrows, const int rowind[])> XPRSloaddelayedrows;
OR_DLL extern std::function<int(XPRSprob prob, int nrows, const int rowind[], const int colind[], const int complement[])> XPRSsetindicators;
OR_DLL extern std::function<int(XPRSprob prob, int ndirs, const int colind[], const int priority[], const char dir[], const double uppseudo[], const double downpseudo[])> XPRSloaddirs;
OR_DLL extern std::function<int(XPRSprob prob, double x[], double slack[], double duals[], double djs[])> XPRSgetlpsol;
OR_DLL extern std::function<int(XPRSprob prob, double x[], double slack[])> XPRSgetmipsol;
OR_DLL extern std::function<int(XPRSprob prob, int ncols, const int colind[], const double objcoef[])> XPRSchgobj;
OR_DLL extern std::function<int(XPRSprob prob, int row, int col, double coef)> XPRSchgcoef;
OR_DLL extern std::function<int(XPRSprob prob, int ncoefs, const int rowind[], const int colind[], const double rowcoef[])> XPRSchgmcoef;
OR_DLL extern std::function<int(XPRSprob prob, XPRSint64 ncoefs, const int rowind[], const int colind[], const double rowcoef[])> XPRSchgmcoef64;
OR_DLL extern std::function<int(XPRSprob prob, int ncoefs, const int objqcol1[], const int objqcol2[], const double objqcoef[])> XPRSchgmqobj;
OR_DLL extern std::function<int(XPRSprob prob, int nrows, const int rowind[], const double rhs[])> XPRSchgrhs;
OR_DLL extern std::function<int(XPRSprob prob, int nrows, const int rowind[], const double rng[])> XPRSchgrhsrange;
OR_DLL extern std::function<int(XPRSprob prob, int nrows, const int rowind[], const char rowtype[])> XPRSchgrowtype;
OR_DLL extern std::function<int(XPRSprob prob, int objidx)> XPRSdelobj;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *f_intsol)(XPRSprob cbprob, void* cbdata), void* p, int priority)> XPRSaddcbintsol;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *f_intsol)(XPRSprob cbprob, void* cbdata), void* p)> XPRSremovecbintsol;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *f_message)(XPRSprob cbprob, void* cbdata, const char* msg, int msglen, int msgtype), void* p, int priority)> XPRSaddcbmessage;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *f_message)(XPRSprob cbprob, void* cbdata, const char* msg, int msglen, int msgtype), void* p)> XPRSremovecbmessage;
OR_DLL extern std::function<int(XPRSprob prob, int (XPRS_CC *f_checktime)(XPRSprob cbprob, void* cbdata), void* p, int priority)> XPRSaddcbchecktime;
OR_DLL extern std::function<int(XPRSprob prob, int (XPRS_CC *f_checktime)(XPRSprob cbprob, void* cbdata), void* p)> XPRSremovecbchecktime;
OR_DLL extern std::function<int(XPRSprob prob, int (XPRS_CC *barlog)(XPRSprob cbprob, void* cbdata), void* data, int priority)> XPRSaddcbbarlog;
OR_DLL extern std::function<int(XPRSprob prob, int (XPRS_CC *barlog)(XPRSprob cbprob, void* cbdata), void* data)> XPRSremovecbbarlog;
OR_DLL extern std::function<int(XPRSprob prob, int (XPRS_CC *lplog)(XPRSprob cbprob, void* cbdata), void* data, int priority)> XPRSaddcblplog;
OR_DLL extern std::function<int(XPRSprob prob, int (XPRS_CC *lplog)(XPRSprob cbprob, void* cbdata), void* data)> XPRSremovecblplog;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *presolve)(XPRSprob cbprob, void* cbdata), void* data, int priority)> XPRSaddcbpresolve;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *presolve)(XPRSprob cbprob, void* cbdata), void* data)> XPRSremovecbpresolve;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *prenode)(XPRSprob cbprob, void* cbdata, int* p_infeasible), void* data, int priority)>XPRSaddcbprenode;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *prenode)(XPRSprob cbprob, void* cbdata, int* p_infeasible), void* data)> XPRSremovecbprenode;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *preintsol)(XPRSprob cbprob, void* cbdata, int soltype, int* p_reject, double* p_cutoff), void* data, int priority)> XPRSaddcbpreintsol;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *preintsol)(XPRSprob cbprob, void* cbdata, int soltype, int* p_reject, double* p_cutoff), void* data)> XPRSremovecbpreintsol;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *optnode)(XPRSprob cbprob, void* cbdata, int* p_infeasible), void* data, int priority)> XPRSaddcboptnode;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *optnode)(XPRSprob cbprob, void* cbdata, int* p_infeasible), void* data)> XPRSremovecboptnode;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *cutround)(XPRSprob cbprob, void* cbdata, int ifxpresscuts, int* p_action), void* data, int priority)> XPRSaddcbcutround;
OR_DLL extern std::function<int(XPRSprob prob, void (XPRS_CC *cutround)(XPRSprob cbprob, void* cbdata, int ifxpresscuts, int* p_action), void* data)> XPRSremovecbcutround;
OR_DLL extern std::function<int(XPRSprob prob, const char* flags)> XPRSlpoptimize;
OR_DLL extern std::function<int(XPRSprob prob, const char* flags)> XPRSmipoptimize;
OR_DLL extern std::function<int(XPRSprob prob, const char* flags, int* solvestatus, int* solstatus)> XPRSoptimize;
OR_DLL extern std::function<int(XPRSprob prob, char rowtype, int norigcoefs, const int origcolind[], const double origrowcoef[], double origrhs, int maxcoefs, int* p_ncoefs, int colind[], double rowcoef[], double* p_rhs, int* p_status)> XPRSpresolverow;
// clang-format on
