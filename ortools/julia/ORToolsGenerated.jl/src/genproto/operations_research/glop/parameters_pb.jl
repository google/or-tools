...
# original file: ortools/glop/parameters.proto (proto2 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GlopParameters}, _endpos::Int=0, _group::Bool=false)
