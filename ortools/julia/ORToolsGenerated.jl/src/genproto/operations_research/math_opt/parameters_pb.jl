...
# original file: ortools/math_opt/parameters.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:StrictnessProto}, _endpos::Int=0, _group::Bool=false)
    bad_parameter = false
...
struct SolverInitializerProto
    ...
    xpress::Union{Nothing,XpressInitializerProto}
end
PB.reserved_fields(::Type{SolverInitializerProto}) = (names = String[], numbers = Union{Int,UnitRange{Int}}[2])
PB.default_values(::Type{SolverInitializerProto}) = (;gurobi = nothing, xpress = nothing)
PB.field_numbers(::Type{SolverInitializerProto}) = (;gurobi = 1, xpress = 3)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SolverInitializerProto}, _endpos::Int=0, _group::Bool=false)
    gurobi = Ref{Union{Nothing,GurobiInitializerProto}}(nothing)
    xpress = Ref{Union{Nothing,XpressInitializerProto}}(nothing)
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            PB.decode!(d, gurobi)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SolveParametersProto}, _endpos::Int=0, _group::Bool=false)
    ...
    xpress = Ref{Union{Nothing,XpressParametersProto}}(nothing)
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
function PB.encode(e::PB.AbstractProtoEncoder, x::SolveParametersProto)
    ...
    !isnothing(x.xpress) && PB.encode(e, 28, x.xpress)
    return position(e.io) - initpos
end
function PB._encoded_size(x::SolveParametersProto)
    ...
    !isnothing(x.xpress) && (encoded_size += PB._encoded_size(x.xpress, 28))
    return encoded_size
end
