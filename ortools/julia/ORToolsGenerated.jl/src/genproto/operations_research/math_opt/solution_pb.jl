...
# original file: ortools/math_opt/solution.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:PrimalRayProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DualRayProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:PrimalSolutionProto}, _endpos::Int=0, _group::Bool=false)
    variable_values = Ref{Union{Nothing,SparseDoubleVectorProto}}(nothing)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DualSolutionProto}, _endpos::Int=0, _group::Bool=false)
    dual_values = Ref{Union{Nothing,SparseDoubleVectorProto}}(nothing)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SparseBasisStatusVector}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:BasisProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SolutionProto}, _endpos::Int=0, _group::Bool=false)
