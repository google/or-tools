...
# original file: ortools/math_opt/solvers/osqp.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:OsqpSettingsProto}, _endpos::Int=0, _group::Bool=false)
    rho = zero(Float64)
    sigma = zero(Float64)
    scaling = zero(Int64)
    adaptive_rho = false
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:OsqpOutput}, _endpos::Int=0, _group::Bool=false)
