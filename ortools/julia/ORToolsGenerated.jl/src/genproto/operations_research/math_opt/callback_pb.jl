...
# original file: ortools/math_opt/callback.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CallbackDataProto.PresolveStats"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CallbackResultProto.GeneratedLinearConstraint"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CallbackDataProto.MipStats"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CallbackDataProto.BarrierStats"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"CallbackDataProto.SimplexStats"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CallbackResultProto}, _endpos::Int=0, _group::Bool=false)
    terminate = false
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CallbackRegistrationProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CallbackDataProto}, _endpos::Int=0, _group::Bool=false)
