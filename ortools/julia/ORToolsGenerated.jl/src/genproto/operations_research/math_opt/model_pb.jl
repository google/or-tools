...
# original file: ortools/math_opt/model.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:QuadraticConstraintProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:LinearConstraintsProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SecondOrderConeConstraintProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:IndicatorConstraintProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:VariablesProto}, _endpos::Int=0, _group::Bool=false)
    ids = PB.BufferedVector{Int64}()
    lower_bounds = PB.BufferedVector{Float64}()
    upper_bounds = PB.BufferedVector{Float64}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SosConstraintProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ObjectiveProto}, _endpos::Int=0, _group::Bool=false)
    maximize = false
    offset = zero(Float64)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ModelProto}, _endpos::Int=0, _group::Bool=false)
    name = ""
