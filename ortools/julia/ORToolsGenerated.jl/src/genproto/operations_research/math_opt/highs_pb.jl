...
# original file: ortools/math_opt/solvers/highs.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:HighsOptionsProto}, _endpos::Int=0, _group::Bool=false)
    string_options = Dict{String,String}()
    double_options = Dict{String,Float64}()
    int_options = Dict{String,Int32}()
    bool_options = Dict{String,Bool}()
