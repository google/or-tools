...
# original file: ortools/math_opt/solvers/gurobi.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"GurobiParametersProto.Parameter"}, _endpos::Int=0, _group::Bool=false)
    name = ""
    value = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"GurobiInitializerProto.ISVKey"}, _endpos::Int=0, _group::Bool=false)
    name = ""
    application_name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GurobiParametersProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GurobiInitializerProto}, _endpos::Int=0, _group::Bool=false)
