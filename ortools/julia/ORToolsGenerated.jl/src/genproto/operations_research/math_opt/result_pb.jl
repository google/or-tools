# Autogenerated using ProtoBuf.jl v1.0.14 on 2024-01-02T18:44:47.229
# original file: /usr/local/google/home/tcuvelier/.julia/artifacts/cc3d5aa28fb2158ce4ff5aed9899545a37503a6b/include/ortools/math_opt/result.proto (proto3 syntax)
...
struct SolveResultProto
    ...
    solver_specific_output::Union{Nothing,OneOf{<:Union{operations_research.GScipOutput,var"SolveResultProto.PdlpOutput"}}}
end
PB.reserved_fields(::Type{SolveResultProto}) = (names = String[], numbers = Union{Int,UnitRange{Int}}[8, 1])
PB.oneof_field_types(::Type{SolveResultProto}) = (;
    solver_specific_output = (;gscip_output=operations_research.GScipOutput, pdlp_output=var"SolveResultProto.PdlpOutput"),
)
PB.default_values(::Type{SolveResultProto}) = (;termination = nothing, solutions = Vector{SolutionProto}(), primal_rays = Vector{PrimalRayProto}(), dual_rays = Vector{DualRayProto}(), solve_stats = nothing, gscip_output = nothing, pdlp_output = nothing)
PB.field_numbers(::Type{SolveResultProto}) = (;termination = 2, solutions = 3, primal_rays = 4, dual_rays = 5, solve_stats = 6, gscip_output = 7, pdlp_output = 9)
