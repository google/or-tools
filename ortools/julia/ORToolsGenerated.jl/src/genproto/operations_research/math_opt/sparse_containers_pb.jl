...
# original file: ortools/math_opt/sparse_containers.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SparseDoubleVectorProto}, _endpos::Int=0, _group::Bool=false)
    ids = PB.BufferedVector{Int64}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SparseInt32VectorProto}, _endpos::Int=0, _group::Bool=false)
    ids = PB.BufferedVector{Int64}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SparseBoolVectorProto}, _endpos::Int=0, _group::Bool=false)
    ids = PB.BufferedVector{Int64}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SparseVectorFilterProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SparseDoubleMatrixProto}, _endpos::Int=0, _group::Bool=false)
