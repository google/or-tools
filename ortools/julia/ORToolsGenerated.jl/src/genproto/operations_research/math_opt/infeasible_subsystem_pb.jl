...
# original file: ortools/math_opt/infeasible_subsystem.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"ModelSubsetProto.Bounds"}, _endpos::Int=0, _group::Bool=false)
    lower = false
    upper = false
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ModelSubsetProto}, _endpos::Int=0, _group::Bool=false)
    variable_bounds = Dict{Int64,var"ModelSubsetProto.Bounds"}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ComputeInfeasibleSubsystemResultProto}, _endpos::Int=0, _group::Bool=false)
