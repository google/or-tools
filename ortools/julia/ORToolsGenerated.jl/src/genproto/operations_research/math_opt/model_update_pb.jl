...
# original file: ortools/math_opt/model_update.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:LinearConstraintUpdatesProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ObjectiveUpdatesProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:IndicatorConstraintUpdatesProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:VariableUpdatesProto}, _endpos::Int=0, _group::Bool=false)
    lower_bounds = Ref{Union{Nothing,SparseDoubleVectorProto}}(nothing)
    upper_bounds = Ref{Union{Nothing,SparseDoubleVectorProto}}(nothing)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SosConstraintUpdatesProto}, _endpos::Int=0, _group::Bool=false)
    deleted_constraint_ids = PB.BufferedVector{Int64}()
    new_constraints = Dict{Int64,SosConstraintProto}()
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SecondOrderConeConstraintUpdatesProto}, _endpos::Int=0, _group::Bool=false)
    deleted_constraint_ids = PB.BufferedVector{Int64}()
    new_constraints = Dict{Int64,SecondOrderConeConstraintProto}()
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:QuadraticConstraintUpdatesProto}, _endpos::Int=0, _group::Bool=false)
    deleted_constraint_ids = PB.BufferedVector{Int64}()
    new_constraints = Dict{Int64,QuadraticConstraintProto}()
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:AuxiliaryObjectivesUpdatesProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ModelUpdateProto}, _endpos::Int=0, _group::Bool=false)
