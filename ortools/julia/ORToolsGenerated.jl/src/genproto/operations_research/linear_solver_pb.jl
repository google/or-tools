...
# original file: ortools/linear_solver/linear_solver.proto (proto2 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPQuadraticObjective}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPQuadraticConstraint}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPConstraintProto}, _endpos::Int=0, _group::Bool=false)
    var_index = PB.BufferedVector{Int32}()
    coefficient = PB.BufferedVector{Float64}()
    lower_bound = Float64(-Inf)
    upper_bound = Float64(Inf)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:OptionalDouble}, _endpos::Int=0, _group::Bool=false)
    value = zero(Float64)
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPSolution}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPArrayWithConstantConstraint}, _endpos::Int=0, _group::Bool=false)
    var_index = PB.BufferedVector{Int32}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPAbsConstraint}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPSolveInfo}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPVariableProto}, _endpos::Int=0, _group::Bool=false)
    lower_bound = Float64(-Inf)
    upper_bound = Float64(Inf)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPArrayConstraint}, _endpos::Int=0, _group::Bool=false)
    var_index = PB.BufferedVector{Int32}()
    resultant_var_index = zero(Int32)
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPIndicatorConstraint}, _endpos::Int=0, _group::Bool=false)
    var_index = zero(Int32)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPSosConstraint}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPSolverCommonParameters}, _endpos::Int=0, _group::Bool=false)
...
PB.reserved_fields(::Type{MPSolutionResponse}) = (names = String[], numbers = Union{Int,UnitRange{Int}}[9])
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPSolutionResponse}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPModelDeltaProto}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"MPModelProto.Annotation"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPGeneralConstraintProto}, _endpos::Int=0, _group::Bool=false)
    name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPModelProto}, _endpos::Int=0, _group::Bool=false)
...
PB.reserved_fields(::Type{MPModelRequest}) = (names = String[], numbers = Union{Int,UnitRange{Int}}[12])
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MPModelRequest}, _endpos::Int=0, _group::Bool=false)
