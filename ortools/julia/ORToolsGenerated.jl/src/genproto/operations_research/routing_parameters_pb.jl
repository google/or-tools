...
# original file: ortools/constraint_solver/routing_parameters.proto (proto3 syntax)

import ProtoBuf as PB
using ProtoBuf: OneOf
using ProtoBuf.EnumX: @enumx

export RoutingModelParameters
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RoutingModelParameters}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"RoutingSearchParameters.LocalSearchNeighborhoodOperators"}, _endpos::Int=0, _group::Bool=false)
    ...
    use_global_cheapest_insertion_visit_types_lns = OptionalBoolean.BOOL_UNSPECIFIED
    use_local_cheapest_insertion_visit_types_lns = OptionalBoolean.BOOL_UNSPECIFIED
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
function PB.encode(e::PB.AbstractProtoEncoder, x::var"RoutingSearchParameters.LocalSearchNeighborhoodOperators")
    ...
    x.use_global_cheapest_insertion_visit_types_lns != OptionalBoolean.BOOL_UNSPECIFIED && PB.encode(e, 39, x.use_global_cheapest_insertion_visit_types_lns)
    x.use_local_cheapest_insertion_visit_types_lns != OptionalBoolean.BOOL_UNSPECIFIED && PB.encode(e, 40, x.use_local_cheapest_insertion_visit_types_lns)
    return position(e.io) - initpos
end
function PB._encoded_size(x::var"RoutingSearchParameters.LocalSearchNeighborhoodOperators")
    ...
    x.use_global_cheapest_insertion_visit_types_lns != OptionalBoolean.BOOL_UNSPECIFIED && (encoded_size += PB._encoded_size(x.use_global_cheapest_insertion_visit_types_lns, 39))
    x.use_local_cheapest_insertion_visit_types_lns != OptionalBoolean.BOOL_UNSPECIFIED && (encoded_size += PB._encoded_size(x.use_local_cheapest_insertion_visit_types_lns, 40))
    return encoded_size
end
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"RoutingSearchParameters.ImprovementSearchLimitParameters"}, _endpos::Int=0, _group::Bool=false)
...
struct RoutingSearchParameters
    ...
    savings_parameters::Union{Nothing,SavingsParameters}
    global_cheapest_insertion_first_solution_parameters::Union{Nothing,GlobalCheapestInsertionParameters}
    global_cheapest_insertion_ls_operator_parameters::Union{Nothing,GlobalCheapestInsertionParameters}
    local_cheapest_insertion_parameters::Union{Nothing,LocalCheapestInsertionParameters}
    local_cheapest_cost_insertion_parameters::Union{Nothing,LocalCheapestInsertionParameters}
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RoutingSearchParameters}, _endpos::Int=0, _group::Bool=false)
    ...
    while !PB.message_done(d, _endpos, _group)
        ...
        elseif field_number == 70
            PB.decode!(d, savings_parameters)
        elseif field_number == 71
            PB.decode!(d, global_cheapest_insertion_first_solution_parameters)
        elseif field_number == 72
            PB.decode!(d, global_cheapest_insertion_ls_operator_parameters)
        elseif field_number == 68
            PB.decode!(d, local_cheapest_insertion_parameters)
        elseif field_number == 69
            PB.decode!(d, local_cheapest_cost_insertion_parameters)
        elseif field_number == 30
...
function PB.encode(e::PB.AbstractProtoEncoder, x::RoutingSearchParameters)
    ...
    !isnothing(x.savings_parameters) && PB.encode(e, 70, x.savings_parameters)
    !isnothing(x.global_cheapest_insertion_first_solution_parameters) && PB.encode(e, 71, x.global_cheapest_insertion_first_solution_parameters)
    !isnothing(x.global_cheapest_insertion_ls_operator_parameters) && PB.encode(e, 72, x.global_cheapest_insertion_ls_operator_parameters)
    !isnothing(x.local_cheapest_insertion_parameters) && PB.encode(e, 68, x.local_cheapest_insertion_parameters)
    !isnothing(x.local_cheapest_cost_insertion_parameters) && PB.encode(e, 69, x.local_cheapest_cost_insertion_parameters)
...
function PB._encoded_size(x::RoutingSearchParameters)
    ...
    !isnothing(x.savings_parameters) && (encoded_size += PB._encoded_size(x.savings_parameters, 70))
    !isnothing(x.global_cheapest_insertion_first_solution_parameters) && (encoded_size += PB._encoded_size(x.global_cheapest_insertion_first_solution_parameters, 71))
    !isnothing(x.global_cheapest_insertion_ls_operator_parameters) && (encoded_size += PB._encoded_size(x.global_cheapest_insertion_ls_operator_parameters, 72))
    !isnothing(x.local_cheapest_insertion_parameters) && (encoded_size += PB._encoded_size(x.local_cheapest_insertion_parameters, 68))
    !isnothing(x.local_cheapest_cost_insertion_parameters) && (encoded_size += PB._encoded_size(x.local_cheapest_cost_insertion_parameters, 69))
