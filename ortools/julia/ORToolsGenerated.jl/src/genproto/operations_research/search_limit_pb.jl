...
# original file: ortools/constraint_solver/search_limit.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RegularLimitParameters}, _endpos::Int=0, _group::Bool=false)
    time = zero(Int64)
    branches = zero(Int64)
    failures = zero(Int64)
