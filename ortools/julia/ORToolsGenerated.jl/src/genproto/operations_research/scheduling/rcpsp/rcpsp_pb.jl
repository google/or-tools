...
# original file: ortools/scheduling/rcpsp/rcpsp.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:PerRecipeDelays}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Recipe}, _endpos::Int=0, _group::Bool=false)
    duration = zero(Int32)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RcpspAssignment}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:PerSuccessorDelays}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RcpspProblem}, _endpos::Int=0, _group::Bool=false)
