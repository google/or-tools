...
# original file: ortools/constraint_solver/solver_parameters.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ConstraintSolverParameters}, _endpos::Int=0, _group::Bool=false)
