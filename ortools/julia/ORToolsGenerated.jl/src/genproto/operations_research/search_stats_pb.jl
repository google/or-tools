# Autogenerated using ProtoBuf.jl v1.0.14 on 2024-01-02T18:44:46.670
# original file: /usr/local/google/home/tcuvelier/.julia/artifacts/cc3d5aa28fb2158ce4ff5aed9899545a37503a6b/include/ortools/constraint_solver/search_stats.proto (proto3 syntax)
...
PB.default_values(::Type{var"LocalSearchStatistics.LocalSearchOperatorStatistics"}) = (;local_search_operator = "", num_neighbors = zero(Int64), num_filtered_neighbors = zero(Int64), num_accepted_neighbors = zero(Int64), duration_seconds = zero(Float64))
PB.field_numbers(::Type{var"LocalSearchStatistics.LocalSearchOperatorStatistics"}) = (;local_search_operator = 1, num_neighbors = 2, num_filtered_neighbors = 3, num_accepted_neighbors = 4, duration_seconds = 5)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"LocalSearchStatistics.LocalSearchOperatorStatistics"})
    ...
    return var"LocalSearchStatistics.LocalSearchOperatorStatistics"(local_search_operator, num_neighbors, num_filtered_neighbors, num_accepted_neighbors, duration_seconds)
end
...
struct SearchStatistics
    local_search_statistics::Union{Nothing,LocalSearchStatistics}
    constraint_solver_statistics::Union{Nothing,ConstraintSolverStatistics}
end
PB.default_values(::Type{SearchStatistics}) = (;local_search_statistics = nothing, constraint_solver_statistics = nothing)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SearchStatistics})
    local_search_statistics = Ref{Union{Nothing,LocalSearchStatistics}}(nothing)
    constraint_solver_statistics = Ref{Union{Nothing,ConstraintSolverStatistics}}(nothing)
    while !PB.message_done(d)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
...
function PB.encode(e::PB.AbstractProtoEncoder, x::SearchStatistics)
    initpos = position(e.io)
    !isnothing(x.local_search_statistics) && PB.encode(e, 1, x.local_search_statistics)
    !isnothing(x.constraint_solver_statistics) && PB.encode(e, 2, x.constraint_solver_statistics)
    return position(e.io) - initpos
end
function PB._encoded_size(x::SearchStatistics)
    encoded_size = 0
    !isnothing(x.local_search_statistics) && (encoded_size += PB._encoded_size(x.local_search_statistics, 1))
    !isnothing(x.constraint_solver_statistics) && (encoded_size += PB._encoded_size(x.constraint_solver_statistics, 2))
    return encoded_size
end
