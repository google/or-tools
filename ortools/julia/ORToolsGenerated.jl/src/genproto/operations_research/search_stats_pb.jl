...
# original file: ortools/constraint_solver/search_stats.proto (proto3 syntax)

import ProtoBuf as PB
using ProtoBuf: OneOf
using ProtoBuf.EnumX: @enumx

export var"LocalSearchStatistics.FirstSolutionStatistics", SubSolverStatistics
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"LocalSearchStatistics.FirstSolutionStatistics"}, _endpos::Int=0, _group::Bool=false)
    strategy = ""
...
struct SubSolverStatistics
    num_glop_calls_in_lp_scheduling::Int64
    num_cp_sat_calls_in_lp_scheduling::Int64
    num_min_cost_flow_calls::Int64
end
PB.default_values(::Type{SubSolverStatistics}) = (;num_glop_calls_in_lp_scheduling = zero(Int64), num_cp_sat_calls_in_lp_scheduling = zero(Int64), num_min_cost_flow_calls = zero(Int64))
PB.field_numbers(::Type{SubSolverStatistics}) = (;num_glop_calls_in_lp_scheduling = 1, num_cp_sat_calls_in_lp_scheduling = 2, num_min_cost_flow_calls = 3)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SubSolverStatistics}, _endpos::Int=0, _group::Bool=false)
    num_glop_calls_in_lp_scheduling = zero(Int64)
    num_cp_sat_calls_in_lp_scheduling = zero(Int64)
    num_min_cost_flow_calls = zero(Int64)
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            num_glop_calls_in_lp_scheduling = PB.decode(d, Int64)
        elseif field_number == 2
            num_cp_sat_calls_in_lp_scheduling = PB.decode(d, Int64)
        elseif field_number == 3
            num_min_cost_flow_calls = PB.decode(d, Int64)
        else
            Base.skip(d, wire_type)
        end
    end
    return SubSolverStatistics(num_glop_calls_in_lp_scheduling, num_cp_sat_calls_in_lp_scheduling, num_min_cost_flow_calls)
end

function PB.encode(e::PB.AbstractProtoEncoder, x::SubSolverStatistics)
    initpos = position(e.io)
    x.num_glop_calls_in_lp_scheduling != zero(Int64) && PB.encode(e, 1, x.num_glop_calls_in_lp_scheduling)
    x.num_cp_sat_calls_in_lp_scheduling != zero(Int64) && PB.encode(e, 2, x.num_cp_sat_calls_in_lp_scheduling)
    x.num_min_cost_flow_calls != zero(Int64) && PB.encode(e, 3, x.num_min_cost_flow_calls)
    return position(e.io) - initpos
end
function PB._encoded_size(x::SubSolverStatistics)
    encoded_size = 0
    x.num_glop_calls_in_lp_scheduling != zero(Int64) && (encoded_size += PB._encoded_size(x.num_glop_calls_in_lp_scheduling, 1))
    x.num_cp_sat_calls_in_lp_scheduling != zero(Int64) && (encoded_size += PB._encoded_size(x.num_cp_sat_calls_in_lp_scheduling, 2))
    x.num_min_cost_flow_calls != zero(Int64) && (encoded_size += PB._encoded_size(x.num_min_cost_flow_calls, 3))
    return encoded_size
end
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"LocalSearchStatistics.LocalSearchFilterStatistics"}, _endpos::Int=0, _group::Bool=false)
    local_search_filter = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ConstraintSolverStatistics}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"LocalSearchStatistics.LocalSearchOperatorStatistics"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:LocalSearchStatistics}, _endpos::Int=0, _group::Bool=false)
...
struct SearchStatistics
    ...
    sub_solver_statistics::Vector{SubSolverStatistics}
end
PB.default_values(::Type{SearchStatistics}) = (;local_search_statistics = Vector{LocalSearchStatistics}(), constraint_solver_statistics = Vector{ConstraintSolverStatistics}(), sub_solver_statistics = Vector{SubSolverStatistics}())
PB.field_numbers(::Type{SearchStatistics}) = (;local_search_statistics = 1, constraint_solver_statistics = 2, sub_solver_statistics = 3)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SearchStatistics}, _endpos::Int=0, _group::Bool=false)
    ...
    sub_solver_statistics = PB.BufferedVector{SubSolverStatistics}()
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
        ...
        elseif field_number == 3
            PB.decode!(d, sub_solver_statistics)
        else
            Base.skip(d, wire_type)
        end
    end
    return SearchStatistics(local_search_statistics[], constraint_solver_statistics[], sub_solver_statistics[])
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::SearchStatistics)
    ...
    !isempty(x.sub_solver_statistics) && PB.encode(e, 3, x.sub_solver_statistics)
    return position(e.io) - initpos
end
function PB._encoded_size(x::SearchStatistics)
    ...
    !isempty(x.sub_solver_statistics) && (encoded_size += PB._encoded_size(x.sub_solver_statistics, 3))
    return encoded_size
end
