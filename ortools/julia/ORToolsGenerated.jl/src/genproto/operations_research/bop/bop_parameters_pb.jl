...
# original file: ortools/bop/bop_parameters.proto (proto2 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:BopOptimizerMethod}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:BopSolverOptimizerSet}, _endpos::Int=0, _group::Bool=false)
