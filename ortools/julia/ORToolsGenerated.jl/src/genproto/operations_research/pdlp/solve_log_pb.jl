...
# original file: ortools/pdlp/solve_log.proto (proto2 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:QuadraticProgramStats}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:PointMetadata}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:InfeasibilityInformation}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ConvergenceInformation}, _endpos::Int=0, _group::Bool=false)
    candidate_type = PointType.POINT_TYPE_UNSPECIFIED
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:IterationStats}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:FeasibilityPolishingDetails}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SolveLog}, _endpos::Int=0, _group::Bool=false)
    instance_name = ""
    params = Ref{Union{Nothing,PrimalDualHybridGradientParams}}(nothing)
    termination_reason = TerminationReason.TERMINATION_REASON_UNSPECIFIED
    termination_string = ""
