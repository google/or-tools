...
# original file: ortools/pdlp/solvers.proto (proto2 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"TerminationCriteria.SimpleOptimalityCriteria"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"PrimalDualHybridGradientParams.PresolveOptions"}, _endpos::Int=0, _group::Bool=false)
    use_glop = false
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MalitskyPockParams}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"TerminationCriteria.DetailedOptimalityCriteria"}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:AdaptiveLinesearchParams}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TerminationCriteria}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:PrimalDualHybridGradientParams}, _endpos::Int=0, _group::Bool=false)
