...
# original file: ortools/scheduling/course_scheduling.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ClassAssignment}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Course}, _endpos::Int=0, _group::Bool=false)
    display_name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:StudentAssignment}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Student}, _endpos::Int=0, _group::Bool=false)
    display_name = ""
    course_indices = PB.BufferedVector{Int32}()
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Room}, _endpos::Int=0, _group::Bool=false)
    display_name = ""
    capacity = zero(Int32)
    while !PB.message_done(d, _endpos, _group)
        field_number, wire_type = PB.decode_tag(d)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Teacher}, _endpos::Int=0, _group::Bool=false)
    display_name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CourseSchedulingResult}, _endpos::Int=0, _group::Bool=false)
    message = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CourseSchedulingModel}, _endpos::Int=0, _group::Bool=false)
    display_name = ""
