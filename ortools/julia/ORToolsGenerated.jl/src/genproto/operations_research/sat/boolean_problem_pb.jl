...
# original file: ortools/sat/boolean_problem.proto (proto2 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:BooleanAssignment}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:LinearObjective}, _endpos::Int=0, _group::Bool=false)
    literals = PB.BufferedVector{Int32}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:LinearBooleanConstraint}, _endpos::Int=0, _group::Bool=false)
    literals = PB.BufferedVector{Int32}()
    coefficients = PB.BufferedVector{Int64}()
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:LinearBooleanProblem}, _endpos::Int=0, _group::Bool=false)
    name = ""
