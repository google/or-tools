...
# original file: ortools/sat/sat_parameters.proto (proto2 syntax)
...
export var"SatParameters.VariableOrder", var"SatParameters.MaxSatAssumptionOrder"
...
@enumx var"SatParameters.ConflictMinimizationAlgorithm" NONE=0 SIMPLE=1 RECURSIVE=2
PB.reserved_fields(::Type{var"SatParameters.ConflictMinimizationAlgorithm".T}) = (names = String[], numbers = Union{Int,UnitRange{Int}}[3])
...
@enumx var"SatParameters.BinaryMinizationAlgorithm" NO_BINARY_MINIMIZATION=0 BINARY_MINIMIZATION_FROM_UIP=1 BINARY_MINIMIZATION_FROM_UIP_AND_DECISIONS=5
PB.reserved_fields(::Type{var"SatParameters.BinaryMinizationAlgorithm".T}) = (names = String[], numbers = Union{Int,UnitRange{Int}}[2, 3, 4])
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SatParameters}, _endpos::Int=0, _group::Bool=false)
    ...
    binary_minimization_algorithm = var"SatParameters.BinaryMinizationAlgorithm".BINARY_MINIMIZATION_FROM_UIP_AND_DECISIONS
    ...
    while !PB.message_done(d, _endpos, _group)
        ...
        elseif field_number == 351
            extra_subsumption_during_conflict_analysis = PB.decode(d, Bool)
        elseif field_number == 353
            decision_subsumption_during_conflict_analysis = PB.decode(d, Bool)
        elseif field_number == 343
            eagerly_subsume_last_n_conflicts = PB.decode(d, Int32)
        elseif field_number == 355
            subsume_during_vivification = PB.decode(d, Bool)
        elseif field_number == 330
            use_chronological_backtracking = PB.decode(d, Bool)
        elseif field_number == 331
            max_backjump_levels = PB.decode(d, Int32)
        elseif field_number == 332
            chronological_backtrack_min_conflicts = PB.decode(d, Int32)
        elseif field_number == 11
            clause_cleanup_period = PB.decode(d, Int32)
        elseif field_number == 337
            clause_cleanup_period_increment = PB.decode(d, Int32)
        ...
        elseif field_number == 349
            clause_cleanup_lbd_tier1 = PB.decode(d, Int32)
        elseif field_number == 350
            clause_cleanup_lbd_tier2 = PB.decode(d, Int32)
        ...
        elseif field_number == 335
            load_at_most_ones_in_sat_presolve = PB.decode(d, Bool)
        ...
        elseif field_number == 340
            max_domain_size_for_linear2_expansion = PB.decode(d, Int32)
        ...
        elseif field_number == 333
            find_clauses_that_are_exactly_one = PB.decode(d, Bool)
        ...
        elseif field_number == 342
            inprocessing_use_congruence_closure = PB.decode(d, Bool)
        elseif field_number == 354
            inprocessing_use_sat_sweeping = PB.decode(d, Bool)
        ...
        elseif field_number == 326
            share_linear2_bounds = PB.decode(d, Bool)
        ...
        elseif field_number == 344
            check_lrat_proof = PB.decode(d, Bool)
        elseif field_number == 352
            check_merged_lrat_proof = PB.decode(d, Bool)
        elseif field_number == 345
            output_lrat_proof = PB.decode(d, Bool)
        elseif field_number == 346
            check_drat_proof = PB.decode(d, Bool)
        elseif field_number == 347
            output_drat_proof = PB.decode(d, Bool)
        elseif field_number == 348
            max_drat_time_in_seconds = PB.decode(d, Float64)
        ...
        elseif field_number == 339
            debug_crash_if_lrat_check_fails = PB.decode(d, Bool)
        ...
        elseif field_number == 327
            transitive_precedences_work_limit = PB.decode(d, Int32)
        ...
        elseif field_number == 328
            shared_tree_split_min_dtime = PB.decode(d, Float64)
        ...
        elseif field_number == 329
            solution_pool_diversity_limit = PB.decode(d, Int32)
        elseif field_number == 325
            alternative_pool_size = PB.decode(d, Int32)
        ...
        elseif field_number == 336
            use_new_integer_conflict_resolution = PB.decode(d, Bool)
        elseif field_number == 341
            create_1uip_boolean_during_icr = PB.decode(d, Bool)
...
function PB.encode(e::PB.AbstractProtoEncoder, x::SatParameters)
    ...
    x.binary_minimization_algorithm != var"SatParameters.BinaryMinizationAlgorithm".BINARY_MINIMIZATION_FROM_UIP_AND_DECISIONS && PB.encode(e, 34, x.binary_minimization_algorithm)
    x.subsumption_during_conflict_analysis != true && PB.encode(e, 56, x.subsumption_during_conflict_analysis)
    x.extra_subsumption_during_conflict_analysis != true && PB.encode(e, 351, x.extra_subsumption_during_conflict_analysis)
    x.decision_subsumption_during_conflict_analysis != true && PB.encode(e, 353, x.decision_subsumption_during_conflict_analysis)
    x.eagerly_subsume_last_n_conflicts != Int32(4) && PB.encode(e, 343, x.eagerly_subsume_last_n_conflicts)
    x.subsume_during_vivification != true && PB.encode(e, 355, x.subsume_during_vivification)
    x.use_chronological_backtracking != false && PB.encode(e, 330, x.use_chronological_backtracking)
    x.max_backjump_levels != Int32(50) && PB.encode(e, 331, x.max_backjump_levels)
    x.chronological_backtrack_min_conflicts != Int32(1000) && PB.encode(e, 332, x.chronological_backtrack_min_conflicts)
    x.clause_cleanup_period != Int32(10000) && PB.encode(e, 11, x.clause_cleanup_period)
    x.clause_cleanup_period_increment != Int32(0) && PB.encode(e, 337, x.clause_cleanup_period_increment)
    ...
    x.clause_cleanup_lbd_tier1 != Int32(0) && PB.encode(e, 349, x.clause_cleanup_lbd_tier1)
    x.clause_cleanup_lbd_tier2 != Int32(0) && PB.encode(e, 350, x.clause_cleanup_lbd_tier2)
    ...
    x.load_at_most_ones_in_sat_presolve != false && PB.encode(e, 335, x.load_at_most_ones_in_sat_presolve)
    ...
    x.max_domain_size_for_linear2_expansion != Int32(8) && PB.encode(e, 340, x.max_domain_size_for_linear2_expansion)
    ...
    x.find_clauses_that_are_exactly_one != true && PB.encode(e, 333, x.find_clauses_that_are_exactly_one)
    ...
    x.inprocessing_use_congruence_closure != true && PB.encode(e, 342, x.inprocessing_use_congruence_closure)
    x.inprocessing_use_sat_sweeping != false && PB.encode(e, 354, x.inprocessing_use_sat_sweeping)
    ...
    x.share_linear2_bounds != false && PB.encode(e, 326, x.share_linear2_bounds)
    x.share_binary_clauses != true && PB.encode(e, 203, x.share_binary_clauses)
    x.share_glue_clauses != true && PB.encode(e, 285, x.share_glue_clauses)
    ...
    x.check_lrat_proof != false && PB.encode(e, 344, x.check_lrat_proof)
    x.check_merged_lrat_proof != false && PB.encode(e, 352, x.check_merged_lrat_proof)
    x.output_lrat_proof != false && PB.encode(e, 345, x.output_lrat_proof)
    x.check_drat_proof != false && PB.encode(e, 346, x.check_drat_proof)
    x.output_drat_proof != false && PB.encode(e, 347, x.output_drat_proof)
    x.max_drat_time_in_seconds !== Float64(Inf) && PB.encode(e, 348, x.max_drat_time_in_seconds)
    ...
    x.debug_crash_if_lrat_check_fails != false && PB.encode(e, 339, x.debug_crash_if_lrat_check_fails)
    ...
    x.transitive_precedences_work_limit != Int32(1000000) && PB.encode(e, 327, x.transitive_precedences_work_limit)
    ...
    x.shared_tree_num_workers != Int32(-1) && PB.encode(e, 235, x.shared_tree_num_workers)
    ...
    x.shared_tree_split_min_dtime !== Float64(0.1) && PB.encode(e, 328, x.shared_tree_split_min_dtime)
    ...
    x.solution_pool_diversity_limit != Int32(10) && PB.encode(e, 329, x.solution_pool_diversity_limit)
    x.alternative_pool_size != Int32(1) && PB.encode(e, 325, x.alternative_pool_size)
    ...
    x.use_new_integer_conflict_resolution != false && PB.encode(e, 336, x.use_new_integer_conflict_resolution)
    x.create_1uip_boolean_during_icr != true && PB.encode(e, 341, x.create_1uip_boolean_during_icr)
...
function PB._encoded_size(x::SatParameters)
    ...
    x.binary_minimization_algorithm != var"SatParameters.BinaryMinizationAlgorithm".BINARY_MINIMIZATION_FROM_UIP_AND_DECISIONS && (encoded_size += PB._encoded_size(x.binary_minimization_algorithm, 34))
    x.subsumption_during_conflict_analysis != true && (encoded_size += PB._encoded_size(x.subsumption_during_conflict_analysis, 56))
    x.extra_subsumption_during_conflict_analysis != true && (encoded_size += PB._encoded_size(x.extra_subsumption_during_conflict_analysis, 351))
    x.decision_subsumption_during_conflict_analysis != true && (encoded_size += PB._encoded_size(x.decision_subsumption_during_conflict_analysis, 353))
    x.eagerly_subsume_last_n_conflicts != Int32(4) && (encoded_size += PB._encoded_size(x.eagerly_subsume_last_n_conflicts, 343))
    x.subsume_during_vivification != true && (encoded_size += PB._encoded_size(x.subsume_during_vivification, 355))
    x.use_chronological_backtracking != false && (encoded_size += PB._encoded_size(x.use_chronological_backtracking, 330))
    x.max_backjump_levels != Int32(50) && (encoded_size += PB._encoded_size(x.max_backjump_levels, 331))
    x.chronological_backtrack_min_conflicts != Int32(1000) && (encoded_size += PB._encoded_size(x.chronological_backtrack_min_conflicts, 332))
    x.clause_cleanup_period != Int32(10000) && (encoded_size += PB._encoded_size(x.clause_cleanup_period, 11))
    x.clause_cleanup_period_increment != Int32(0) && (encoded_size += PB._encoded_size(x.clause_cleanup_period_increment, 337))
    ...
    x.clause_cleanup_lbd_tier1 != Int32(0) && (encoded_size += PB._encoded_size(x.clause_cleanup_lbd_tier1, 349))
    x.clause_cleanup_lbd_tier2 != Int32(0) && (encoded_size += PB._encoded_size(x.clause_cleanup_lbd_tier2, 350))
    ...
    x.load_at_most_ones_in_sat_presolve != false && (encoded_size += PB._encoded_size(x.load_at_most_ones_in_sat_presolve, 335))
    ...
    x.max_domain_size_for_linear2_expansion != Int32(8) && (encoded_size += PB._encoded_size(x.max_domain_size_for_linear2_expansion, 340))
    ...
    x.find_clauses_that_are_exactly_one != true && (encoded_size += PB._encoded_size(x.find_clauses_that_are_exactly_one, 333))
    ...
    x.inprocessing_use_congruence_closure != true && (encoded_size += PB._encoded_size(x.inprocessing_use_congruence_closure, 342))
    x.inprocessing_use_sat_sweeping != false && (encoded_size += PB._encoded_size(x.inprocessing_use_sat_sweeping, 354))
    ...
    x.share_linear2_bounds != false && (encoded_size += PB._encoded_size(x.share_linear2_bounds, 326))
    x.share_binary_clauses != true && (encoded_size += PB._encoded_size(x.share_binary_clauses, 203))
    x.share_glue_clauses != true && (encoded_size += PB._encoded_size(x.share_glue_clauses, 285))
    ...
    x.check_lrat_proof != false && (encoded_size += PB._encoded_size(x.check_lrat_proof, 344))
    x.check_merged_lrat_proof != false && (encoded_size += PB._encoded_size(x.check_merged_lrat_proof, 352))
    x.output_lrat_proof != false && (encoded_size += PB._encoded_size(x.output_lrat_proof, 345))
    x.check_drat_proof != false && (encoded_size += PB._encoded_size(x.check_drat_proof, 346))
    x.output_drat_proof != false && (encoded_size += PB._encoded_size(x.output_drat_proof, 347))
    x.max_drat_time_in_seconds !== Float64(Inf) && (encoded_size += PB._encoded_size(x.max_drat_time_in_seconds, 348))
    ...
    x.debug_crash_if_lrat_check_fails != false && (encoded_size += PB._encoded_size(x.debug_crash_if_lrat_check_fails, 339))
    ...
    x.transitive_precedences_work_limit != Int32(1000000) && (encoded_size += PB._encoded_size(x.transitive_precedences_work_limit, 327))
    ...
    x.shared_tree_num_workers != Int32(-1) && (encoded_size += PB._encoded_size(x.shared_tree_num_workers, 235))
    ...
    x.shared_tree_split_min_dtime !== Float64(0.1) && (encoded_size += PB._encoded_size(x.shared_tree_split_min_dtime, 328))
    ...
    x.solution_pool_diversity_limit != Int32(10) && (encoded_size += PB._encoded_size(x.solution_pool_diversity_limit, 329))
    x.alternative_pool_size != Int32(1) && (encoded_size += PB._encoded_size(x.alternative_pool_size, 325))
    ...
    x.use_new_integer_conflict_resolution != false && (encoded_size += PB._encoded_size(x.use_new_integer_conflict_resolution, 336))
    x.create_1uip_boolean_during_icr != true && (encoded_size += PB._encoded_size(x.create_1uip_boolean_during_icr, 341))
