...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SatParameters})
    ...
    while !PB.message_done(d)
        ...
        elseif field_number == 204
            use_shaving_in_probing_search = PB.decode(d, Bool)
...
function PB.encode(e::PB.AbstractProtoEncoder, x::SatParameters)
    ...
    x.use_shaving_in_probing_search != true && PB.encode(e, 204, x.use_shaving_in_probing_search)
    x.shaving_search_deterministic_time != Float64(0.001) && PB.encode(e, 205, x.shaving_search_deterministic_time)
...
function PB._encoded_size(x::SatParameters)
    ...
    x.use_shaving_in_probing_search != true && (encoded_size += PB._encoded_size(x.use_shaving_in_probing_search, 204))
