# Autogenerated using ProtoBuf.jl v1.0.14 on 2024-01-02T18:44:47.251
# original file: /usr/local/google/home/tcuvelier/.julia/artifacts/cc3d5aa28fb2158ce4ff5aed9899545a37503a6b/include/ortools/sat/cp_model.proto (proto3 syntax)
...
export AutomatonConstraintProto, IntegerVariableProto, BoolArgumentProto
export TableConstraintProto, FloatObjectiveProto, ElementConstraintProto
...
export CircuitConstraintProto, RoutesConstraintProto, NoOverlapConstraintProto
export var"DecisionStrategyProto.AffineTransformation"
...
export CumulativeConstraintProto, SymmetryProto, CpSolverResponse, DecisionStrategyProto
export ConstraintProto, CpModelProto
...
PB.default_values(::Type{AutomatonConstraintProto}) = (;starting_state = zero(Int64), final_states = Vector{Int64}(), transition_tail = Vector{Int64}(), transition_head = Vector{Int64}(), transition_label = Vector{Int64}(), vars = Vector{Int32}())
PB.field_numbers(::Type{AutomatonConstraintProto}) = (;starting_state = 2, final_states = 3, transition_tail = 4, transition_head = 5, transition_label = 6, vars = 7)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:AutomatonConstraintProto})
    ...
    return AutomatonConstraintProto(starting_state, final_states[], transition_tail[], transition_head[], transition_label[], vars[])
end
...
PB.default_values(::Type{TableConstraintProto}) = (;vars = Vector{Int32}(), values = Vector{Int64}(), negated = false)
PB.field_numbers(::Type{TableConstraintProto}) = (;vars = 1, values = 2, negated = 3)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:TableConstraintProto})
    ...
    return TableConstraintProto(vars[], values[], negated)
end
...
PB.default_values(::Type{ElementConstraintProto}) = (;index = zero(Int32), target = zero(Int32), vars = Vector{Int32}())
PB.field_numbers(::Type{ElementConstraintProto}) = (;index = 1, target = 2, vars = 3)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ElementConstraintProto})
    ...
    return ElementConstraintProto(index, target, vars[])
end
...
PB.default_values(::Type{RoutesConstraintProto}) = (;tails = Vector{Int32}(), heads = Vector{Int32}(), literals = Vector{Int32}(), demands = Vector{Int32}(), capacity = zero(Int64))
PB.field_numbers(::Type{RoutesConstraintProto}) = (;tails = 1, heads = 2, literals = 3, demands = 4, capacity = 5)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:RoutesConstraintProto})
    ...
    return RoutesConstraintProto(tails[], heads[], literals[], demands[], capacity)
end
...
struct var"DecisionStrategyProto.AffineTransformation"
    index::Int32
    offset::Int64
    positive_coeff::Int64
end
PB.default_values(::Type{var"DecisionStrategyProto.AffineTransformation"}) = (;index = zero(Int32), offset = zero(Int64), positive_coeff = zero(Int64))
PB.field_numbers(::Type{var"DecisionStrategyProto.AffineTransformation"}) = (;index = 1, offset = 2, positive_coeff = 3)

function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:var"DecisionStrategyProto.AffineTransformation"})
    index = zero(Int32)
    offset = zero(Int64)
    positive_coeff = zero(Int64)
    while !PB.message_done(d)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
            index = PB.decode(d, Int32)
        elseif field_number == 2
            offset = PB.decode(d, Int64)
        elseif field_number == 3
            positive_coeff = PB.decode(d, Int64)
        else
            PB.skip(d, wire_type)
        end
    end
    return var"DecisionStrategyProto.AffineTransformation"(index, offset, positive_coeff)
end

function PB.encode(e::PB.AbstractProtoEncoder, x::var"DecisionStrategyProto.AffineTransformation")
    initpos = position(e.io)
    x.index != zero(Int32) && PB.encode(e, 1, x.index)
    x.offset != zero(Int64) && PB.encode(e, 2, x.offset)
    x.positive_coeff != zero(Int64) && PB.encode(e, 3, x.positive_coeff)
    return position(e.io) - initpos
end
function PB._encoded_size(x::var"DecisionStrategyProto.AffineTransformation")
    encoded_size = 0
    x.index != zero(Int32) && (encoded_size += PB._encoded_size(x.index, 1))
    x.offset != zero(Int64) && (encoded_size += PB._encoded_size(x.offset, 2))
    x.positive_coeff != zero(Int64) && (encoded_size += PB._encoded_size(x.positive_coeff, 3))
    return encoded_size
end

@enumx var"DecisionStrategyProto.DomainReductionStrategy" SELECT_MIN_VALUE=0 SELECT_MAX_VALUE=1 SELECT_LOWER_HALF=2 SELECT_UPPER_HALF=3 SELECT_MEDIAN_VALUE=4
...
PB.field_numbers(::Type{CpSolverResponse}) = (;status = 1, solution = 2, objective_value = 3, best_objective_bound = 4, additional_solutions = 27, tightened_variables = 21, sufficient_assumptions_for_infeasibility = 23, integer_objective = 28, inner_objective_lower_bound = 29, num_integers = 30, num_booleans = 10, num_conflicts = 11, num_branches = 12, num_binary_propagations = 13, num_integer_propagations = 14, num_restarts = 24, num_lp_iterations = 25, wall_time = 15, user_time = 16, deterministic_time = 17, gap_integral = 22, solution_info = 20, solve_log = 26)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:CpSolverResponse})
    ...
    return CpSolverResponse(status, solution[], objective_value, best_objective_bound, additional_solutions[], tightened_variables[], sufficient_assumptions_for_infeasibility[], integer_objective[], inner_objective_lower_bound, num_integers, num_booleans, num_conflicts, num_branches, num_binary_propagations, num_integer_propagations, num_restarts, num_lp_iterations, wall_time, user_time, deterministic_time, gap_integral, solution_info, solve_log)
end
...
struct DecisionStrategyProto
    ...
    transformations::Vector{var"DecisionStrategyProto.AffineTransformation"}
end
PB.default_values(::Type{DecisionStrategyProto}) = (;variables = Vector{Int32}(), variable_selection_strategy = var"DecisionStrategyProto.VariableSelectionStrategy".CHOOSE_FIRST, domain_reduction_strategy = var"DecisionStrategyProto.DomainReductionStrategy".SELECT_MIN_VALUE, transformations = Vector{var"DecisionStrategyProto.AffineTransformation"}())
PB.field_numbers(::Type{DecisionStrategyProto}) = (;variables = 1, variable_selection_strategy = 2, domain_reduction_strategy = 3, transformations = 4)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DecisionStrategyProto})
    ...
    transformations = PB.BufferedVector{var"DecisionStrategyProto.AffineTransformation"}()
    while !PB.message_done(d)
        field_number, wire_type = PB.decode_tag(d)
        if field_number == 1
        ...
        elseif field_number == 4
            PB.decode!(d, transformations)
        else
            PB.skip(d, wire_type)
        end
    end
    return DecisionStrategyProto(variables[], variable_selection_strategy, domain_reduction_strategy, transformations[])
end
...
function PB.encode(e::PB.AbstractProtoEncoder, x::DecisionStrategyProto)
    ...
    !isempty(x.transformations) && PB.encode(e, 4, x.transformations)
    return position(e.io) - initpos
end
function PB._encoded_size(x::DecisionStrategyProto)
    ...
    !isempty(x.transformations) && (encoded_size += PB._encoded_size(x.transformations, 4))
    return encoded_size
end
