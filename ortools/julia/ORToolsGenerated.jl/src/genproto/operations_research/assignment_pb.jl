...
# original file: ortools/constraint_solver/assignment.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:IntVarAssignment}, _endpos::Int=0, _group::Bool=false)
    var_id = ""
    min = zero(Int64)
    max = zero(Int64)
    active = false
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:SequenceVarAssignment}, _endpos::Int=0, _group::Bool=false)
    var_id = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:IntervalVarAssignment}, _endpos::Int=0, _group::Bool=false)
    var_id = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:WorkerInfo}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:AssignmentProto}, _endpos::Int=0, _group::Bool=false)
