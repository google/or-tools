...
# original file: ortools/constraint_solver/demon_profiler.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:DemonRuns}, _endpos::Int=0, _group::Bool=false)
    demon_id = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:ConstraintRuns}, _endpos::Int=0, _group::Bool=false)
    constraint_id = ""
