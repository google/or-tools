...
# original file: ortools/packing/vbp/vector_bin_packing.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:VectorBinPackingOneBinInSolution}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:Item}, _endpos::Int=0, _group::Bool=false)
    name = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:VectorBinPackingSolution}, _endpos::Int=0, _group::Bool=false)
    solver_info = ""
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:VectorBinPackingProblem}, _endpos::Int=0, _group::Bool=false)
    name = ""
