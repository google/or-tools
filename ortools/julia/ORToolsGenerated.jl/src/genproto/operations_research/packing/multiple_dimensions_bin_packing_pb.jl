...
# original file: ortools/packing/multiple_dimensions_bin_packing.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MultipleDimensionsBinPackingShape}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MultipleDimensionsBinPackingItem}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:MultipleDimensionsBinPackingProblem}, _endpos::Int=0, _group::Bool=false)
