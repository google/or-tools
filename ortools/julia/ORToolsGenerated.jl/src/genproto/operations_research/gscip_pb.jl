# Autogenerated using ProtoBuf.jl v1.0.14 on 2024-01-02T18:44:46.805
# original file: /usr/local/google/home/tcuvelier/.julia/artifacts/cc3d5aa28fb2158ce4ff5aed9899545a37503a6b/include/ortools/gscip/gscip.proto (proto3 syntax)
...
PB.default_values(::Type{GScipSolvingStats}) = (;best_objective = zero(Float64), best_bound = zero(Float64), primal_simplex_iterations = zero(Int64), dual_simplex_iterations = zero(Int64), total_lp_iterations = zero(Int64), node_count = zero(Int64), first_lp_relaxation_bound = zero(Float64), root_node_bound = zero(Float64), deterministic_time = zero(Float64))
PB.field_numbers(::Type{GScipSolvingStats}) = (;best_objective = 1, best_bound = 2, primal_simplex_iterations = 3, dual_simplex_iterations = 4, total_lp_iterations = 5, node_count = 6, first_lp_relaxation_bound = 7, root_node_bound = 8, deterministic_time = 9)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GScipSolvingStats})
    ...
    return GScipSolvingStats(best_objective, best_bound, primal_simplex_iterations, dual_simplex_iterations, total_lp_iterations, node_count, first_lp_relaxation_bound, root_node_bound, deterministic_time)
end
