...
# original file: ortools/math_opt/solvers/gscip/gscip.proto (proto3 syntax)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GScipSolvingStats}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GScipParameters}, _endpos::Int=0, _group::Bool=false)
...
function PB.decode(d::PB.AbstractProtoDecoder, ::Type{<:GScipOutput}, _endpos::Int=0, _group::Bool=false)
